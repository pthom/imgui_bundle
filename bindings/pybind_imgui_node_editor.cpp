...
void py_init_module_imgui_node_editor(py::module& m)
{
    ...
    auto pyClassConfig =
        py::class_<ax::NodeEditor::Config>
            (m, "Config", "")
        .def_readwrite("settings_file", &Config::SettingsFile, "")
        .def_readwrite("user_pointer", &Config::UserPointer, "")
        .def_readwrite("custom_zoom_levels", &Config::CustomZoomLevels, "")
        .def_readwrite("canvas_size_mode", &Config::CanvasSizeMode, "")
        .def_readwrite("drag_button_index", &Config::DragButtonIndex, "Mouse button index drag action will react to (0-left, 1-right, 2-middle)")
        .def_readwrite("select_button_index", &Config::SelectButtonIndex, "Mouse button index select action will react to (0-left, 1-right, 2-middle)")
        .def_readwrite("navigate_button_index", &Config::NavigateButtonIndex, "Mouse button index navigate action will react to (0-left, 1-right, 2-middle)")
        .def_readwrite("context_menu_button_index", &Config::ContextMenuButtonIndex, "Mouse button index context menu action will react to (0-left, 1-right, 2-middle)")
        .def(py::init<>())
        ;
    ...
    auto pyClassStyle =
        py::class_<ax::NodeEditor::Style>
            (m, "Style", "")
        .def_readwrite("node_padding", &Style::NodePadding, "")
        .def_readwrite("node_rounding", &Style::NodeRounding, "")
        .def_readwrite("node_border_width", &Style::NodeBorderWidth, "")
        .def_readwrite("hovered_node_border_width", &Style::HoveredNodeBorderWidth, "")
        .def_readwrite("selected_node_border_width", &Style::SelectedNodeBorderWidth, "")
        .def_readwrite("pin_rounding", &Style::PinRounding, "")
        .def_readwrite("pin_border_width", &Style::PinBorderWidth, "")
        .def_readwrite("link_strength", &Style::LinkStrength, "")
        .def_readwrite("source_direction", &Style::SourceDirection, "")
        .def_readwrite("target_direction", &Style::TargetDirection, "")
        .def_readwrite("scroll_duration", &Style::ScrollDuration, "")
        .def_readwrite("flow_marker_distance", &Style::FlowMarkerDistance, "")
        .def_readwrite("flow_speed", &Style::FlowSpeed, "")
        .def_readwrite("flow_duration", &Style::FlowDuration, "")
        .def_readwrite("pivot_alignment", &Style::PivotAlignment, "")
        .def_readwrite("pivot_size", &Style::PivotSize, "")
        .def_readwrite("pivot_scale", &Style::PivotScale, "")
        .def_readwrite("pin_corners", &Style::PinCorners, "")
        .def_readwrite("pin_radius", &Style::PinRadius, "")
        .def_readwrite("pin_arrow_size", &Style::PinArrowSize, "")
        .def_readwrite("pin_arrow_width", &Style::PinArrowWidth, "")
        .def_readwrite("group_rounding", &Style::GroupRounding, "")
        .def_readwrite("group_border_width", &Style::GroupBorderWidth, "")
        .def_readwrite("highlight_connected_links", &Style::HighlightConnectedLinks, "")
        .def_readwrite("snap_link_to_pin_dir", &Style::SnapLinkToPinDir, "when True link will start on the line defined by pin direction")
        .def(py::init<>())
        ;
