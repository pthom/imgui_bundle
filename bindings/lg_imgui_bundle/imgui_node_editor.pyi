...
#------------------------------------------------------------------------------
# <submodule ax>
class ax:  # Proxy class that introduces typings for the *submodule* ax
    pass  # (This corresponds to a C++ namespace. All method are static!)
    """------------------------------------------------------------------------------"""

    # <submodule NodeEditor>
    class NodeEditor:  # Proxy class that introduces typings for the *submodule* NodeEditor
        pass  # (This corresponds to a C++ namespace. All method are static!)
        """ namespace Editor"""
        ...
        def get_current_editor() -> EditorContext:
            pass
        def create_editor(config: ax.NodeEditor.Config = None) -> EditorContext:
            pass
        def destroy_editor(ctx: EditorContext) -> None:
            pass
        def get_config(ctx: EditorContext = None) -> ax.NodeEditor.Config:
            pass

        def get_style() -> ax.NodeEditor.Style:
            pass
        def get_style_color_name(color_index: ax.NodeEditor.StyleColor) -> str:
            pass

        def push_style_color(
            color_index: ax.NodeEditor.StyleColor,
            color: ImVec4
            ) -> None:
            pass
        ...
        def push_style_var(var_index: ax.NodeEditor.StyleVar, value: float) -> None:
            pass
        def push_style_var(var_index: ax.NodeEditor.StyleVar, value: ImVec2) -> None:
            pass
        def push_style_var(var_index: ax.NodeEditor.StyleVar, value: ImVec4) -> None:
            pass
        ...
        def begin_node(id: ax.NodeEditor.NodeId) -> None:
            pass
        def begin_pin(id: ax.NodeEditor.PinId, kind: ax.NodeEditor.PinKind) -> None:
            pass
        ...
        def begin_group_hint(node_id: ax.NodeEditor.NodeId) -> bool:
            pass
        ...
        def get_node_background_draw_list(node_id: ax.NodeEditor.NodeId) -> ImDrawList:
            """ TODO: Add a way to manage node background channels"""
            pass

        def link(
            id: ax.NodeEditor.LinkId,
            start_pin_id: ax.NodeEditor.PinId,
            end_pin_id: ax.NodeEditor.PinId,
        ...
        def flow(
            link_id: ax.NodeEditor.LinkId,
            direction: ax.NodeEditor.FlowDirection = FlowDirection.forward
            ) -> None:
            pass
        ...
        def begin_create(
            ...
            pass
        def query_new_link(
            start_id: ax.NodeEditor.PinId,
            end_id: ax.NodeEditor.PinId
            ) -> bool:
            pass
        def query_new_link(
            start_id: ax.NodeEditor.PinId,
            ...
            pass
        def query_new_node(pin_id: ax.NodeEditor.PinId) -> bool:
            pass
        def query_new_node(
            pin_id: ax.NodeEditor.PinId,
            color: ImVec4,
            thickness: float = 1.0
            ) -> bool:
            pass
        ...
        def query_deleted_link(
            link_id: ax.NodeEditor.LinkId,
            start_id: ax.NodeEditor.PinId = None,
            end_id: ax.NodeEditor.PinId = None
            ) -> bool:
            pass
        def query_deleted_node(node_id: ax.NodeEditor.NodeId) -> bool:
            pass
        ...
        def set_node_position(
            node_id: ax.NodeEditor.NodeId,
            editor_position: ImVec2
            ) -> None:
            pass
        def set_group_size(node_id: ax.NodeEditor.NodeId, size: ImVec2) -> None:
            pass
        def get_node_position(node_id: ax.NodeEditor.NodeId) -> ImVec2:
            pass
        def get_node_size(node_id: ax.NodeEditor.NodeId) -> ImVec2:
            pass
        def center_node_on_screen(node_id: ax.NodeEditor.NodeId) -> None:
            pass
        def set_node_z_position(node_id: ax.NodeEditor.NodeId, z: float) -> None:
            """ Sets node z position, nodes with higher value are drawn over nodes with lower value"""
            pass
        def get_node_z_position(node_id: ax.NodeEditor.NodeId) -> float:
            """ Returns node z position, defaults is 0.0"""
            pass

        def restore_node_state(node_id: ax.NodeEditor.NodeId) -> None:
            pass
        ...
        def get_selected_object_count() -> int:
            pass
        def get_selected_nodes(nodes: ax.NodeEditor.NodeId, size: int) -> int:
            pass
        def get_selected_links(links: ax.NodeEditor.LinkId, size: int) -> int:
            pass
        def is_node_selected(node_id: ax.NodeEditor.NodeId) -> bool:
            pass
        def is_link_selected(link_id: ax.NodeEditor.LinkId) -> bool:
            pass
        def clear_selection() -> None:
            pass
        def select_node(node_id: ax.NodeEditor.NodeId, append: bool = False) -> None:
            pass
        def select_link(link_id: ax.NodeEditor.LinkId, append: bool = False) -> None:
            pass
        def deselect_node(node_id: ax.NodeEditor.NodeId) -> None:
            pass
        def deselect_link(link_id: ax.NodeEditor.LinkId) -> None:
            pass

        def delete_node(node_id: ax.NodeEditor.NodeId) -> bool:
            pass
        def delete_link(link_id: ax.NodeEditor.LinkId) -> bool:
            pass

        def has_any_links(node_id: ax.NodeEditor.NodeId) -> bool:
            """ Returns True if node has any link connected"""
            pass
        def has_any_links(pin_id: ax.NodeEditor.PinId) -> bool:
            """ Return True if pin has any link connected"""
            pass
        def break_links(node_id: ax.NodeEditor.NodeId) -> int:
            """ Break all links connected to this node"""
            pass
        def break_links(pin_id: ax.NodeEditor.PinId) -> int:
        ...
        def show_node_context_menu(node_id: ax.NodeEditor.NodeId) -> bool:
            pass
        def show_pin_context_menu(pin_id: ax.NodeEditor.PinId) -> bool:
            pass
        def show_link_context_menu(link_id: ax.NodeEditor.LinkId) -> bool:
            pass
        ...
        def get_action_context_size() -> int:
            pass
        def get_action_context_nodes(nodes: ax.NodeEditor.NodeId, size: int) -> int:
            pass
        def get_action_context_links(links: ax.NodeEditor.LinkId, size: int) -> int:
            pass
        ...
        def get_hovered_node() -> ax.NodeEditor.NodeId:
            pass
        def get_hovered_pin() -> ax.NodeEditor.PinId:
            pass
        def get_hovered_link() -> ax.NodeEditor.LinkId:
            pass
        def get_double_clicked_node() -> ax.NodeEditor.NodeId:
            pass
        def get_double_clicked_pin() -> ax.NodeEditor.PinId:
            pass
        def get_double_clicked_link() -> ax.NodeEditor.LinkId:
            pass
        ...
        def pin_had_any_links(pin_id: ax.NodeEditor.PinId) -> bool:
            pass
        ...
        def get_node_count() -> int:
            ...
            pass
        def get_ordered_node_ids(nodes: ax.NodeEditor.NodeId, size: int) -> int:
