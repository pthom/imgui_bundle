...
void py_init_module_imgui_main(py::module& m)
{
    ...
    auto fontAtlas_AddFontFromFileTTF = [](
        ...
        std::vector<int> glyph_ranges_as_int_list = {})
    {
        // from imgui.h doc:
        ...
        return self.AddFontFromFileTTF(filename, size_pixels, font_cfg, glyph_range_this_call.data());
    };
    m.def("font_atlas_add_font_from_file_ttf_experimental", fontAtlas_AddFontFromFileTTF);
