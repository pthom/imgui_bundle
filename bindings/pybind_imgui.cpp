...
//        printf("IsBuilt=%i\n", ImGui::GetIO().Fonts->IsBuilt());
    ...
    auto pyClassImGuiIO =
        ...
        .def_readwrite("user_data", &ImGuiIO::UserData, "= None           // Store your own data for retrieval by callbacks.")
    ...
    py::enum_<ImGuiToggleFlags_>(m, "ToggleFlags_", py::arithmetic(), "")
