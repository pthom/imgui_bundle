"""GLFW bindings for ImGuiBundle
Warning: these bindings were auto-generated from glfw3.h.
They may differ from the classic glfw bindings provided by "pip install glfw".

When using ImGuiBundle, use those bindings instead of pypi bindings
(since glfw is statically linked into the library)
"""
...
class GLFWwindow:
    ...
    @staticmethod
    def null() -> GLFWwindow:
        """returns an object pointing to NULL"""
        pass
...
GLFWerrorfun = Callable[[int, str], None]
...
GLFWwindowposfun = Callable[[GLFWwindow, int, int], None]
...
GLFWwindowsizefun = Callable[[GLFWwindow, int, int], None]
...
GLFWwindowclosefun = Callable[[GLFWwindow], None]
...
GLFWwindowrefreshfun = Callable[[GLFWwindow], None]
...
GLFWwindowfocusfun = Callable[[GLFWwindow, int], None]
...
GLFWwindowiconifyfun = Callable[[GLFWwindow, int], None]
...
GLFWwindowmaximizefun = Callable[GLFWwindow, int]
...
GLFWframebuffersizefun = Callable[[GLFWwindow, int, int], None]
...
GLFWwindowcontentscalefun = Callable[[GLFWwindow, float, float], None]
...
GLFWmousebuttonfun = Callable[[GLFWwindow, int, int, int], None]
...
GLFWcursorposfun = Callable[[GLFWwindow, float, float], None]
...
GLFWcursorenterfun = Callable[[GLFWwindow, int], None]
...
GLFWscrollfun = Callable[[GLFWwindow, float, float]]
...
GLFWkeyfun = Callable[[GLFWwindow, int, int, int, int], None]
...
GLFWcharfun = Callable[[GLFWwindow, int], None]
...
GLFWcharmodsfun = Callable[[GLFWwindow, int, int], None]
...
GLFWdropfun = Callable[[GLFWwindow, int, List[str]], None]
...
GLFWmonitorfun = Callable[[GLFWmonitor, int], None]
...
GLFWjoystickfun = Callable[[int, int], None]
...
def set_error_callback(callback: GLFWerrorfun):
    pass
...
def set_monitor_callback(callback: GLFWmonitorfun):
    pass
...
def set_window_pos_callback(window: GLFWwindow, callback: GLFWwindowposfun):
    pass
...
def set_window_size_callback(window: GLFWwindow, callback: GLFWwindowsizefun):
    pass
...
def set_window_close_callback(window: GLFWwindow, callback: GLFWwindowclosefun):
    pass
...
def set_window_refresh_callback(window: GLFWwindow, callback: GLFWwindowrefreshfun):
    pass
...
def set_window_focus_callback(window: GLFWwindow, callback: GLFWwindowfocusfun):
    pass
...
def set_window_iconify_callback(window: GLFWwindow, callback: GLFWwindowiconifyfun):
    pass
...
def set_window_maximize_callback(window: GLFWwindow, callback: GLFWwindowmaximizefun):
    pass
...
def set_frame_buffer_size_callback(window: GLFWwindow, callback: GLFWframebuffersizefun):
    pass
...
def set_window_content_scale_callback(window: GLFWwindow, callback: GLFWwindowcontentscalefun):
    pass
...
def set_key_callback(window: GLFWwindow, callback: GLFWkeyfun):
    pass
...
def set_char_callback(window: GLFWwindow, callback: GLFWcharfun):
    pass
...
def set_char_mods_callback(window: GLFWwindow, callback: GLFWcharmodsfun):
    pass
...
def set_mouse_button_callback(window: GLFWwindow, callback: GLFWmousebuttonfun):
    pass
...
def set_cursor_pos_callback(window: GLFWwindow, callback: GLFWcursorposfun):
    pass
...
def set_cursor_enter_callback(window: GLFWwindow, callback: GLFWcursorenterfun):
    pass
...
def set_scroll_callback(window: GLFWwindow, callback: GLFWscrollfun):
    pass
...
def set_drop_callback(window: GLFWwindow, callback: GLFWdropfun):
    pass
...
def set_joystick_callback(window: GLFWwindow, callback: GLFWjoystickfun):
    pass
...
def init_allocator(allocator: GLFWallocator) -> None:
...
def get_version(major: BoxedInt, minor: BoxedInt, rev: BoxedInt) -> None:
...
def get_primary_monitor() -> GLFWmonitor:
...
def get_monitor_name(monitor: GLFWmonitor) -> str:
...
def set_monitor_user_pointer(monitor: GLFWmonitor, pointer: Any) -> None:
...
def get_monitor_user_pointer(monitor: GLFWmonitor) -> Any:
...
def get_video_modes(monitor: GLFWmonitor, count: BoxedInt) -> GLFWvidmode:
...
def get_video_mode(monitor: GLFWmonitor) -> GLFWvidmode:
...
def set_gamma(monitor: GLFWmonitor, gamma: float) -> None:
...
def get_gamma_ramp(monitor: GLFWmonitor) -> GLFWgammaramp:
...
def set_gamma_ramp(monitor: GLFWmonitor, ramp: GLFWgammaramp) -> None:
...
def window_should_close(window: GLFWwindow) -> int:
...
def set_window_should_close(window: GLFWwindow, value: int) -> None:
...
def set_window_title(window: GLFWwindow, title: str) -> None:
...
def set_window_icon(window: GLFWwindow, count: int, images: GLFWimage) -> None:
...
def get_window_pos(window: GLFWwindow, xpos: BoxedInt, ypos: BoxedInt) -> None:
...
def set_window_pos(window: GLFWwindow, xpos: int, ypos: int) -> None:
...
def set_window_size(window: GLFWwindow, width: int, height: int) -> None:
...
def get_window_opacity(window: GLFWwindow) -> float:
...
def set_window_opacity(window: GLFWwindow, opacity: float) -> None:
...
def iconify_window(window: GLFWwindow) -> None:
...
def restore_window(window: GLFWwindow) -> None:
...
def maximize_window(window: GLFWwindow) -> None:
...
def show_window(window: GLFWwindow) -> None:
...
def hide_window(window: GLFWwindow) -> None:
...
def focus_window(window: GLFWwindow) -> None:
...
def request_window_attention(window: GLFWwindow) -> None:
...
def get_window_monitor(window: GLFWwindow) -> GLFWmonitor:
...
def get_window_attrib(window: GLFWwindow, attrib: int) -> int:
...
def set_window_attrib(window: GLFWwindow, attrib: int, value: int) -> None:
...
def set_window_user_pointer(window: GLFWwindow, pointer: Any) -> None:
...
def get_window_user_pointer(window: GLFWwindow) -> Any:
...
def get_input_mode(window: GLFWwindow, mode: int) -> int:
...
def set_input_mode(window: GLFWwindow, mode: int, value: int) -> None:
...
def get_key(window: GLFWwindow, key: int) -> int:
...
def get_mouse_button(window: GLFWwindow, button: int) -> int:
...
def set_cursor_pos(window: GLFWwindow, xpos: float, ypos: float) -> None:
...
def create_cursor(image: GLFWimage, xhot: int, yhot: int) -> GLFWcursor:
...
def create_standard_cursor(shape: int) -> GLFWcursor:
...
def destroy_cursor(cursor: GLFWcursor) -> None:
...
def set_cursor(window: GLFWwindow, cursor: GLFWcursor) -> None:
...
def joystick_present(jid: int) -> int:
...
def get_joystick_axes(jid: int, count: BoxedInt) -> float:
...
def get_joystick_buttons(jid: int, count: BoxedInt) -> int:
...
def get_joystick_hats(jid: int, count: BoxedInt) -> int:
...
def get_joystick_name(jid: int) -> str:
...
def get_joystick_guid(jid: int) -> str:
...
def set_joystick_user_pointer(jid: int, pointer: Any) -> None:
...
def get_joystick_user_pointer(jid: int) -> Any:
...
def joystick_is_gamepad(jid: int) -> int:
...
def get_gamepad_name(jid: int) -> str:
...
def get_gamepad_state(jid: int, state: GLFWgamepadstate) -> int:
...
def set_clipboard_string(window: GLFWwindow, string: str) -> None:
...
def get_clipboard_string(window: GLFWwindow) -> str:
...
def make_context_current(window: GLFWwindow) -> None:
...
def get_current_context() -> GLFWwindow:
...
def swap_buffers(window: GLFWwindow) -> None:
