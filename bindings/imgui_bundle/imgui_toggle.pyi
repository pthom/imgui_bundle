...
class ToggleStateConfig:
    ...
    palette: Optional[TogglePalette] = None  # (const)
...
# static inline ImOffsetRect ImLerp(const ImOffsetRect& a, const ImOffsetRect& b, float t)    /* original C++ signature */
# {
#     return ImOffsetRect(
#         a.Top    + (b.Top    - a.Top)    * t,
...
# }
def im_lerp(a: ImOffsetRect, b: ImOffsetRect, t: float) -> ImOffsetRect:
