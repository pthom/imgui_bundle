...
class StyleVar_(enum.Enum):
    ...
    button_text_align = enum.auto()  # (= 26)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,     /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 27)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_SeparatorTextBorderSize,    /* original C++ signature */
    separator_text_border_size = enum.auto()  # (= 28)  # float  SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,      /* original C++ signature */
    separator_text_align = enum.auto()  # (= 29)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,    /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 30)  # ImVec2    SeparatorTextPadding
    # ImGuiStyleVar_DockingSeparatorSize,    /* original C++ signature */
    docking_separator_size = enum.auto()  # (= 31)  # float     DockingSeparatorSize
    # ImGuiStyleVar_LayoutAlign,             /* original C++ signature */
    layout_align = enum.auto()  # (= 32)  # float     LayoutAlign
