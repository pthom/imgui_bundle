...
class ImDrawFlags_(enum.IntFlag):
    ...
    closed = (
        enum.auto()
    )  # (= 1 << 9)  # PathStroke(), AddPolyline(): specify that shape should be closed (Important: this is always == 1 for legacy reason)
    ...
    # ImDrawFlags_InvalidMask_                = (ImDrawFlags)0x8000000F,    /* original C++ signature */
    # }
    invalid_mask_ = enum.auto()  # (= (ImDrawFlags)0x8000000F)
