...
class StyleVar_(enum.Enum):
    ...
    separator_text_border_size = enum.auto()  # (= 25)  # float  SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,      /* original C++ signature */
    separator_text_align = enum.auto()  # (= 26)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,    /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 27)  # ImVec2    SeparatorTextPadding
