...
class ListClipper:
    ...
    def step(self) -> bool:
        ...
        pass
    # IMGUI_API void  IncludeRangeByIndices(int item_begin, int item_end);     /* original C++ signature */
    def include_range_by_indices(self, item_begin: int, item_end: int) -> None:
