...
class ImVec4:  # imgui.h:274
    ...
    def __init__(self) -> None:  # imgui.h:277
        pass
...
) -> Tuple[bool, Optional[bool]]:  # imgui.h:338
    pass

# IMGUI_API void          End();    /* original C++ signature */
def end() -> None:  # imgui.h:339
    pass
...
def set_next_window_size(size: ImVec2, cond: Cond = 0) -> None:  # imgui.h:370
...
def set_next_window_content_size(size: ImVec2) -> None:  # imgui.h:372
...
def set_next_window_collapsed(collapsed: bool, cond: Cond = 0) -> None:  # imgui.h:373
    """set next window collapsed state. call before Begin()"""
    pass

# IMGUI_API void          SetNextWindowFocus();                                                           /* original C++ signature */
def set_next_window_focus() -> None:  # imgui.h:374
    """set next window to be focused / top-most. call before Begin()"""
    pass

# IMGUI_API void          SetNextWindowScroll(const ImVec2& scroll);                                      /* original C++ signature */
def set_next_window_scroll(scroll: ImVec2) -> None:  # imgui.h:375
...
def set_window_collapsed(collapsed: bool, cond: Cond = 0) -> None:  # imgui.h:380
    """(not recommended) set current window collapsed state. prefer using SetNextWindowCollapsed()."""
    pass

# IMGUI_API void          SetWindowFocus();                                                               /* original C++ signature */
def set_window_focus() -> None:  # imgui.h:381
    """(not recommended) set current window to be focused / top-most. prefer using SetNextWindowFocus()."""
    pass

# IMGUI_API void          SetWindowFontScale(float scale);                                                /* original C++ signature */
def set_window_font_scale(scale: float) -> None:  # imgui.h:382
...
def set_window_pos(name: str, pos: ImVec2, cond: Cond = 0) -> None:  # imgui.h:383
    """set named window position."""
    pass

# IMGUI_API void          SetWindowSize(const char* name, const ImVec2& size, ImGuiCond cond = 0);        /* original C++ signature */
def set_window_size(name: str, size: ImVec2, cond: Cond = 0) -> None:  # imgui.h:384
...
def set_window_focus(name: str) -> None:  # imgui.h:386
...
def pop_item_width() -> None:  # imgui.h:426
    pass

# IMGUI_API void          SetNextItemWidth(float item_width);                                 /* original C++ signature */
def set_next_item_width(item_width: float) -> None:  # imgui.h:427
...
def separator() -> None:  # imgui.h:449
...
def label_text(label: str, fmt: str) -> None:  # imgui.h:503
    """display text+label aligned the same way as value+label widgets"""
    pass

# IMGUI_API void          BulletText(const char* fmt, ...)                                ;     /* original C++ signature */
def bullet_text(fmt: str) -> None:  # imgui.h:505
...
def button(label: str, size: ImVec2 = ImVec2(0, 0)) -> bool:  # imgui.h:511
    """button"""
    pass

# IMGUI_API bool          SmallButton(const char* label);                                     /* original C++ signature */
def small_button(label: str) -> bool:  # imgui.h:512
...
def arrow_button(str_id: str, dir: Dir) -> bool:  # imgui.h:514
    """square button with an arrow shape"""
    pass

# IMGUI_API bool          Checkbox(const char* label, bool* v);    /* original C++ signature */
def checkbox(label: str, v: bool) -> Tuple[bool, bool]:  # imgui.h:515
    pass
...
def end_combo() -> None:  # imgui.h:532
...
def drag_float3(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:551
    pass
...
def drag_float_range2(
    ...
    flags: SliderFlags = 0,
) -> Tuple[bool, float, float]:  # imgui.h:553
    pass
...
def drag_int3(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:556
    pass
...
def drag_int_range2(
    ...
    format_max: Optional[str] = None,
    flags: SliderFlags = 0,
) -> Tuple[bool, int, int]:  # imgui.h:558
    pass
...
def slider_float3(
    ...
    format: str = "%.3",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[float]]:  # imgui.h:570
    pass
...
def slider_int3(
    ...
    format: str = "%d",
    flags: SliderFlags = 0,
) -> Tuple[bool, List[int]]:  # imgui.h:575
    pass
...
def input_float3(
    label: str, v: List[float], format: str = "%.3", flags: InputTextFlags = 0
) -> Tuple[bool, List[float]]:  # imgui.h:591
    pass
...
def input_int3(
    label: str, v: List[int], flags: InputTextFlags = 0
) -> Tuple[bool, List[int]]:  # imgui.h:595
    pass
...
def set_color_edit_options(flags: ColorEditFlags) -> None:  # imgui.h:609
...
def collapsing_header(label: str, flags: TreeNodeFlags = 0) -> bool:  # imgui.h:627
...
def set_next_item_open(is_open: bool, cond: Cond = 0) -> None:  # imgui.h:629
...
def begin_list_box(label: str, size: ImVec2 = ImVec2(0, 0)) -> bool:  # imgui.h:648
    """open a framed scrolling region"""
    pass

# IMGUI_API void          EndListBox();                                                           /* original C++ signature */
def end_list_box() -> None:  # imgui.h:649
...
def begin_popup(str_id: str, flags: WindowFlags = 0) -> bool:  # imgui.h:700
...
def begin_popup_modal(
    name: str, p_open: Optional[bool] = None, flags: WindowFlags = 0
) -> Tuple[bool, Optional[bool]]:  # imgui.h:701
    """return True if the modal is open, and you can start outputting to it."""
    pass

# IMGUI_API void          EndPopup();                                                                             /* original C++ signature */
def end_popup() -> None:  # imgui.h:702
...
def open_popup(str_id: str, popup_flags: PopupFlags = 0) -> None:  # imgui.h:712
    """call to mark popup as open (don't call every frame!)."""
    pass

# IMGUI_API void          OpenPopup(ImGuiID id, ImGuiPopupFlags popup_flags = 0);                                 /* original C++ signature */
def open_popup(id_: ID, popup_flags: PopupFlags = 0) -> None:  # imgui.h:713
...
def close_current_popup() -> None:  # imgui.h:715
...
def is_popup_open(str_id: str, flags: PopupFlags = 0) -> bool:  # imgui.h:730
...
def end_table() -> None:  # imgui.h:756
...
def table_next_column() -> bool:  # imgui.h:758
    """append into the next column (or first column of next row if currently in last column). Return True when column is visible."""
    pass

# IMGUI_API bool          TableSetColumnIndex(int column_n);                      /* original C++ signature */
def table_set_column_index(column_n: int) -> bool:  # imgui.h:759
...
def table_setup_scroll_freeze(cols: int, rows: int) -> None:  # imgui.h:770
    """lock columns/rows so they stay visible when scrolled."""
    pass

# IMGUI_API void          TableHeadersRow();                                      /* original C++ signature */
def table_headers_row() -> None:  # imgui.h:771
    """submit all headers cells based on data provided to TableSetupColumn() + submit context menu"""
    pass

# IMGUI_API void          TableHeader(const char* label);                         /* original C++ signature */
def table_header(label: str) -> None:  # imgui.h:772
...
def table_get_sort_specs() -> TableSortSpecs:  # imgui.h:780
...
def log_to_tty(auto_open_depth: int = -1) -> None:  # imgui.h:831
...
def begin_drag_drop_source(flags: DragDropFlags = 0) -> bool:  # imgui.h:844
...
def end_drag_drop_source() -> None:  # imgui.h:846
    """only call EndDragDropSource() if BeginDragDropSource() returns True!"""
    pass

# IMGUI_API bool                  BeginDragDropTarget();                                                              /* original C++ signature */
def begin_drag_drop_target() -> bool:  # imgui.h:847
...
def end_drag_drop_target() -> None:  # imgui.h:849
    """only call EndDragDropTarget() if BeginDragDropTarget() returns True!"""
    pass

# IMGUI_API const ImGuiPayload*   GetDragDropPayload();                                                               /* original C++ signature */
def get_drag_drop_payload() -> Payload:  # imgui.h:850
...
def begin_disabled(disabled: bool = True) -> None:  # imgui.h:856
    pass

# IMGUI_API void          EndDisabled();    /* original C++ signature */
def end_disabled() -> None:  # imgui.h:857
    pass
...
def get_main_viewport() -> Viewport:  # imgui.h:894
...
def get_background_draw_list() -> ImDrawList:  # imgui.h:897
...
def get_foreground_draw_list() -> ImDrawList:  # imgui.h:898
...
def get_background_draw_list(viewport: Viewport) -> ImDrawList:  # imgui.h:899
...
def get_foreground_draw_list(viewport: Viewport) -> ImDrawList:  # imgui.h:900
...
def end_child_frame() -> None:  # imgui.h:912
...
def color_convert_u32_to_float4(in_: ImU32) -> ImVec4:  # imgui.h:918
    pass

# IMGUI_API ImU32         ColorConvertFloat4ToU32(const ImVec4& in);    /* original C++ signature */
def color_convert_float4_to_u32(in_: ImVec4) -> ImU32:  # imgui.h:919
    pass
...
) -> Tuple[float, float, float]:  # imgui.h:920
    pass
...
) -> Tuple[float, float, float]:  # imgui.h:921
    pass
...
def get_key_name(key: Key) -> str:  # imgui.h:933
...
def get_clipboard_text() -> str:  # imgui.h:959
    pass

# IMGUI_API void          SetClipboardText(const char* text);    /* original C++ signature */
def set_clipboard_text(text: str) -> None:  # imgui.h:960
    pass
...
def load_ini_settings_from_disk(ini_filename: str) -> None:  # imgui.h:966
...
def save_ini_settings_to_disk(ini_filename: str) -> None:  # imgui.h:968
...
class WindowFlags_(enum.Enum):  # imgui.h:1002
...
class InputTextFlags_(enum.Enum):  # imgui.h:1043
...
class TreeNodeFlags_(enum.Enum):  # imgui.h:1075
...
class PopupFlags_(enum.Enum):  # imgui.h:1104
...
class SelectableFlags_(enum.Enum):  # imgui.h:1120
...
class ComboFlags_(enum.Enum):  # imgui.h:1131
...
class TabBarFlags_(enum.Enum):  # imgui.h:1145
...
class TabItemFlags_(enum.Enum):  # imgui.h:1161
...
class TableFlags_(enum.Enum):  # imgui.h:1196
...
class TableColumnFlags_(enum.Enum):  # imgui.h:1247
...
class TableRowFlags_(enum.Enum):  # imgui.h:1284
...
class TableBgTarget_(enum.Enum):  # imgui.h:1299
...
class FocusedFlags_(enum.Enum):  # imgui.h:1308
...
class HoveredFlags_(enum.Enum):  # imgui.h:1322
...
class DockNodeFlags_(enum.Enum):  # imgui.h:1348
...
class DragDropFlags_(enum.Enum):  # imgui.h:1361
...
class DataType_(enum.Enum):  # imgui.h:1383
    """A primary data type"""
...
class Dir_(enum.Enum):  # imgui.h:1399
...
class SortDirection_(enum.Enum):  # imgui.h:1410
    """A sorting direction"""
...
class Key(enum.Enum):  # imgui.h:1420
...
class ConfigFlags_(enum.Enum):  # imgui.h:1561
...
class BackendFlags_(enum.Enum):  # imgui.h:1586
...
class Col_(enum.Enum):  # imgui.h:1601
...
class StyleVar_(enum.Enum):  # imgui.h:1668
...
class ButtonFlags_(enum.Enum):  # imgui.h:1700
...
class ColorEditFlags_(enum.Enum):  # imgui.h:1713
...
class SliderFlags_(enum.Enum):  # imgui.h:1759
...
class MouseButton_(enum.Enum):  # imgui.h:1776
...
class MouseCursor_(enum.Enum):  # imgui.h:1786
...
class Cond_(enum.Enum):  # imgui.h:1804
...
class ImNewWrapper:  # imgui.h:1823
...
class Style:  # imgui.h:1916
    # float       Alpha;    /* original C++ signature */
    alpha: float  # Global alpha applies to everything in Dear ImGui.    # imgui.h:1918
    # float       DisabledAlpha;    /* original C++ signature */
    disabled_alpha: float  # Additional alpha multiplier applied by BeginDisabled(). Multiply over current value of Alpha.    # imgui.h:1919
    # ImVec2      WindowPadding;    /* original C++ signature */
    window_padding: ImVec2  # Padding within a window.    # imgui.h:1920
    # float       WindowRounding;    /* original C++ signature */
    window_rounding: float  # Radius of window corners rounding. Set to 0.0 to have rectangular windows. Large values tend to lead to variety of artifacts and are not recommended.    # imgui.h:1921
    # float       WindowBorderSize;    /* original C++ signature */
    window_border_size: float  # Thickness of border around windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1922
    # ImVec2      WindowMinSize;    /* original C++ signature */
    window_min_size: ImVec2  # Minimum window size. This is a global setting. If you want to constrain individual windows, use SetNextWindowSizeConstraints().    # imgui.h:1923
    # ImVec2      WindowTitleAlign;    /* original C++ signature */
    window_title_align: ImVec2  # Alignment for title bar text. Defaults to (0.0,0.5) for left-aligned,vertically centered.    # imgui.h:1924
    # ImGuiDir    WindowMenuButtonPosition;    /* original C++ signature */
    window_menu_button_position: Dir  # Side of the collapsing/docking button in the title bar (None/Left/Right). Defaults to ImGuiDir_Left.    # imgui.h:1925
    # float       ChildRounding;    /* original C++ signature */
    child_rounding: float  # Radius of child window corners rounding. Set to 0.0 to have rectangular windows.    # imgui.h:1926
    # float       ChildBorderSize;    /* original C++ signature */
    child_border_size: float  # Thickness of border around child windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1927
    # float       PopupRounding;    /* original C++ signature */
    popup_rounding: float  # Radius of popup window corners rounding. (Note that tooltip windows use WindowRounding)    # imgui.h:1928
    # float       PopupBorderSize;    /* original C++ signature */
    popup_border_size: float  # Thickness of border around popup/tooltip windows. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1929
    # ImVec2      FramePadding;    /* original C++ signature */
    frame_padding: ImVec2  # Padding within a framed rectangle (used by most widgets).    # imgui.h:1930
    # float       FrameRounding;    /* original C++ signature */
    frame_rounding: float  # Radius of frame corners rounding. Set to 0.0 to have rectangular frame (used by most widgets).    # imgui.h:1931
    # float       FrameBorderSize;    /* original C++ signature */
    frame_border_size: float  # Thickness of border around frames. Generally set to 0.0 or 1.0. (Other values are not well tested and more CPU/GPU costly).    # imgui.h:1932
    # ImVec2      ItemSpacing;    /* original C++ signature */
    item_spacing: ImVec2  # Horizontal and vertical spacing between widgets/lines.    # imgui.h:1933
    # ImVec2      ItemInnerSpacing;    /* original C++ signature */
    item_inner_spacing: ImVec2  # Horizontal and vertical spacing between within elements of a composed widget (e.g. a slider and its label).    # imgui.h:1934
    # ImVec2      CellPadding;    /* original C++ signature */
    cell_padding: ImVec2  # Padding within a table cell    # imgui.h:1935
    # ImVec2      TouchExtraPadding;    /* original C++ signature */
    touch_extra_padding: ImVec2  # Expand reactive bounding box for touch-based system where touch position is not accurate enough. Unfortunately we don't sort widgets so priority on overlap will always be given to the first widget. So don't grow this too much!    # imgui.h:1936
    # float       IndentSpacing;    /* original C++ signature */
    indent_spacing: float  # Horizontal indentation when e.g. entering a tree node. Generally == (FontSize + FramePadding.x*2).    # imgui.h:1937
    # float       ColumnsMinSpacing;    /* original C++ signature */
    columns_min_spacing: float  # Minimum horizontal spacing between two columns. Preferably > (FramePadding.x + 1).    # imgui.h:1938
    # float       ScrollbarSize;    /* original C++ signature */
    scrollbar_size: float  # Width of the vertical scrollbar, Height of the horizontal scrollbar.    # imgui.h:1939
    # float       ScrollbarRounding;    /* original C++ signature */
    scrollbar_rounding: float  # Radius of grab corners for scrollbar.    # imgui.h:1940
    # float       GrabMinSize;    /* original C++ signature */
    grab_min_size: float  # Minimum width/height of a grab box for slider/scrollbar.    # imgui.h:1941
    # float       GrabRounding;    /* original C++ signature */
    grab_rounding: float  # Radius of grabs corners rounding. Set to 0.0 to have rectangular slider grabs.    # imgui.h:1942
    # float       LogSliderDeadzone;    /* original C++ signature */
    log_slider_deadzone: float  # The size in pixels of the dead-zone around zero on logarithmic sliders that cross zero.    # imgui.h:1943
    # float       TabRounding;    /* original C++ signature */
    tab_rounding: float  # Radius of upper corners of a tab. Set to 0.0 to have rectangular tabs.    # imgui.h:1944
    # float       TabBorderSize;    /* original C++ signature */
    tab_border_size: float  # Thickness of border around tabs.    # imgui.h:1945
    # float       TabMinWidthForCloseButton;    /* original C++ signature */
    tab_min_width_for_close_button: float  # Minimum width for close button to appear on an unselected tab when hovered. Set to 0.0 to always show when hovering, set to FLT_MAX to never show close button unless selected.    # imgui.h:1946
    # ImGuiDir    ColorButtonPosition;    /* original C++ signature */
    color_button_position: Dir  # Side of the color button in the ColorEdit4 widget (left/right). Defaults to ImGuiDir_Right.    # imgui.h:1947
    # ImVec2      ButtonTextAlign;    /* original C++ signature */
    button_text_align: ImVec2  # Alignment of button text when button is larger than text. Defaults to (0.5, 0.5) (centered).    # imgui.h:1948
    # ImVec2      SelectableTextAlign;    /* original C++ signature */
    selectable_text_align: ImVec2  # Alignment of selectable text. Defaults to (0.0, 0.0) (top-left aligned). It's generally important to keep this left-aligned if you want to lay multiple items on a same line.    # imgui.h:1949
    # ImVec2      DisplayWindowPadding;    /* original C++ signature */
    display_window_padding: ImVec2  # Window position are clamped to be visible within the display area or monitors by at least this amount. Only applies to regular windows.    # imgui.h:1950
    # ImVec2      DisplaySafeAreaPadding;    /* original C++ signature */
    display_safe_area_padding: ImVec2  # If you cannot see the edges of your screen (e.g. on a TV) increase the safe area padding. Apply to popups/tooltips as well regular windows. NB: Prefer configuring your TV sets correctly!    # imgui.h:1951
    # float       MouseCursorScale;    /* original C++ signature */
    mouse_cursor_scale: float  # Scale software rendered mouse cursor (when io.MouseDrawCursor is enabled). We apply per-monitor DPI scaling over this scale. May be removed later.    # imgui.h:1952
    # bool        AntiAliasedLines;    /* original C++ signature */
    anti_aliased_lines: bool  # Enable anti-aliased lines/borders. Disable if you are really tight on CPU/GPU. Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1953
    # bool        AntiAliasedLinesUseTex;    /* original C++ signature */
    anti_aliased_lines_use_tex: bool  # Enable anti-aliased lines/borders using textures where possible. Require backend to render with bilinear filtering (NOT point/nearest filtering). Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1954
    # bool        AntiAliasedFill;    /* original C++ signature */
    anti_aliased_fill: bool  # Enable anti-aliased edges around filled shapes (rounded rectangles, circles, etc.). Disable if you are really tight on CPU/GPU. Latched at the beginning of the frame (copied to ImDrawList).    # imgui.h:1955
    # float       CurveTessellationTol;    /* original C++ signature */
    curve_tessellation_tol: float  # Tessellation tolerance when using PathBezierCurveTo() without a specific number of segments. Decrease for highly tessellated curves (higher quality, more polygons), increase to reduce quality.    # imgui.h:1956
    # float       CircleTessellationMaxError;    /* original C++ signature */
    circle_tessellation_max_error: float  # Maximum error (in pixels) allowed when using AddCircle()/AddCircleFilled() or drawing rounded corner rectangles with no explicit segment count specified. Decrease for higher quality but more geometry.    # imgui.h:1957

    # IMGUI_API ImGuiStyle();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:1960
        pass
    # IMGUI_API void ScaleAllSizes(float scale_factor);    /* original C++ signature */
    def scale_all_sizes(self, scale_factor: float) -> None:  # imgui.h:1961
        pass
...
class KeyData:  # imgui.h:1973
    """[Internal] Storage used by IsKeyDown(), IsKeyPressed() etc functions.
    If prior to 1.87 you used io.KeysDownDuration[] (which was marked as internal), you should use GetKeyData(key)->DownDuration and *NOT* io.KeysData[key]->DownDuration.
    """

    # bool        Down;    /* original C++ signature */
    down: bool  # True for if key is down    # imgui.h:1975
    # float       DownDuration;    /* original C++ signature */
    down_duration: float  # Duration the key has been down (<0.0: not pressed, 0.0: just pressed, >0.0: time held)    # imgui.h:1976
    # float       DownDurationPrev;    /* original C++ signature */
    down_duration_prev: float  # Last frame duration the key has been down    # imgui.h:1977
    # float       AnalogValue;    /* original C++ signature */
    analog_value: float  # 0.0..1.0 for gamepad values    # imgui.h:1978
...
class IO:  # imgui.h:1981
    # ------------------------------------------------------------------
    # Configuration                            // Default value
    # ------------------------------------------------------------------

    # ImGuiConfigFlags   ConfigFlags;    /* original C++ signature */
    config_flags: ConfigFlags  # = 0              // See ImGuiConfigFlags_ enum. Set by user/application. Gamepad/keyboard navigation options, etc.    # imgui.h:1987
    # ImGuiBackendFlags  BackendFlags;    /* original C++ signature */
    backend_flags: BackendFlags  # = 0              // See ImGuiBackendFlags_ enum. Set by backend (imgui_impl_xxx files or custom backend) to communicate features supported by the backend.    # imgui.h:1988
    # ImVec2      DisplaySize;    /* original C++ signature */
    display_size: ImVec2  # <unset>          // Main display size, in pixels (generally == GetMainViewport()->Size). May change every frame.    # imgui.h:1989
    # float       DeltaTime;    /* original C++ signature */
    delta_time: float  # = 1.0/60.0     // Time elapsed since last frame, in seconds. May change every frame.    # imgui.h:1990
    # float       IniSavingRate;    /* original C++ signature */
    ini_saving_rate: float  # = 5.0           // Minimum time between saving positions/sizes to .ini file, in seconds.    # imgui.h:1991
    # const char* IniFilename;    /* original C++ signature */
    ini_filename: str  # = "imgui.ini"    // Path to .ini file (important: default "imgui.ini" is relative to current working dir!). Set None to disable automatic .ini loading/saving or if you want to manually call LoadIniSettingsXXX() / SaveIniSettingsXXX() functions.    # imgui.h:1992
    # const char* LogFilename;    /* original C++ signature */
    log_filename: str  # = "imgui_log.txt"// Path to .log file (default parameter to ImGui::LogToFile when no file is specified).    # imgui.h:1993
    # float       MouseDoubleClickTime;    /* original C++ signature */
    mouse_double_click_time: float  # = 0.30          // Time for a double-click, in seconds.    # imgui.h:1994
    # float       MouseDoubleClickMaxDist;    /* original C++ signature */
    mouse_double_click_max_dist: float  # = 6.0           // Distance threshold to stay in to validate a double-click, in pixels.    # imgui.h:1995
    # float       MouseDragThreshold;    /* original C++ signature */
    mouse_drag_threshold: float  # = 6.0           // Distance threshold before considering we are dragging.    # imgui.h:1996
    # float       KeyRepeatDelay;    /* original C++ signature */
    key_repeat_delay: float  # = 0.275         // When holding a key/button, time before it starts repeating, in seconds (for buttons in Repeat mode, etc.).    # imgui.h:1997
    # float       KeyRepeatRate;    /* original C++ signature */
    key_repeat_rate: float  # = 0.050         // When holding a key/button, rate at which it repeats, in seconds.    # imgui.h:1998
    # float       HoverDelayNormal;    /* original C++ signature */
    hover_delay_normal: float  # = 0.30 sec       // Delay on hovering before IsItemHovered(ImGuiHoveredFlags_DelayNormal) returns True.    # imgui.h:1999
    # float       HoverDelayShort;    /* original C++ signature */
    hover_delay_short: float  # = 0.10 sec       // Delay on hovering before IsItemHovered(ImGuiHoveredFlags_DelayShort) returns True.    # imgui.h:2000
    ...
    config_input_text_enter_keep_active: bool  # = False          // [BETA] Pressing Enter will keep item active and select contents (single-line only).    # imgui.h:2026
    # bool        ConfigDragClickToInputText;    /* original C++ signature */
    config_drag_click_to_input_text: bool  # = False          // [BETA] Enable turning DragXXX widgets into text input with a simple mouse click-release (without moving). Not desirable on devices without a keyboard.    # imgui.h:2027
    # bool        ConfigWindowsResizeFromEdges;    /* original C++ signature */
    config_windows_resize_from_edges: bool  # = True           // Enable resizing of windows from their edges and from the lower-left corner. This requires (io.BackendFlags & ImGuiBackendFlags_HasMouseCursors) because it needs mouse cursor feedback. (This used to be a per-window ImGuiWindowFlags_ResizeFromAnySide flag)    # imgui.h:2028
    # bool        ConfigWindowsMoveFromTitleBarOnly;    /* original C++ signature */
    config_windows_move_from_title_bar_only: bool  # = False       // Enable allowing to move windows only when clicking on their title bar. Does not apply to windows without a title bar.    # imgui.h:2029
    # float       ConfigMemoryCompactTimer;    /* original C++ signature */
    config_memory_compact_timer: float  # = 60.0          // Timer (in seconds) to free transient windows/tables memory buffers when unused. Set to -1.0 to disable.    # imgui.h:2030
    ...
    backend_platform_name: str  # = None    # imgui.h:2038
    # const char* BackendRendererName;    /* original C++ signature */
    backend_renderer_name: str  # = None    # imgui.h:2039
    # void*       BackendPlatformUserData;    /* original C++ signature */
    backend_platform_user_data: Any  # = None           // User data for platform backend    # imgui.h:2040
    # void*       BackendRendererUserData;    /* original C++ signature */
    backend_renderer_user_data: Any  # = None           // User data for renderer backend    # imgui.h:2041
    # void*       BackendLanguageUserData;    /* original C++ signature */
    backend_language_user_data: Any  # = None           // User data for non C++ programming language backend    # imgui.h:2042

    # Optional: Access OS clipboard
    # (default to use native Win32 clipboard on Windows, otherwise uses a private clipboard. Override to access OS clipboard on other architectures)
    # void*       ClipboardUserData;    /* original C++ signature */
    clipboard_user_data: Any  # imgui.h:2048
    ...
    def add_key_event(self, key: Key, down: bool) -> None:  # imgui.h:2064
    ...
    def set_app_accepting_events(self, accepting_events: bool) -> None:  # imgui.h:2076
        """Set master flag for accepting key/mouse/text events (default to True). Useful if you have native dialog boxes that are interrupting your application loop/refresh, and you want to disable events being queued while your app is frozen."""
        pass
    # IMGUI_API void  ClearInputCharacters();                                     /* original C++ signature */
    def clear_input_characters(self) -> None:  # imgui.h:2077
        """[Internal] Clear the text input buffer manually"""
        pass
    # IMGUI_API void  ClearInputKeys();                                           /* original C++ signature */
    def clear_input_keys(self) -> None:  # imgui.h:2078
    ...
    want_capture_keyboard: bool  # Set when Dear ImGui will use keyboard inputs, in this case do not dispatch them to your main game/application (either way, always pass keyboard inputs to imgui). (e.g. InputText active, or an imgui window is focused and navigation is enabled, etc.).    # imgui.h:2087
    # bool        WantTextInput;    /* original C++ signature */
    want_text_input: bool  # Mobile/console: when set, you may display an on-screen keyboard. This is set by Dear ImGui when it wants textual keyboard input to happen (e.g. when a InputText widget is active).    # imgui.h:2088
    # bool        WantSetMousePos;    /* original C++ signature */
    want_set_mouse_pos: bool  # MousePos has been altered, backend should reposition mouse on next frame. Rarely used! Set only when ImGuiConfigFlags_NavEnableSetMousePos flag is enabled.    # imgui.h:2089
    # bool        WantSaveIniSettings;    /* original C++ signature */
    want_save_ini_settings: bool  # When manual .ini load/save is active (io.IniFilename == None), this will be set to notify your application that you can call SaveIniSettingsToMemory() and save yourself. Important: clear io.WantSaveIniSettings yourself after saving!    # imgui.h:2090
    # bool        NavActive;    /* original C++ signature */
    nav_active: bool  # Keyboard/Gamepad navigation is currently allowed (will handle ImGuiKey_NavXXX events) = a window is focused and it doesn't use the ImGuiWindowFlags_NoNavInputs flag.    # imgui.h:2091
    # bool        NavVisible;    /* original C++ signature */
    nav_visible: bool  # Keyboard/Gamepad navigation is visible and allowed (will handle ImGuiKey_NavXXX events).    # imgui.h:2092
    # float       Framerate;    /* original C++ signature */
    framerate: float  # Estimate of application framerate (rolling average over 60 frames, based on io.DeltaTime), in frame per second. Solely for convenience. Slow applications may not want to use a moving average or may want to reset underlying buffers occasionally.    # imgui.h:2093
    # int         MetricsRenderVertices;    /* original C++ signature */
    metrics_render_vertices: int  # Vertices output during last call to Render()    # imgui.h:2094
    # int         MetricsRenderIndices;    /* original C++ signature */
    metrics_render_indices: int  # Indices output during last call to Render() = number of triangles * 3    # imgui.h:2095
    # int         MetricsRenderWindows;    /* original C++ signature */
    metrics_render_windows: int  # Number of visible windows    # imgui.h:2096
    # int         MetricsActiveWindows;    /* original C++ signature */
    metrics_active_windows: int  # Number of active windows    # imgui.h:2097
    # int         MetricsActiveAllocations;    /* original C++ signature */
    metrics_active_allocations: int  # Number of active allocations, updated by MemAlloc/MemFree based on current context. May be off if you have multiple imgui contexts.    # imgui.h:2098
    # ImVec2      MouseDelta;    /* original C++ signature */
    mouse_delta: ImVec2  # imgui.h:2099
    ...
    mouse_pos: ImVec2  # Mouse position, in pixels. Set to ImVec2(-FLT_MAX, -FLT_MAX) if mouse is unavailable (on another screen, etc.)    # imgui.h:2117
    ...
    mouse_wheel: float  # Mouse wheel Vertical: 1 unit scrolls about 5 lines text.    # imgui.h:2119
    # float       MouseWheelH;    /* original C++ signature */
    mouse_wheel_h: float  # Mouse wheel Horizontal. Most users don't have a mouse with a horizontal wheel, may not be filled by all backends.    # imgui.h:2120
    # ImGuiID     MouseHoveredViewport;    /* original C++ signature */
    mouse_hovered_viewport: ID  # (Optional) Modify using io.AddMouseViewportEvent(). With multi-viewports: viewport the OS mouse is hovering. If possible _IGNORING_ viewports with the ImGuiViewportFlags_NoInputs flag is much better (few backends can handle that). Set io.BackendFlags |= ImGuiBackendFlags_HasMouseHoveredViewport if you can provide this info. If you don't imgui will infer the value using the rectangles and last focused time of the viewports it knows about (ignoring other OS windows).    # imgui.h:2121
    # bool        KeyCtrl;    /* original C++ signature */
    key_ctrl: bool  # Keyboard modifier down: Control    # imgui.h:2122
    # bool        KeyShift;    /* original C++ signature */
    key_shift: bool  # Keyboard modifier down: Shift    # imgui.h:2123
    # bool        KeyAlt;    /* original C++ signature */
    key_alt: bool  # Keyboard modifier down: Alt    # imgui.h:2124
    # bool        KeySuper;    /* original C++ signature */
    key_super: bool  # Keyboard modifier down: Cmd/Super/Windows    # imgui.h:2125

    # Other state maintained from data above + IO function calls
    # ImGuiKeyChord KeyMods;    /* original C++ signature */
    key_mods: KeyChord  # Key mods flags (any of ImGuiMod_Ctrl/ImGuiMod_Shift/ImGuiMod_Alt/ImGuiMod_Super flags, same as io.KeyCtrl/KeyShift/KeyAlt/KeySuper but merged into flags). Read-only, updated by NewFrame()    # imgui.h:2128
    # bool        WantCaptureMouseUnlessPopupClose;    /* original C++ signature */
    want_capture_mouse_unless_popup_close: bool  # Alternative to WantCaptureMouse: (WantCaptureMouse == True && WantCaptureMouseUnlessPopupClose == False) when a click over None is expected to close a popup.    # imgui.h:2130
    # ImVec2      MousePosPrev;    /* original C++ signature */
    mouse_pos_prev: ImVec2  # Previous mouse position (note that MouseDelta is not necessary == MousePos-MousePosPrev, in case either position is invalid)    # imgui.h:2131
    # double      MouseClickedTime[5];    /* original C++ signature */
    mouse_clicked_time: np.ndarray  # ndarray[type=double, size=5]  # Time of last click (used to figure out double-click)    # imgui.h:2133
    # bool        MouseClicked[5];    /* original C++ signature */
    mouse_clicked: np.ndarray  # ndarray[type=bool, size=5]  # Mouse button went from !Down to Down (same as MouseClickedCount[x] != 0)    # imgui.h:2134
    # bool        MouseDoubleClicked[5];    /* original C++ signature */
    mouse_double_clicked: np.ndarray  # ndarray[type=bool, size=5]  # Has mouse button been double-clicked? (same as MouseClickedCount[x] == 2)    # imgui.h:2135
    # ImU16       MouseClickedCount[5];    /* original C++ signature */
    mouse_clicked_count: np.ndarray  # ndarray[type=ImU16, size=5]  # == 0 (not clicked), == 1 (same as MouseClicked[]), == 2 (double-clicked), == 3 (triple-clicked) etc. when going from !Down to Down    # imgui.h:2136
    # ImU16       MouseClickedLastCount[5];    /* original C++ signature */
    mouse_clicked_last_count: np.ndarray  # ndarray[type=ImU16, size=5]  # Count successive number of clicks. Stays valid after mouse release. Reset after another click is done.    # imgui.h:2137
    # bool        MouseReleased[5];    /* original C++ signature */
    mouse_released: np.ndarray  # ndarray[type=bool, size=5]  # Mouse button went from Down to !Down    # imgui.h:2138
    # bool        MouseDownOwned[5];    /* original C++ signature */
    mouse_down_owned: np.ndarray  # ndarray[type=bool, size=5]  # Track if button was clicked inside a dear imgui window or over None blocked by a popup. We don't request mouse capture from the application if click started outside ImGui bounds.    # imgui.h:2139
    # bool        MouseDownOwnedUnlessPopupClose[5];    /* original C++ signature */
    mouse_down_owned_unless_popup_close: np.ndarray  # ndarray[type=bool, size=5]  # Track if button was clicked inside a dear imgui window.    # imgui.h:2140
    # float       MouseDownDuration[5];    /* original C++ signature */
    mouse_down_duration: np.ndarray  # ndarray[type=float, size=5]  # Duration the mouse button has been down (0.0 == just clicked)    # imgui.h:2141
    # float       MouseDownDurationPrev[5];    /* original C++ signature */
    mouse_down_duration_prev: np.ndarray  # ndarray[type=float, size=5]  # Previous time the mouse button has been down    # imgui.h:2142
    # float       MouseDragMaxDistanceSqr[5];    /* original C++ signature */
    mouse_drag_max_distance_sqr: np.ndarray  # ndarray[type=float, size=5]  # Squared maximum distance of how much mouse has traveled from the clicking point (used for moving thresholds)    # imgui.h:2144
...
class SizeCallbackData:  # imgui.h:2200
    ...
    # void*   UserData;    /* original C++ signature */
    user_data: Any  # Read-only.   What user passed to SetNextWindowSizeConstraints(). Generally store an integer or float in here (need reinterpret_cast<>).    # imgui.h:2202
...
class OnceUponAFrame:  # imgui.h:2289
    ...
    def __bool__(self) -> bool:  # imgui.h:2293
        pass
...
class ImFontAtlas:  # imgui.h:2864
    ...
    def add_custom_rect_regular(self, width: int, height: int) -> int:  # imgui.h:2918
        pass
    ...
    flags: ImFontAtlasFlags  # Build flags (see ImFontAtlasFlags_)    # imgui.h:2930
    # ImTextureID                 TexID;    /* original C++ signature */
    tex_id: ImTextureID  # User data to refer to the texture once it has been uploaded to user's graphic systems. It is passed back to you during rendering via the ImDrawCmd structure.    # imgui.h:2931
    # int                         TexDesiredWidth;    /* original C++ signature */
    tex_desired_width: int  # Texture width desired by user before Build(). Must be a power-of-two. If have many glyphs your graphics API have texture size restrictions you may want to increase texture width to decrease height.    # imgui.h:2932
    # int                         TexGlyphPadding;    /* original C++ signature */
    tex_glyph_padding: int  # Padding between glyphs within texture in pixels. Defaults to 1. If your rendering method doesn't rely on bilinear filtering you may set this to 0 (will also need to set AntiAliasedLinesUseTex = False).    # imgui.h:2933
    # bool                        Locked;    /* original C++ signature */
    locked: bool  # Marked as Locked by ImGui::NewFrame() so attempt to modify the atlas will assert.    # imgui.h:2934

    # [Internal]
    # NB: Access texture data via GetTexData*() calls! Which will setup a default font for you.
    # bool                        TexReady;    /* original C++ signature */
    tex_ready: bool  # Set when texture was built matching current font input    # imgui.h:2938
    # bool                        TexPixelsUseColors;    /* original C++ signature */
    tex_pixels_use_colors: bool  # Tell whether our texture data is known to use colors (rather than just alpha channel), in order to help backend select a format.    # imgui.h:2939
    # int                         TexWidth;    /* original C++ signature */
    tex_width: int  # Texture width calculated during Build().    # imgui.h:2942
    # int                         TexHeight;    /* original C++ signature */
    tex_height: int  # Texture height calculated during Build().    # imgui.h:2943
    # ImVec2                      TexUvScale;    /* original C++ signature */
    tex_uv_scale: ImVec2  # = (1.0/TexWidth, 1.0/TexHeight)    # imgui.h:2944
    # ImVec2                      TexUvWhitePixel;    /* original C++ signature */
    tex_uv_white_pixel: ImVec2  # Texture coordinates to a white pixel    # imgui.h:2945

    # [Internal] Font builder
    # const ImFontBuilderIO*      FontBuilderIO;    /* original C++ signature */
    font_builder_io: ImFontBuilderIO  # Opaque interface to a font builder (default to stb_truetype, can be changed to use FreeType by defining IMGUI_ENABLE_FREETYPE).    # imgui.h:2952
    # unsigned int                FontBuilderFlags;    /* original C++ signature */
    font_builder_flags: int  # Shared flags (for all fonts) for custom font builder. THIS IS BUILD IMPLEMENTATION DEPENDENT. Per-font override is also available in ImFontConfig.    # imgui.h:2953

    # [Internal] Packing data
    # int                         PackIdMouseCursors;    /* original C++ signature */
    pack_id_mouse_cursors: int  # Custom texture rectangle ID for white pixel and mouse cursors    # imgui.h:2956
    # int                         PackIdLines;    /* original C++ signature */
    pack_id_lines: int  # Custom texture rectangle ID for baked anti-aliased lines    # imgui.h:2957

    # [Obsolete]
    # typedef ImFontAtlasCustomRect    CustomRect;         // OBSOLETED in 1.72+
    # typedef ImFontGlyphRangesBuilder GlyphRangesBuilder; // OBSOLETED in 1.67+

class ImFont:  # imgui.h:2966
    ...
    fallback_advance_x: float  # 4     // out // = FallbackGlyph->AdvanceX    # imgui.h:2970
    # float                       FontSize;    /* original C++ signature */
    font_size: float  # 4     // in  //            // Height of characters/line, set during loading (don't change after loading)    # imgui.h:2971

    # Members: Hot ~28/40 bytes (for CalcTextSize + render loop)
    # const ImFontGlyph*          FallbackGlyph;    /* original C++ signature */
    fallback_glyph: ImFontGlyph  # 4-8   // out // = FindGlyph(FontFallbackChar)    # imgui.h:2976

    # Members: Cold ~32/40 bytes
    # ImFontAtlas*                ContainerAtlas;    /* original C++ signature */
    container_atlas: ImFontAtlas  # 4-8   // out //            // What we has been loaded into    # imgui.h:2979
    # const ImFontConfig*         ConfigData;    /* original C++ signature */
    config_data: ImFontConfig  # 4-8   // in  //            // Pointer within ContainerAtlas->ConfigData    # imgui.h:2980
    # short                       ConfigDataCount;    /* original C++ signature */
    config_data_count: int  # 2     // in  // ~ 1        // Number of ImFontConfig involved in creating this font. Bigger than 1 when merging multiple font sources into one ImFont.    # imgui.h:2981
    # ImWchar                     FallbackChar;    /* original C++ signature */
    fallback_char: ImWchar  # 2     // out // = FFFD/'?' // Character used if a glyph isn't found.    # imgui.h:2982
    # ImWchar                     EllipsisChar;    /* original C++ signature */
    ellipsis_char: ImWchar  # 2     // out // = '...'    // Character used for ellipsis rendering.    # imgui.h:2983
    # ImWchar                     DotChar;    /* original C++ signature */
    dot_char: ImWchar  # 2     // out // = '.'      // Character used for ellipsis rendering (if a single '...' character isn't found)    # imgui.h:2984
    # bool                        DirtyLookupTables;    /* original C++ signature */
    dirty_lookup_tables: bool  # 1     // out //    # imgui.h:2985
    # float                       Scale;    /* original C++ signature */
    scale: float  # 4     // in  // = 1.      // Base font scale, multiplied by the per-window font scale which you can adjust with SetWindowFontScale()    # imgui.h:2986
    # float                       Ascent,     /* original C++ signature */
    ascent: float  # 4+4   // out //            // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize]    # imgui.h:2987
    # Descent;    /* original C++ signature */
    descent: float  # 4+4   // out //            // Ascent: distance from top to bottom of e.g. 'A' [0..FontSize]    # imgui.h:2987
    # int                         MetricsTotalSurface;    /* original C++ signature */
    metrics_total_surface: int  # 4     // out //            // Total surface in pixels to get an idea of the font rasterization/texture cost (not exact, we approximate the cost of padding between glyphs)    # imgui.h:2988

    # IMGUI_API ImFont();    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:2992
        """Methods"""
        pass
    # IMGUI_API const ImFontGlyph*FindGlyph(ImWchar c) const;    /* original C++ signature */
    def find_glyph(self, c: ImWchar) -> ImFontGlyph:  # imgui.h:2994
        pass
    # IMGUI_API const ImFontGlyph*FindGlyphNoFallback(ImWchar c) const;    /* original C++ signature */
    def find_glyph_no_fallback(self, c: ImWchar) -> ImFontGlyph:  # imgui.h:2995
        pass
    ...
    def build_lookup_table(self) -> None:  # imgui.h:3008
        pass
    # IMGUI_API void              ClearOutputData();    /* original C++ signature */
    def clear_output_data(self) -> None:  # imgui.h:3009
        pass
    # IMGUI_API void              GrowIndex(int new_size);    /* original C++ signature */
    def grow_index(self, new_size: int) -> None:  # imgui.h:3010
        pass
    ...
    def set_glyph_visible(self, c: ImWchar, visible: bool) -> None:  # imgui.h:3013
        pass
    # IMGUI_API bool              IsGlyphRangeUnused(unsigned int c_begin, unsigned int c_last);    /* original C++ signature */
    def is_glyph_range_unused(self, c_begin: int, c_last: int) -> bool:  # imgui.h:3014
        pass
...
class ViewportFlags_(enum.Enum):  # imgui.h:3022
...
class Viewport:  # imgui.h:3047
    ...
    id_: ID  # Unique identifier for the viewport    # imgui.h:3049
    # ImGuiViewportFlags  Flags;    /* original C++ signature */
    flags: ViewportFlags  # See ImGuiViewportFlags_    # imgui.h:3050
    # ImVec2              Pos;    /* original C++ signature */
    pos: ImVec2  # Main Area: Position of the viewport (Dear ImGui coordinates are the same as OS desktop/native coordinates)    # imgui.h:3051
    # ImVec2              Size;    /* original C++ signature */
    size: ImVec2  # Main Area: Size of the viewport.    # imgui.h:3052
    # ImVec2              WorkPos;    /* original C++ signature */
    work_pos: ImVec2  # Work Area: Position of the viewport minus task bars, menus bars, status bars (>= Pos)    # imgui.h:3053
    # ImVec2              WorkSize;    /* original C++ signature */
    work_size: ImVec2  # Work Area: Size of the viewport minus task bars, menu bars, status bars (<= Size)    # imgui.h:3054
    # float               DpiScale;    /* original C++ signature */
    dpi_scale: float  # 1.0 = 96 DPI = No extra scale.    # imgui.h:3055
    # ImGuiID             ParentViewportId;    /* original C++ signature */
    parent_viewport_id: ID  # (Advanced) 0: no parent. Instruct the platform backend to setup a parent/child relationship between platform windows.    # imgui.h:3056
    # ImDrawData*         DrawData;    /* original C++ signature */
    draw_data: ImDrawData  # The ImDrawData corresponding to this viewport. Valid after Render() and until the next call to NewFrame().    # imgui.h:3057
    ...
    renderer_user_data: Any  # None* to hold custom data structure for the renderer (e.g. swap chain, framebuffers etc.). generally set by your Renderer_CreateWindow function.    # imgui.h:3064
    # void*               PlatformUserData;    /* original C++ signature */
    platform_user_data: Any  # None* to hold custom data structure for the OS / platform (e.g. windowing info, render context). generally set by your Platform_CreateWindow function.    # imgui.h:3065
    # void*               PlatformHandle;    /* original C++ signature */
    platform_handle: Any  # None* for FindViewportByPlatformHandle(). (e.g. suggested to use natural platform handle such as HWND, GLFWWindow*, SDL_Window*)    # imgui.h:3066
    # void*               PlatformHandleRaw;    /* original C++ signature */
    platform_handle_raw: Any  # None* to hold lower-level, platform-native window handle (under Win32 this is expected to be a HWND, unused for other platforms), when using an abstraction layer like GLFW or SDL (where PlatformHandle would be a SDL_Window*)    # imgui.h:3067
    # bool                PlatformWindowCreated;    /* original C++ signature */
    platform_window_created: bool  # Platform window has been created (Platform_CreateWindow() has been called). This is False during the first frame where a viewport is being created.    # imgui.h:3068
    # bool                PlatformRequestMove;    /* original C++ signature */
    platform_request_move: bool  # Platform window requested move (e.g. window was moved by the OS / host window manager, authoritative position will be OS window position)    # imgui.h:3069
    # bool                PlatformRequestResize;    /* original C++ signature */
    platform_request_resize: bool  # Platform window requested resize (e.g. window was resized by the OS / host window manager, authoritative size will be OS window size)    # imgui.h:3070
    # bool                PlatformRequestClose;    /* original C++ signature */
    platform_request_close: bool  # Platform window requested closure (e.g. window was moved by the OS / host window manager, e.g. pressing ALT-F4)    # imgui.h:3071

    # ImGuiViewport()     { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui.h:3073
        pass
    # Helpers
...
class PlatformIO:  # imgui.h:3131
    ...
    def __init__(self) -> None:  # imgui.h:3189
        """Zero clear"""
        pass

class PlatformMonitor:  # imgui.h:3194
    """(Optional) This is required when enabling multi-viewport. Represent the bounds of each connected monitor/display and their DPI.
    We use this information for multiple DPI support + clamping the position of popups and tooltips so they don't straddle multiple monitors.
    """

    # ImVec2  MainPos,     /* original C++ signature */
    main_pos: ImVec2  # Coordinates of the area displayed on this monitor (Min = upper left, Max = bottom right)    # imgui.h:3196
    # MainSize;    /* original C++ signature */
    main_size: ImVec2  # Coordinates of the area displayed on this monitor (Min = upper left, Max = bottom right)    # imgui.h:3196
    # ImVec2  WorkPos,     /* original C++ signature */
    work_pos: ImVec2  # Coordinates without task bars / side bars / menu bars. Used to avoid positioning popups/tooltips inside this region. If you don't have this info, please copy the value for MainPos/MainSize.    # imgui.h:3197
    # WorkSize;    /* original C++ signature */
    work_size: ImVec2  # Coordinates without task bars / side bars / menu bars. Used to avoid positioning popups/tooltips inside this region. If you don't have this info, please copy the value for MainPos/MainSize.    # imgui.h:3197
    # float   DpiScale;    /* original C++ signature */
    dpi_scale: float  # 1.0 = 96 DPI    # imgui.h:3198
...
class PlatformImeData:  # imgui.h:3203
    """(Optional) Support for IME (Input Method Editor) via the io.SetPlatformImeDataFn() function."""

    # bool    WantVisible;    /* original C++ signature */
    want_visible: bool  # A widget wants the IME to be visible    # imgui.h:3205
    # ImVec2  InputPos;    /* original C++ signature */
    input_pos: ImVec2  # Position of the input cursor    # imgui.h:3206
    # float   InputLineHeight;    /* original C++ signature */
    input_line_height: float  # Line height    # imgui.h:3207
