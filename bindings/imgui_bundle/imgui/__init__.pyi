...
class ChildFlags_(enum.Enum):
    ...
    none = enum.auto()  # (= 0)
    # ImGuiChildFlags_Border                  = 1 << 0,       /* original C++ signature */
    border = (
        enum.auto()
    ...
    nav_flattened = (
        enum.auto()
    )  # (= 1 << 8)  # Share focus scope, allow gamepad/keyboard navigation to cross over parent border to this child or between sibling child windows.
...
class Col_(enum.Enum):
    ...
    text_selected_bg = enum.auto()  # (= 51)
    # ImGuiCol_DragDropTarget,            /* original C++ signature */
    drag_drop_target = enum.auto()  # (= 52)  # Rectangle highlighting a drop target
    # ImGuiCol_NavHighlight,              /* original C++ signature */
    nav_highlight = enum.auto()  # (= 53)  # Gamepad/keyboard: current highlighted item
    # ImGuiCol_NavWindowingHighlight,     /* original C++ signature */
    nav_windowing_highlight = enum.auto()  # (= 54)  # Highlight window when using CTRL+TAB
    # ImGuiCol_NavWindowingDimBg,         /* original C++ signature */
    nav_windowing_dim_bg = (
        enum.auto()
    )  # (= 55)  # Darken/colorize entire screen behind the CTRL+TAB window list, when active
    # ImGuiCol_ModalWindowDimBg,          /* original C++ signature */
    modal_window_dim_bg = (
        enum.auto()
    )  # (= 56)  # Darken/colorize entire screen behind a modal window, when one is active
...
class StyleVar_(enum.Enum):
    ...
    table_angled_headers_angle = enum.auto()  # (= 26)  # float     TableAngledHeadersAngle
    # ImGuiStyleVar_TableAngledHeadersTextAlign,    /* original C++ signature */
    table_angled_headers_text_align = enum.auto()  # (= 27)  # ImVec2  TableAngledHeadersTextAlign
    # ImGuiStyleVar_ButtonTextAlign,              /* original C++ signature */
    button_text_align = enum.auto()  # (= 28)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,          /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 29)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_SeparatorTextBorderSize,      /* original C++ signature */
    separator_text_border_size = enum.auto()  # (= 30)  # float     SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,           /* original C++ signature */
    separator_text_align = enum.auto()  # (= 31)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,         /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 32)  # ImVec2    SeparatorTextPadding
    # ImGuiStyleVar_DockingSeparatorSize,         /* original C++ signature */
    docking_separator_size = enum.auto()  # (= 33)  # float     DockingSeparatorSize
...
class ImVector_NavTreeNodeData:  # Python specialization for ImVector<ImGuiNavTreeNodeData>
    ...
    # inline ImVector(const ImVector<T>& src)                 { Size = Capacity = 0; Data = NULL; operator=(src); }    /* original C++ signature */
    @overload
    def __init__(self, src: ImVector_NavTreeNodeData) -> None:
        pass
    # inline void         clear()                             { if (Data) { Size = Capacity = 0; IM_FREE(Data); Data = NULL; } }    /* original C++ signature */
    def clear(self) -> None:
        """Important: does not destruct anything
    ...
    # inline const T&     operator[](int i) const             { IM_ASSERT(i >= 0 && i < Size); return Data[i]; }    /* original C++ signature */
    @overload
    def __getitem__(self, i: int) -> NavTreeNodeData:
        """(private API)"""
        pass
    # inline T&           operator[](int i)                   { IM_ASSERT(i >= 0 && i < Size); return Data[i]; }    /* original C++ signature */
    @overload
    ...
    # NB: It is illegal to call push_back/push_front/insert with a reference pointing inside the ImVector data itself! e.g. v.push_back(v[10]) is forbidden.
    # inline void         push_back(const T& v)               { if (Size == Capacity) reserve(_grow_capacity(Size + 1)); memcpy(&Data[Size], &v, sizeof(v)); Size++; }    /* original C++ signature */
    def push_back(self, v: NavTreeNodeData) -> None:
        """(private API)"""
        pass
    # inline void         pop_back()                          { IM_ASSERT(Size > 0); Size--; }    /* original C++ signature */
    def pop_back(self) -> None:
...
class ImFont:
    ...
    index_advance_x: ImVector_float  # 12-16 // out //            // Sparse. Glyphs->AdvanceX in a directly indexable way (cache-friendly for CalcTextSize functions which only this this info, and are often bottleneck in large UI).
