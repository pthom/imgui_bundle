...
class ChildFlags_(enum.Enum):
    ...
    nav_flattened = (
        enum.auto()
    )  # (= 1 << 8)  # [BETA] Share focus scope, allow gamepad/keyboard navigation to cross over parent border to this child or between sibling child windows.
...
class Col_(enum.Enum):
    ...
    nav_highlight = enum.auto()  # (= 54)  # Gamepad/keyboard: current highlighted item
