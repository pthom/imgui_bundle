...
class ImVec2:
    ...
    def __init__(self, _x: float, _y: float) -> None:
        pass
    # float  operator[] (size_t idx) const    { IM_ASSERT(idx == 0 || idx == 1); return (&x)[idx]; }      /* original C++ signature */
    def __getitem__(self, idx: int) -> float:
        ...
        """
        pass
    # float& operator[] (size_t idx)          { IM_ASSERT(idx == 0 || idx == 1); return (&x)[idx]; }      /* original C++ signature */
    def __getitem__(self, idx: int) -> float:
        """(private API)"""
        pass
    # We very rarely use this [] operator, the assert overhead is fine.
