...
class StyleVar_(enum.Enum):
    ...
    tab_border_size = enum.auto()  # (= 23)  # float     TabBorderSize
    # ImGuiStyleVar_TabBarBorderSize,             /* original C++ signature */
    tab_bar_border_size = enum.auto()  # (= 24)  # float     TabBarBorderSize
    # ImGuiStyleVar_TableAngledHeadersAngle,      /* original C++ signature */
    table_angled_headers_angle = enum.auto()  # (= 25)  # float     TableAngledHeadersAngle
    # ImGuiStyleVar_TableAngledHeadersTextAlign,    /* original C++ signature */
    table_angled_headers_text_align = enum.auto()  # (= 26)  # ImVec2  TableAngledHeadersTextAlign
    # ImGuiStyleVar_ButtonTextAlign,              /* original C++ signature */
    button_text_align = enum.auto()  # (= 27)  # ImVec2    ButtonTextAlign
    # ImGuiStyleVar_SelectableTextAlign,          /* original C++ signature */
    selectable_text_align = enum.auto()  # (= 28)  # ImVec2    SelectableTextAlign
    # ImGuiStyleVar_SeparatorTextBorderSize,      /* original C++ signature */
    separator_text_border_size = enum.auto()  # (= 29)  # float     SeparatorTextBorderSize
    # ImGuiStyleVar_SeparatorTextAlign,           /* original C++ signature */
    separator_text_align = enum.auto()  # (= 30)  # ImVec2    SeparatorTextAlign
    # ImGuiStyleVar_SeparatorTextPadding,         /* original C++ signature */
    separator_text_padding = enum.auto()  # (= 31)  # ImVec2    SeparatorTextPadding
    # ImGuiStyleVar_DockingSeparatorSize,         /* original C++ signature */
    docking_separator_size = enum.auto()  # (= 32)  # float     DockingSeparatorSize
    # ImGuiStyleVar_LayoutAlign,             /* original C++ signature */
    layout_align = enum.auto()  # (= 33)  # float     LayoutAlign
