...
class InputTextState:
    ...
    # int                     CurLenA;    /* original C++ signature */
    cur_len_a: int  # UTF-8 length of the string in TextA (in bytes)
    # ImVector<char>          TextA;    /* original C++ signature */
    text_a: ImVector_char  # main UTF8 buffer.
    ...
    def __init__(self) -> None:
        pass
    # void        ClearText()                 { CurLenA = 0; TextA[0] = 0; CursorClamp(); }    /* original C++ signature */
    def clear_text(self) -> None:
        """(private API)"""
        pass
    # void        ClearFreeMemory()           { TextA.clear(); InitialTextA.clear(); }    /* original C++ signature */
    def clear_free_memory(self) -> None:
        """(private API)"""
        pass
...
class DebugLogFlags_(enum.Enum):
    ...
    # ImGuiDebugLogFlags_EventInputRouting    = 1 << 8,    /* original C++ signature */
    event_input_routing = enum.auto()  # (= 1 << 8)
    # ImGuiDebugLogFlags_EventDocking         = 1 << 9,    /* original C++ signature */
    event_docking = enum.auto()  # (= 1 << 9)
    # ImGuiDebugLogFlags_EventViewport        = 1 << 10,    /* original C++ signature */
    event_viewport = enum.auto()  # (= 1 << 10)
    ...
    event_mask_ = (
        enum.auto()
    )  # (= DebugLogFlags_EventError | DebugLogFlags_EventActiveId | DebugLogFlags_EventFocus | DebugLogFlags_EventPopup | DebugLogFlags_EventNav | DebugLogFlags_EventClipper | DebugLogFlags_EventSelection | DebugLogFlags_EventIO | DebugLogFlags_EventInputRouting | DebugLogFlags_EventDocking | DebugLogFlags_EventViewport)
