...
) -> ID:  # imgui_internal.h:330
    pass

# Helpers: Sorting

# IMGUI_API ImU32         ImAlphaBlendColors(ImU32 col_a, ImU32 col_b);    /* original C++ signature */
def im_alpha_blend_colors(col_a: ImU32, col_b: ImU32) -> ImU32:  # imgui_internal.h:338
...
class TextIndex:  # imgui_internal.h:721
    """Helper: ImGuiTextIndex<>
    Maintain a line index for a text buffer. This is a strong candidate to be moved into the public API.
    """

    # int             EndOffset = 0;    /* original C++ signature */
    end_offset: int = 0  # Because we don't own text buffer we need to maintain EndOffset (may bake in LineOffsets?)    # imgui_internal.h:724
...
class ImDrawListSharedData:  # imgui_internal.h:764
    """Data shared between all ImDrawList instances
    You may want to create your own instance of this if you want to use ImDrawList completely without ImGui. In that case, watch out for future changes to this structure.
    """

    # ImVec2          TexUvWhitePixel;    /* original C++ signature */
    tex_uv_white_pixel: ImVec2  # UV of white pixel in the atlas    # imgui_internal.h:766
    # ImFont*         Font;    /* original C++ signature */
    font: ImFont  # Current/default font (optional, for simplified AddText overload)    # imgui_internal.h:767
    # float           FontSize;    /* original C++ signature */
    font_size: float  # Current/default font size (optional, for simplified AddText overload)    # imgui_internal.h:768
    # float           CurveTessellationTol;    /* original C++ signature */
    curve_tessellation_tol: float  # Tessellation tolerance when using PathBezierCurveTo()    # imgui_internal.h:769
    # float           CircleSegmentMaxError;    /* original C++ signature */
    circle_segment_max_error: float  # Number of circle segments to use per pixel of radius for AddCircle() etc    # imgui_internal.h:770
    # ImVec4          ClipRectFullscreen;    /* original C++ signature */
    clip_rect_fullscreen: ImVec4  # Value for PushClipRectFullscreen()    # imgui_internal.h:771
    # ImDrawListFlags InitialFlags;    /* original C++ signature */
    initial_flags: ImDrawListFlags  # Initial flags at the beginning of the frame (it is possible to alter flags on a per-drawlist basis afterwards)    # imgui_internal.h:772

    # [Internal] Lookup tables
    # float           ArcFastRadiusCutoff;    /* original C++ signature */
    arc_fast_radius_cutoff: float  # Cutoff radius after which arc drawing will fallback to slower PathArcTo()    # imgui_internal.h:779
    # ImU8            CircleSegmentCounts[64];    /* original C++ signature */
    circle_segment_counts: np.ndarray  # ndarray[type=ImU8, size=64]  # Precomputed segment count for given radius before we calculate it dynamically (to avoid calculation overhead)    # imgui_internal.h:780
    # const ImVec4*   TexUvLines;    /* original C++ signature */
    tex_uv_lines: ImVec4  # UV of anti-aliased lines in the atlas    # imgui_internal.h:781

    # ImDrawListSharedData();    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:783
        pass

class ImDrawDataBuilder:  # imgui_internal.h:787

    # IMGUI_API void FlattenIntoSingleLayer();    /* original C++ signature */
    def flatten_into_single_layer(self) -> None:  # imgui_internal.h:794
        pass
...
class ItemFlags_(enum.Enum):  # imgui_internal.h:806
...
class ItemStatusFlags_(enum.Enum):  # imgui_internal.h:826
...
class InputTextFlagsPrivate_(enum.Enum):  # imgui_internal.h:849
...
class ButtonFlagsPrivate_(enum.Enum):  # imgui_internal.h:858
...
class ComboFlagsPrivate_(enum.Enum):  # imgui_internal.h:883
...
class SliderFlagsPrivate_(enum.Enum):  # imgui_internal.h:889
...
class SelectableFlagsPrivate_(enum.Enum):  # imgui_internal.h:896
...
class TreeNodeFlagsPrivate_(enum.Enum):  # imgui_internal.h:911
...
class SeparatorFlags_(enum.Enum):  # imgui_internal.h:916
...
class TextFlags_(enum.Enum):  # imgui_internal.h:924
...
class TooltipFlags_(enum.Enum):  # imgui_internal.h:930
...
class LayoutType_(enum.Enum):  # imgui_internal.h:938
...
class LogType(enum.Enum):  # imgui_internal.h:944
...
class Axis(enum.Enum):  # imgui_internal.h:954
...
class PlotType(enum.Enum):  # imgui_internal.h:961
...
class PopupPositionPolicy(enum.Enum):  # imgui_internal.h:967
...
class DataTypeTempStorage:  # imgui_internal.h:974
    # ImU8        Data[8];    /* original C++ signature */
    data: np.ndarray  # ndarray[type=ImU8, size=8]  # Can fit any data up to ImGuiDataType_COUNT    # imgui_internal.h:976
    # ImGuiDataTypeTempStorage();    /* original C++ signature */
    def __init__(self) -> None:  # Line:3
        """Auto-generated default constructor"""
        pass

class DataTypeInfo:  # imgui_internal.h:980
    """Type information associated to one ImGuiDataType. Retrieve with DataTypeGetInfo()."""

    # size_t      Size;    /* original C++ signature */
    size: int  # Size in bytes    # imgui_internal.h:982
    # const char* Name;    /* original C++ signature */
    name: str  # Short descriptive name for the type, for debugging    # imgui_internal.h:983
    # const char* PrintFmt;    /* original C++ signature */
    print_fmt: str  # Default printf format for the type    # imgui_internal.h:984
    # const char* ScanFmt;    /* original C++ signature */
    scan_fmt: str  # Default scanf format for the type    # imgui_internal.h:985
    # ImGuiDataTypeInfo(size_t Size = size_t());    /* original C++ signature */
    def __init__(self, size: int = int()) -> None:  # Line:3
        """Auto-generated default constructor with named params"""
        pass

class DataTypePrivate_(enum.Enum):  # imgui_internal.h:989
...
class ColorMod:  # imgui_internal.h:997
    """Stacked color modifier, backup of modified data so we can restore it"""

    # ImGuiCol        Col;    /* original C++ signature */
    col: Col  # imgui_internal.h:999
    # ImVec4          BackupValue;    /* original C++ signature */
    backup_value: ImVec4  # imgui_internal.h:1000
...
class StyleMod:  # imgui_internal.h:1004
    """Stacked style modifier, backup of modified data so we can restore it. Data type inferred from the variable."""

    # ImGuiStyleVar   VarIdx;    /* original C++ signature */
    var_idx: StyleVar  # imgui_internal.h:1006
    # ImGuiStyleMod(ImGuiStyleVar idx, int v)     { VarIdx = idx; BackupInt[0] = v; }    /* original C++ signature */
    def __init__(self, idx: StyleVar, v: int) -> None:  # imgui_internal.h:1008
        pass
    # ImGuiStyleMod(ImGuiStyleVar idx, float v)   { VarIdx = idx; BackupFloat[0] = v; }    /* original C++ signature */
    def __init__(self, idx: StyleVar, v: float) -> None:  # imgui_internal.h:1009
        pass
    # ImGuiStyleMod(ImGuiStyleVar idx, ImVec2 v)  { VarIdx = idx; BackupFloat[0] = v.x; BackupFloat[1] = v.y; }    /* original C++ signature */
    def __init__(self, idx: StyleVar, v: ImVec2) -> None:  # imgui_internal.h:1010
        pass

class ComboPreviewData:  # imgui_internal.h:1014
    """Storage data for BeginComboPreview()/EndComboPreview()"""

    # ImRect          PreviewRect;    /* original C++ signature */
    preview_rect: ImRect  # imgui_internal.h:1016
    # ImVec2          BackupCursorPos;    /* original C++ signature */
    backup_cursor_pos: ImVec2  # imgui_internal.h:1017
    # ImVec2          BackupCursorMaxPos;    /* original C++ signature */
    backup_cursor_max_pos: ImVec2  # imgui_internal.h:1018
    # ImVec2          BackupCursorPosPrevLine;    /* original C++ signature */
    backup_cursor_pos_prev_line: ImVec2  # imgui_internal.h:1019
    # float           BackupPrevLineTextBaseOffset;    /* original C++ signature */
    backup_prev_line_text_base_offset: float  # imgui_internal.h:1020
    # ImGuiLayoutType BackupLayout;    /* original C++ signature */
    backup_layout: LayoutType  # imgui_internal.h:1021

    # ImGuiComboPreviewData() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1023
        pass

class GroupData:  # imgui_internal.h:1027
    """Stacked storage data for BeginGroup()/EndGroup()"""

    # ImGuiID     WindowID;    /* original C++ signature */
    window_id: ID  # imgui_internal.h:1029
    # ImVec2      BackupCursorPos;    /* original C++ signature */
    backup_cursor_pos: ImVec2  # imgui_internal.h:1030
    # ImVec2      BackupCursorMaxPos;    /* original C++ signature */
    backup_cursor_max_pos: ImVec2  # imgui_internal.h:1031
    # ImVec1      BackupIndent;    /* original C++ signature */
    backup_indent: ImVec1  # imgui_internal.h:1032
    # ImVec1      BackupGroupOffset;    /* original C++ signature */
    backup_group_offset: ImVec1  # imgui_internal.h:1033
    # ImVec2      BackupCurrLineSize;    /* original C++ signature */
    backup_curr_line_size: ImVec2  # imgui_internal.h:1034
    # float       BackupCurrLineTextBaseOffset;    /* original C++ signature */
    backup_curr_line_text_base_offset: float  # imgui_internal.h:1035
    # ImGuiID     BackupActiveIdIsAlive;    /* original C++ signature */
    backup_active_id_is_alive: ID  # imgui_internal.h:1036
    # bool        BackupActiveIdPreviousFrameIsAlive;    /* original C++ signature */
    backup_active_id_previous_frame_is_alive: bool  # imgui_internal.h:1037
    # bool        BackupHoveredIdIsAlive;    /* original C++ signature */
    backup_hovered_id_is_alive: bool  # imgui_internal.h:1038
    # bool        EmitItem;    /* original C++ signature */
    emit_item: bool  # imgui_internal.h:1039
...
class MenuColumns:  # imgui_internal.h:1043
    """Simple column measurement, currently used for MenuItem() only.. This is very short-sighted/throw-away code and NOT a generic helper."""

    # ImU32       TotalWidth;    /* original C++ signature */
    total_width: ImU32  # imgui_internal.h:1045
    # ImU32       NextTotalWidth;    /* original C++ signature */
    next_total_width: ImU32  # imgui_internal.h:1046
    # ImU16       Spacing;    /* original C++ signature */
    spacing: ImU16  # imgui_internal.h:1047
    # ImU16       OffsetIcon;    /* original C++ signature */
    offset_icon: ImU16  # Always zero for now    # imgui_internal.h:1048
    # ImU16       OffsetLabel;    /* original C++ signature */
    offset_label: ImU16  # Offsets are locked in Update()    # imgui_internal.h:1049
    # ImU16       OffsetShortcut;    /* original C++ signature */
    offset_shortcut: ImU16  # imgui_internal.h:1050
    # ImU16       OffsetMark;    /* original C++ signature */
    offset_mark: ImU16  # imgui_internal.h:1051
    # ImU16       Widths[4];    /* original C++ signature */
    widths: np.ndarray  # ndarray[type=ImU16, size=4]  # Width of:   Icon, Label, Shortcut, Mark  (accumulators for current frame)    # imgui_internal.h:1052

    # ImGuiMenuColumns() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1054
        pass

class InputTextState:  # imgui_internal.h:1062
    """Internal state of the currently focused/edited text input box
    For a given item ID, access with ImGui::GetInputTextState()
    """

    # ImGuiContext*           Ctx;    /* original C++ signature */
    ctx: Context  # parent dear imgui context    # imgui_internal.h:1064
    # ImGuiID                 ID;    /* original C++ signature */
    id_: ID  # widget id owning the text state    # imgui_internal.h:1065
    # int                     CurLenW,     /* original C++ signature */
    cur_len_w: int  # we need to maintain our buffer length in both UTF-8 and wchar format. UTF-8 length is valid even if TextA is not.    # imgui_internal.h:1066
    # CurLenA;    /* original C++ signature */
    cur_len_a: int  # we need to maintain our buffer length in both UTF-8 and wchar format. UTF-8 length is valid even if TextA is not.    # imgui_internal.h:1066
    # bool                    TextAIsValid;    /* original C++ signature */
    text_a_is_valid: bool  # temporary UTF8 buffer is not initially valid before we make the widget active (until then we pull the data from user argument)    # imgui_internal.h:1070
    # int                     BufCapacityA;    /* original C++ signature */
    buf_capacity_a: int  # end-user buffer capacity    # imgui_internal.h:1071
    # float                   ScrollX;    /* original C++ signature */
    scroll_x: float  # horizontal scrolling/offset    # imgui_internal.h:1072
    # float                   CursorAnim;    /* original C++ signature */
    cursor_anim: float  # timer for cursor blink, reset on every user action so the cursor reappears immediately    # imgui_internal.h:1074
    # bool                    CursorFollow;    /* original C++ signature */
    cursor_follow: bool  # set when we want scrolling to follow the current cursor position (not always!)    # imgui_internal.h:1075
    # bool                    SelectedAllMouseLock;    /* original C++ signature */
    selected_all_mouse_lock: bool  # after a double-click to select all, we ignore further mouse drags to update selection    # imgui_internal.h:1076
    # bool                    Edited;    /* original C++ signature */
    edited: bool  # edited this frame    # imgui_internal.h:1077
    # ImGuiInputTextFlags     Flags;    /* original C++ signature */
    flags: InputTextFlags  # copy of InputText() flags. may be used to check if e.g. ImGuiInputTextFlags_Password is set.    # imgui_internal.h:1078

    # ImGuiInputTextState(ImGuiContext* ctx)  { memset(this, 0, sizeof(*this)); Ctx = ctx;}    /* original C++ signature */
    def __init__(self, ctx: Context) -> None:  # imgui_internal.h:1080
        pass
    # Cursor & Selection

class PopupData:  # imgui_internal.h:1099
    """Storage for current popup stack"""

    # ImGuiID             PopupId;    /* original C++ signature */
    popup_id: ID  # Set on OpenPopup()    # imgui_internal.h:1101
    # ImGuiWindow*        Window;    /* original C++ signature */
    window: Window  # Resolved on BeginPopup() - may stay unresolved if user never calls OpenPopup()    # imgui_internal.h:1102
    # ImGuiWindow*        BackupNavWindow;    /* original C++ signature */
    backup_nav_window: Window  # Set on OpenPopup(), a NavWindow that will be restored on popup close    # imgui_internal.h:1103
    # int                 ParentNavLayer;    /* original C++ signature */
    parent_nav_layer: int  # Resolved on BeginPopup(). Actually a ImGuiNavLayer type (declared down below), initialized to -1 which is not part of an enum, but serves well-enough as "not any of layers" value    # imgui_internal.h:1104
    # int                 OpenFrameCount;    /* original C++ signature */
    open_frame_count: int  # Set on OpenPopup()    # imgui_internal.h:1105
    # ImGuiID             OpenParentId;    /* original C++ signature */
    open_parent_id: ID  # Set on OpenPopup(), we need this to differentiate multiple menu sets from each others (e.g. inside menu bar vs loose menu items)    # imgui_internal.h:1106
    # ImVec2              OpenPopupPos;    /* original C++ signature */
    open_popup_pos: ImVec2  # Set on OpenPopup(), preferred popup position (typically == OpenMousePos when using mouse)    # imgui_internal.h:1107
    # ImVec2              OpenMousePos;    /* original C++ signature */
    open_mouse_pos: ImVec2  # Set on OpenPopup(), copy of mouse position at the time of opening popup    # imgui_internal.h:1108

    # ImGuiPopupData()    { memset(this, 0, sizeof(*this)); ParentNavLayer = OpenFrameCount = -1; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1110
        pass

class NextWindowDataFlags_(enum.Enum):  # imgui_internal.h:1113
...
class NextWindowData:  # imgui_internal.h:1130
    """Storage for SetNexWindow** functions"""

    # ImGuiNextWindowDataFlags    Flags;    /* original C++ signature */
    flags: NextWindowDataFlags  # imgui_internal.h:1132
    # ImGuiCond                   PosCond;    /* original C++ signature */
    pos_cond: Cond  # imgui_internal.h:1133
    # ImGuiCond                   SizeCond;    /* original C++ signature */
    size_cond: Cond  # imgui_internal.h:1134
    # ImGuiCond                   CollapsedCond;    /* original C++ signature */
    collapsed_cond: Cond  # imgui_internal.h:1135
    # ImGuiCond                   DockCond;    /* original C++ signature */
    dock_cond: Cond  # imgui_internal.h:1136
    # ImVec2                      PosVal;    /* original C++ signature */
    pos_val: ImVec2  # imgui_internal.h:1137
    # ImVec2                      PosPivotVal;    /* original C++ signature */
    pos_pivot_val: ImVec2  # imgui_internal.h:1138
    # ImVec2                      SizeVal;    /* original C++ signature */
    size_val: ImVec2  # imgui_internal.h:1139
    # ImVec2                      ContentSizeVal;    /* original C++ signature */
    content_size_val: ImVec2  # imgui_internal.h:1140
    # ImVec2                      ScrollVal;    /* original C++ signature */
    scroll_val: ImVec2  # imgui_internal.h:1141
    # bool                        PosUndock;    /* original C++ signature */
    pos_undock: bool  # imgui_internal.h:1142
    # bool                        CollapsedVal;    /* original C++ signature */
    collapsed_val: bool  # imgui_internal.h:1143
    # ImRect                      SizeConstraintRect;    /* original C++ signature */
    size_constraint_rect: ImRect  # imgui_internal.h:1144
    # void*                       SizeCallbackUserData;    /* original C++ signature */
    size_callback_user_data: Any  # imgui_internal.h:1146
    # float                       BgAlphaVal;    /* original C++ signature */
    bg_alpha_val: float  # Override background alpha    # imgui_internal.h:1147
    # ImGuiID                     ViewportId;    /* original C++ signature */
    viewport_id: ID  # imgui_internal.h:1148
    # ImGuiID                     DockId;    /* original C++ signature */
    dock_id: ID  # imgui_internal.h:1149
    # ImGuiWindowClass            WindowClass;    /* original C++ signature */
    window_class: WindowClass  # imgui_internal.h:1150
    # ImVec2                      MenuBarOffsetMinVal;    /* original C++ signature */
    menu_bar_offset_min_val: ImVec2  # (Always on) This is not exposed publicly, so we don't clear it and it doesn't have a corresponding flag (could we? for consistency?)    # imgui_internal.h:1151

    # ImGuiNextWindowData()       { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1153
        pass

class NextItemDataFlags_(enum.Enum):  # imgui_internal.h:1157
...
class NextItemData:  # imgui_internal.h:1164
    # ImGuiNextItemDataFlags      Flags;    /* original C++ signature */
    flags: NextItemDataFlags  # imgui_internal.h:1166
    # float                       Width;    /* original C++ signature */
    width: float  # Set by SetNextItemWidth()    # imgui_internal.h:1167
    # ImGuiID                     FocusScopeId;    /* original C++ signature */
    focus_scope_id: ID  # Set by SetNextItemMultiSelectData() (!= 0 signify value has been set, so it's an alternate version of HasSelectionData, we don't use Flags for this because they are cleared too early. This is mostly used for debugging)    # imgui_internal.h:1168
    # ImGuiCond                   OpenCond;    /* original C++ signature */
    open_cond: Cond  # imgui_internal.h:1169
    # bool                        OpenVal;    /* original C++ signature */
    open_val: bool  # Set by SetNextItemOpen()    # imgui_internal.h:1170

    # ImGuiNextItemData()         { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1172
        pass

class LastItemData:  # imgui_internal.h:1177
    """Status storage for the last submitted item"""

    # ImGuiID                 ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:1179
    # ImGuiItemFlags          InFlags;    /* original C++ signature */
    in_flags: ItemFlags  # See ImGuiItemFlags_    # imgui_internal.h:1180
    # ImGuiItemStatusFlags    StatusFlags;    /* original C++ signature */
    status_flags: ItemStatusFlags  # See ImGuiItemStatusFlags_    # imgui_internal.h:1181
    # ImRect                  Rect;    /* original C++ signature */
    rect: ImRect  # Full rectangle    # imgui_internal.h:1182
    # ImRect                  NavRect;    /* original C++ signature */
    nav_rect: ImRect  # Navigation scoring rectangle (not displayed)    # imgui_internal.h:1183
    # ImRect                  DisplayRect;    /* original C++ signature */
    display_rect: ImRect  # Display rectangle (only if ImGuiItemStatusFlags_HasDisplayRect is set)    # imgui_internal.h:1184

    # ImGuiLastItemData()     { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1186
        pass

class StackSizes:  # imgui_internal.h:1189
    # short   SizeOfIDStack;    /* original C++ signature */
    size_of_id_stack: int  # imgui_internal.h:1191
    # short   SizeOfColorStack;    /* original C++ signature */
    size_of_color_stack: int  # imgui_internal.h:1192
    # short   SizeOfStyleVarStack;    /* original C++ signature */
    size_of_style_var_stack: int  # imgui_internal.h:1193
    # short   SizeOfFontStack;    /* original C++ signature */
    size_of_font_stack: int  # imgui_internal.h:1194
    # short   SizeOfFocusScopeStack;    /* original C++ signature */
    size_of_focus_scope_stack: int  # imgui_internal.h:1195
    # short   SizeOfGroupStack;    /* original C++ signature */
    size_of_group_stack: int  # imgui_internal.h:1196
    # short   SizeOfItemFlagsStack;    /* original C++ signature */
    size_of_item_flags_stack: int  # imgui_internal.h:1197
    # short   SizeOfBeginPopupStack;    /* original C++ signature */
    size_of_begin_popup_stack: int  # imgui_internal.h:1198
    # short   SizeOfDisabledStack;    /* original C++ signature */
    size_of_disabled_stack: int  # imgui_internal.h:1199

    # ImGuiStackSizes() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1201
        pass

class WindowStackData:  # imgui_internal.h:1207
    """Data saved for each window pushed into the stack"""

    # ImGuiWindow*            Window;    /* original C++ signature */
    window: Window  # imgui_internal.h:1209
    # ImGuiLastItemData       ParentLastItemDataBackup;    /* original C++ signature */
    parent_last_item_data_backup: LastItemData  # imgui_internal.h:1210
    # ImGuiStackSizes         StackSizesOnBegin;    /* original C++ signature */
    stack_sizes_on_begin: StackSizes  # Store size of various stacks for asserting    # imgui_internal.h:1211
...
class ShrinkWidthItem:  # imgui_internal.h:1214
    # int         Index;    /* original C++ signature */
    index: int  # imgui_internal.h:1216
    # float       Width;    /* original C++ signature */
    width: float  # imgui_internal.h:1217
    # float       InitialWidth;    /* original C++ signature */
    initial_width: float  # imgui_internal.h:1218
...
class PtrOrIndex:  # imgui_internal.h:1221
    # void*       Ptr;    /* original C++ signature */
    ptr: Any  # Either field can be set, not both. e.g. Dock node tab bars are loose while BeginTabBar() ones are in a pool.    # imgui_internal.h:1223
    # int         Index;    /* original C++ signature */
    index: int  # Usually index in a main pool.    # imgui_internal.h:1224

    # ImGuiPtrOrIndex(void* ptr)  { Ptr = ptr; Index = -1; }    /* original C++ signature */
    def __init__(self, ptr: Any) -> None:  # imgui_internal.h:1226
        pass
    # ImGuiPtrOrIndex(int index)  { Ptr = NULL; Index = index; }    /* original C++ signature */
    def __init__(self, index: int) -> None:  # imgui_internal.h:1227
        pass
...
class InputEventType(enum.Enum):  # imgui_internal.h:1258
...
class InputSource(enum.Enum):  # imgui_internal.h:1271
...
class InputEventMousePos:  # imgui_internal.h:1284
    # float PosX,     /* original C++ signature */
    pos_x: float  # imgui_internal.h:1284
    # PosY;    /* original C++ signature */
    pos_y: float  # imgui_internal.h:1284
...
class InputEventMouseWheel:  # imgui_internal.h:1285
    # float WheelX,     /* original C++ signature */
    wheel_x: float  # imgui_internal.h:1285
    # WheelY;    /* original C++ signature */
    wheel_y: float  # imgui_internal.h:1285
...
class InputEventMouseButton:  # imgui_internal.h:1286
    # int Button;    /* original C++ signature */
    button: int  # imgui_internal.h:1286
    # bool Down;    /* original C++ signature */
    down: bool  # imgui_internal.h:1286
...
class InputEventMouseViewport:  # imgui_internal.h:1287
    # ImGuiID HoveredViewportID;    /* original C++ signature */
    hovered_viewport_id: ID  # imgui_internal.h:1287
...
class InputEventKey:  # imgui_internal.h:1288
    # ImGuiKey Key;    /* original C++ signature */
    key: Key  # imgui_internal.h:1288
    # bool Down;    /* original C++ signature */
    down: bool  # imgui_internal.h:1288
    # float AnalogValue;    /* original C++ signature */
    analog_value: float  # imgui_internal.h:1288
...
class InputEventText:  # imgui_internal.h:1289
    # unsigned int Char;    /* original C++ signature */
    char: int  # imgui_internal.h:1289
    # ImGuiInputEventText();    /* original C++ signature */
    def __init__(self) -> None:  # Line:3
        """Auto-generated default constructor"""
        pass

class InputEventAppFocused:  # imgui_internal.h:1290
    # bool Focused;    /* original C++ signature */
    focused: bool  # imgui_internal.h:1290
    # ImGuiInputEventAppFocused(bool Focused = bool());    /* original C++ signature */
    def __init__(self, focused: bool = bool()) -> None:  # Line:3
        """Auto-generated default constructor with named params"""
        pass

class InputEvent:  # imgui_internal.h:1292
    # ImGuiInputEventType             Type;    /* original C++ signature */
    type: InputEventType  # imgui_internal.h:1294
    # ImGuiInputSource                Source;    /* original C++ signature */
    source: InputSource  # imgui_internal.h:1295
    # bool                            AddedByTestEngine;    /* original C++ signature */
    added_by_test_engine: bool  # imgui_internal.h:1306

    # ImGuiInputEvent() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1308
        pass

# Input function taking an 'ImGuiID owner_id' argument defaults to (ImGuiKeyOwner_Any == 0) aka don't test ownership, which matches legacy behavior.

class KeyRoutingData:  # imgui_internal.h:1318
    """Routing table entry (sizeof() == 16 bytes)"""

    # ImGuiKeyRoutingIndex            NextEntryIndex;    /* original C++ signature */
    next_entry_index: KeyRoutingIndex  # imgui_internal.h:1320
    # ImU16                           Mods;    /* original C++ signature */
    mods: ImU16  # Technically we'd only need 4-bits but for simplify we store ImGuiMod_ values which need 16-bits. ImGuiMod_Shortcut is already translated to Ctrl/Super.    # imgui_internal.h:1321
    # ImU8                            RoutingNextScore;    /* original C++ signature */
    routing_next_score: ImU8  # Lower is better (0: perfect score)    # imgui_internal.h:1322
    # ImGuiID                         RoutingCurr;    /* original C++ signature */
    routing_curr: ID  # imgui_internal.h:1323
    # ImGuiID                         RoutingNext;    /* original C++ signature */
    routing_next: ID  # imgui_internal.h:1324
    ...
    def __init__(self) -> None:  # imgui_internal.h:1326
        pass

class KeyRoutingTable:  # imgui_internal.h:1331
    """Routing table: maintain a desired owner for each possible key-chord (key + mods), and setup owner in NewFrame() when mods are matching.
    Stored in main context (1 instance)
    """

    # ImGuiKeyRoutingTable()          { Clear(); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1337
        pass

class KeyOwnerData:  # imgui_internal.h:1343
    """This extends ImGuiKeyData but only for named keys (legacy keys don't support the new features)
    Stored in main context (1 per named key). In the future it might be merged into ImGuiKeyData.
    """

    # ImGuiID     OwnerCurr;    /* original C++ signature */
    owner_curr: ID  # imgui_internal.h:1345
    # ImGuiID     OwnerNext;    /* original C++ signature */
    owner_next: ID  # imgui_internal.h:1346
    # bool        LockThisFrame;    /* original C++ signature */
    lock_this_frame: bool  # Reading this key requires explicit owner id (until end of frame). Set by ImGuiInputFlags_LockThisFrame.    # imgui_internal.h:1347
    # bool        LockUntilRelease;    /* original C++ signature */
    lock_until_release: bool  # Reading this key requires explicit owner id (until key is released). Set by ImGuiInputFlags_LockUntilRelease. When this is True LockThisFrame is always True as well.    # imgui_internal.h:1348

    # ImGuiKeyOwnerData()             { OwnerCurr = OwnerNext = ImGuiKeyOwner_None; LockThisFrame = LockUntilRelease = false; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1350
        pass

class InputFlags_(enum.Enum):  # imgui_internal.h:1355
...
class ListClipperRange:  # imgui_internal.h:1405
    # int     Min;    /* original C++ signature */
    min: int  # imgui_internal.h:1407
    # int     Max;    /* original C++ signature */
    max: int  # imgui_internal.h:1408
    # bool    PosToIndexConvert;    /* original C++ signature */
    pos_to_index_convert: bool  # Begin/End are absolute position (will be converted to indices later)    # imgui_internal.h:1409
    # ImS8    PosToIndexOffsetMin;    /* original C++ signature */
    pos_to_index_offset_min: ImS8  # Add to Min after converting to indices    # imgui_internal.h:1410
    # ImS8    PosToIndexOffsetMax;    /* original C++ signature */
    pos_to_index_offset_max: ImS8  # Add to Min after converting to indices    # imgui_internal.h:1411
...
class ListClipperData:  # imgui_internal.h:1418
    """Temporary clipper data, buffers shared/reused between instances"""

    # ImGuiListClipper*               ListClipper;    /* original C++ signature */
    list_clipper: ListClipper  # imgui_internal.h:1420
    # float                           LossynessOffset;    /* original C++ signature */
    lossyness_offset: float  # imgui_internal.h:1421
    # int                             StepNo;    /* original C++ signature */
    step_no: int  # imgui_internal.h:1422
    # int                             ItemsFrozen;    /* original C++ signature */
    items_frozen: int  # imgui_internal.h:1423

    # ImGuiListClipperData()          { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1426
        pass
...
class ActivateFlags_(enum.Enum):  # imgui_internal.h:1434
...
class ScrollFlags_(enum.Enum):  # imgui_internal.h:1443
...
class NavHighlightFlags_(enum.Enum):  # imgui_internal.h:1457
...
class NavMoveFlags_(enum.Enum):  # imgui_internal.h:1466
...
class NavLayer(enum.Enum):  # imgui_internal.h:1484
...
class NavItemData:  # imgui_internal.h:1491
    # ImGuiWindow*        Window;    /* original C++ signature */
    window: Window  # Init,Move    // Best candidate window (result->ItemWindow->RootWindowForNav == request->Window)    # imgui_internal.h:1493
    # ImGuiID             ID;    /* original C++ signature */
    id_: ID  # Init,Move    // Best candidate item ID    # imgui_internal.h:1494
    # ImGuiID             FocusScopeId;    /* original C++ signature */
    focus_scope_id: ID  # Init,Move    // Best candidate focus scope ID    # imgui_internal.h:1495
    # ImRect              RectRel;    /* original C++ signature */
    rect_rel: ImRect  # Init,Move    // Best candidate bounding box in window relative space    # imgui_internal.h:1496
    # ImGuiItemFlags      InFlags;    /* original C++ signature */
    in_flags: ItemFlags  # ????,Move    // Best candidate item flags    # imgui_internal.h:1497
    # float               DistBox;    /* original C++ signature */
    dist_box: float  #      Move    // Best candidate box distance to current NavId    # imgui_internal.h:1498
    # float               DistCenter;    /* original C++ signature */
    dist_center: float  #      Move    // Best candidate center distance to current NavId    # imgui_internal.h:1499
    # float               DistAxial;    /* original C++ signature */
    dist_axial: float  #      Move    // Best candidate axial distance to current NavId    # imgui_internal.h:1500

    # ImGuiNavItemData()  { Clear(); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1502
        pass
...
class OldColumnFlags_(enum.Enum):  # imgui_internal.h:1511
...
class OldColumnData:  # imgui_internal.h:1531
    # float               OffsetNorm;    /* original C++ signature */
    offset_norm: float  # Column start offset, normalized 0.0 (far left) -> 1.0 (far right)    # imgui_internal.h:1533
    # float               OffsetNormBeforeResize;    /* original C++ signature */
    offset_norm_before_resize: float  # imgui_internal.h:1534
    # ImGuiOldColumnFlags Flags;    /* original C++ signature */
    flags: OldColumnFlags  # Not exposed    # imgui_internal.h:1535
    # ImRect              ClipRect;    /* original C++ signature */
    clip_rect: ImRect  # imgui_internal.h:1536

    # ImGuiOldColumnData() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1538
        pass

class OldColumns:  # imgui_internal.h:1541
    # ImGuiID             ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:1543
    # ImGuiOldColumnFlags Flags;    /* original C++ signature */
    flags: OldColumnFlags  # imgui_internal.h:1544
    # bool                IsFirstFrame;    /* original C++ signature */
    is_first_frame: bool  # imgui_internal.h:1545
    # bool                IsBeingResized;    /* original C++ signature */
    is_being_resized: bool  # imgui_internal.h:1546
    # int                 Current;    /* original C++ signature */
    current: int  # imgui_internal.h:1547
    # int                 Count;    /* original C++ signature */
    count: int  # imgui_internal.h:1548
    # float               OffMinX,     /* original C++ signature */
    off_min_x: float  # Offsets from HostWorkRect.Min.x    # imgui_internal.h:1549
    # OffMaxX;    /* original C++ signature */
    off_max_x: float  # Offsets from HostWorkRect.Min.x    # imgui_internal.h:1549
    # float               LineMinY,     /* original C++ signature */
    line_min_y: float  # imgui_internal.h:1550
    # LineMaxY;    /* original C++ signature */
    line_max_y: float  # imgui_internal.h:1550
    # float               HostCursorPosY;    /* original C++ signature */
    host_cursor_pos_y: float  # Backup of CursorPos at the time of BeginColumns()    # imgui_internal.h:1551
    # float               HostCursorMaxPosX;    /* original C++ signature */
    host_cursor_max_pos_x: float  # Backup of CursorMaxPos at the time of BeginColumns()    # imgui_internal.h:1552
    # ImRect              HostInitialClipRect;    /* original C++ signature */
    host_initial_clip_rect: ImRect  # Backup of ClipRect at the time of BeginColumns()    # imgui_internal.h:1553
    # ImRect              HostBackupClipRect;    /* original C++ signature */
    host_backup_clip_rect: ImRect  # Backup of ClipRect during PushColumnsBackground()/PopColumnsBackground()    # imgui_internal.h:1554
    # ImRect              HostBackupParentWorkRect;    /* original C++ signature */
    host_backup_parent_work_rect: ImRect  # Backup of WorkRect at the time of BeginColumns()    # imgui_internal.h:1555
    # ImDrawListSplitter  Splitter;    /* original C++ signature */
    splitter: ImDrawListSplitter  # imgui_internal.h:1557

    # ImGuiOldColumns()   { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1559
        pass
...
class DockNodeFlagsPrivate_(enum.Enum):  # imgui_internal.h:1580
...
class DataAuthority_(enum.Enum):  # imgui_internal.h:1605
...
class DockNodeState(enum.Enum):  # imgui_internal.h:1612
...
class DockNode:  # imgui_internal.h:1621
    """sizeof() 156~192"""

    # ImGuiID                 ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:1623
    # ImGuiDockNodeFlags      SharedFlags;    /* original C++ signature */
    shared_flags: DockNodeFlags  # (Write) Flags shared by all nodes of a same dockspace hierarchy (inherited from the root node)    # imgui_internal.h:1624
    # ImGuiDockNodeFlags      LocalFlags;    /* original C++ signature */
    local_flags: DockNodeFlags  # (Write) Flags specific to this node    # imgui_internal.h:1625
    # ImGuiDockNodeFlags      LocalFlagsInWindows;    /* original C++ signature */
    local_flags_in_windows: DockNodeFlags  # (Write) Flags specific to this node, applied from windows    # imgui_internal.h:1626
    # ImGuiDockNodeFlags      MergedFlags;    /* original C++ signature */
    merged_flags: DockNodeFlags  # (Read)  Effective flags (== SharedFlags | LocalFlagsInNode | LocalFlagsInWindows)    # imgui_internal.h:1627
    # ImGuiDockNodeState      State;    /* original C++ signature */
    state: DockNodeState  # imgui_internal.h:1628
    # ImGuiDockNode*          ParentNode;    /* original C++ signature */
    parent_node: DockNode  # imgui_internal.h:1629
    # ImGuiTabBar*            TabBar;    /* original C++ signature */
    tab_bar: TabBar  # imgui_internal.h:1632
    # ImVec2                  Pos;    /* original C++ signature */
    pos: ImVec2  # Current position    # imgui_internal.h:1633
    # ImVec2                  Size;    /* original C++ signature */
    size: ImVec2  # Current size    # imgui_internal.h:1634
    # ImVec2                  SizeRef;    /* original C++ signature */
    size_ref: ImVec2  # [Split node only] Last explicitly written-to size (overridden when using a splitter affecting the node), used to calculate Size.    # imgui_internal.h:1635
    # ImGuiAxis               SplitAxis;    /* original C++ signature */
    split_axis: Axis  # [Split node only] Split axis (X or Y)    # imgui_internal.h:1636
    # ImGuiWindowClass        WindowClass;    /* original C++ signature */
    window_class: WindowClass  # [Root node only]    # imgui_internal.h:1637
    # ImU32                   LastBgColor;    /* original C++ signature */
    last_bg_color: ImU32  # imgui_internal.h:1638

    # ImGuiWindow*            HostWindow;    /* original C++ signature */
    host_window: Window  # imgui_internal.h:1640
    # ImGuiWindow*            VisibleWindow;    /* original C++ signature */
    visible_window: Window  # Generally point to window which is ID is == SelectedTabID, but when CTRL+Tabbing this can be a different window.    # imgui_internal.h:1641
    # ImGuiDockNode*          CentralNode;    /* original C++ signature */
    central_node: DockNode  # [Root node only] Pointer to central node.    # imgui_internal.h:1642
    # ImGuiDockNode*          OnlyNodeWithWindows;    /* original C++ signature */
    only_node_with_windows: DockNode  # [Root node only] Set when there is a single visible node within the hierarchy.    # imgui_internal.h:1643
    # int                     CountNodeWithWindows;    /* original C++ signature */
    count_node_with_windows: int  # [Root node only]    # imgui_internal.h:1644
    # int                     LastFrameAlive;    /* original C++ signature */
    last_frame_alive: int  # Last frame number the node was updated or kept alive explicitly with DockSpace() + ImGuiDockNodeFlags_KeepAliveOnly    # imgui_internal.h:1645
    # int                     LastFrameActive;    /* original C++ signature */
    last_frame_active: int  # Last frame number the node was updated.    # imgui_internal.h:1646
    # int                     LastFrameFocused;    /* original C++ signature */
    last_frame_focused: int  # Last frame number the node was focused.    # imgui_internal.h:1647
    # ImGuiID                 LastFocusedNodeId;    /* original C++ signature */
    last_focused_node_id: ID  # [Root node only] Which of our child docking node (any ancestor in the hierarchy) was last focused.    # imgui_internal.h:1648
    # ImGuiID                 SelectedTabId;    /* original C++ signature */
    selected_tab_id: ID  # [Leaf node only] Which of our tab/window is selected.    # imgui_internal.h:1649
    # ImGuiID                 WantCloseTabId;    /* original C++ signature */
    want_close_tab_id: ID  # [Leaf node only] Set when closing a specific tab/window.    # imgui_internal.h:1650

    # ImGuiDockNode(ImGuiID id);    /* original C++ signature */
    def __init__(self, id_: ID) -> None:  # imgui_internal.h:1666
        pass

class WindowDockStyleCol(enum.Enum):  # imgui_internal.h:1687
...
class WindowDockStyle:  # imgui_internal.h:1698
    # ImGuiWindowDockStyle();    /* original C++ signature */
    def __init__(self) -> None:  # Line:3
        """Auto-generated default constructor"""
        pass

class DockContext:  # imgui_internal.h:1703
    # ImGuiStorage                    Nodes;    /* original C++ signature */
    nodes: Storage  # Map ID -> ImGuiDockNode*: Active nodes    # imgui_internal.h:1705
    # bool                            WantFullRebuild;    /* original C++ signature */
    want_full_rebuild: bool  # imgui_internal.h:1708
    # ImGuiDockContext()              { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1709
        pass
...
class ViewportP:  # imgui_internal.h:1720
    """ImGuiViewport Private/Internals fields (cardinal sin: we are using inheritance!)
    Every instance of ImGuiViewport is in fact a ImGuiViewportP.
    """

    # int                 Idx;    /* original C++ signature */
    idx: int  # imgui_internal.h:1722
    # int                 LastFrameActive;    /* original C++ signature */
    last_frame_active: int  # Last frame number this viewport was activated by a window    # imgui_internal.h:1723
    # int                 LastFrontMostStampCount;    /* original C++ signature */
    last_front_most_stamp_count: int  # Last stamp number from when a window hosted by this viewport was made front-most (by comparing this value between two viewport we have an implicit viewport z-order    # imgui_internal.h:1724
    # ImGuiID             LastNameHash;    /* original C++ signature */
    last_name_hash: ID  # imgui_internal.h:1725
    # ImVec2              LastPos;    /* original C++ signature */
    last_pos: ImVec2  # imgui_internal.h:1726
    # float               Alpha;    /* original C++ signature */
    alpha: float  # Window opacity (when dragging dockable windows/viewports we make them transparent)    # imgui_internal.h:1727
    # float               LastAlpha;    /* original C++ signature */
    last_alpha: float  # imgui_internal.h:1728
    # short               PlatformMonitor;    /* original C++ signature */
    platform_monitor: int  # imgui_internal.h:1729
    # ImGuiWindow*        Window;    /* original C++ signature */
    window: Window  # Set when the viewport is owned by a window (and ImGuiViewportFlags_CanHostOtherWindows is NOT set)    # imgui_internal.h:1730
    # int                 DrawListsLastFrame[2];    /* original C++ signature */
    draw_lists_last_frame: np.ndarray  # ndarray[type=int, size=2]  # Last frame number the background (0) and foreground (1) draw lists were used    # imgui_internal.h:1731
    # ImDrawData          DrawDataP;    /* original C++ signature */
    draw_data_p: ImDrawData  # imgui_internal.h:1733
    # ImDrawDataBuilder   DrawDataBuilder;    /* original C++ signature */
    draw_data_builder: ImDrawDataBuilder  # imgui_internal.h:1734
    # ImVec2              LastPlatformPos;    /* original C++ signature */
    last_platform_pos: ImVec2  # imgui_internal.h:1735
    # ImVec2              LastPlatformSize;    /* original C++ signature */
    last_platform_size: ImVec2  # imgui_internal.h:1736
    # ImVec2              LastRendererSize;    /* original C++ signature */
    last_renderer_size: ImVec2  # imgui_internal.h:1737
    # ImVec2              WorkOffsetMin;    /* original C++ signature */
    work_offset_min: ImVec2  # Work Area: Offset from Pos to top-left corner of Work Area. Generally (0,0) or (0,+main_menu_bar_height). Work Area is Full Area but without menu-bars/status-bars (so WorkArea always fit inside Pos/Size!)    # imgui_internal.h:1738
    # ImVec2              WorkOffsetMax;    /* original C++ signature */
    work_offset_max: ImVec2  # Work Area: Offset from Pos+Size to bottom-right corner of Work Area. Generally (0,0) or (0,-status_bar_height).    # imgui_internal.h:1739
    # ImVec2              BuildWorkOffsetMin;    /* original C++ signature */
    build_work_offset_min: ImVec2  # Work Area: Offset being built during current frame. Generally >= 0.0.    # imgui_internal.h:1740
    # ImVec2              BuildWorkOffsetMax;    /* original C++ signature */
    build_work_offset_max: ImVec2  # Work Area: Offset being built during current frame. Generally <= 0.0.    # imgui_internal.h:1741
    ...
    def __init__(self) -> None:  # imgui_internal.h:1743
        pass
...
class WindowSettings:  # imgui_internal.h:1765
    ...
    # ImGuiID     ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:1767
    # ImVec2ih    Pos;    /* original C++ signature */
    pos: ImVec2ih  # NB: Settings position are stored RELATIVE to the viewport! Whereas runtime ones are absolute positions.    # imgui_internal.h:1768
    # ImVec2ih    Size;    /* original C++ signature */
    size: ImVec2ih  # imgui_internal.h:1769
    # ImVec2ih    ViewportPos;    /* original C++ signature */
    viewport_pos: ImVec2ih  # imgui_internal.h:1770
    # ImGuiID     ViewportId;    /* original C++ signature */
    viewport_id: ID  # imgui_internal.h:1771
    # ImGuiID     DockId;    /* original C++ signature */
    dock_id: ID  # ID of last known DockNode (even if the DockNode is invisible because it has only 1 active window), or 0 if none.    # imgui_internal.h:1772
    # ImGuiID     ClassId;    /* original C++ signature */
    class_id: ID  # ID of window class if specified    # imgui_internal.h:1773
    # short       DockOrder;    /* original C++ signature */
    dock_order: int  # Order of the last time the window was visible within its DockNode. This is used to reorder windows that are reappearing on the same frame. Same value between windows that were active and windows that were none are possible.    # imgui_internal.h:1774
    # bool        Collapsed;    /* original C++ signature */
    collapsed: bool  # imgui_internal.h:1775
    # bool        WantApply;    /* original C++ signature */
    want_apply: bool  # Set when loaded from .ini data (to enable merging/loading .ini data into an already running context)    # imgui_internal.h:1776

    # ImGuiWindowSettings()       { memset(this, 0, sizeof(*this)); DockOrder = -1; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1778
        pass

class SettingsHandler:  # imgui_internal.h:1782
    # const char* TypeName;    /* original C++ signature */
    type_name: str  # Short description stored in .ini file. Disallowed characters: '[' ']'    # imgui_internal.h:1784
    # ImGuiID     TypeHash;    /* original C++ signature */
    type_hash: ID  # == ImHashStr(TypeName)    # imgui_internal.h:1785
    # void*       UserData;    /* original C++ signature */
    user_data: Any  # imgui_internal.h:1792

    # ImGuiSettingsHandler() { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1794
        pass
...
class LocKey(enum.Enum):  # imgui_internal.h:1802
...
class LocEntry:  # imgui_internal.h:1815
    # ImGuiLocKey     Key;    /* original C++ signature */
    key: LocKey  # imgui_internal.h:1817
    # const char*     Text;    /* original C++ signature */
    text: str  # imgui_internal.h:1818
...
class DebugLogFlags_(enum.Enum):  # imgui_internal.h:1826
    # Event types
...
class MetricsConfig:  # imgui_internal.h:1842
    # bool        ShowDebugLog;    /* original C++ signature */
    show_debug_log: bool  # imgui_internal.h:1844
    # bool        ShowStackTool;    /* original C++ signature */
    show_stack_tool: bool  # imgui_internal.h:1845
    # bool        ShowWindowsRects;    /* original C++ signature */
    show_windows_rects: bool  # imgui_internal.h:1846
    # bool        ShowWindowsBeginOrder;    /* original C++ signature */
    show_windows_begin_order: bool  # imgui_internal.h:1847
    # bool        ShowTablesRects;    /* original C++ signature */
    show_tables_rects: bool  # imgui_internal.h:1848
    # bool        ShowDrawCmdMesh;    /* original C++ signature */
    show_draw_cmd_mesh: bool  # imgui_internal.h:1849
    # bool        ShowDrawCmdBoundingBoxes;    /* original C++ signature */
    show_draw_cmd_bounding_boxes: bool  # imgui_internal.h:1850
    # bool        ShowDockingNodes;    /* original C++ signature */
    show_docking_nodes: bool  # imgui_internal.h:1851
    # int         ShowWindowsRectsType;    /* original C++ signature */
    show_windows_rects_type: int  # imgui_internal.h:1852
    # int         ShowTablesRectsType;    /* original C++ signature */
    show_tables_rects_type: int  # imgui_internal.h:1853
    ...
    #     }
    def __init__(self) -> None:  # imgui_internal.h:1855
        pass

class StackLevelInfo:  # imgui_internal.h:1865
    # ImGuiID                 ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:1867
    # ImS8                    QueryFrameCount;    /* original C++ signature */
    query_frame_count: ImS8  # >= 1: Query in progress    # imgui_internal.h:1868
    # bool                    QuerySuccess;    /* original C++ signature */
    query_success: bool  # Obtained result from DebugHookIdInfo()    # imgui_internal.h:1869

    # ImGuiStackLevelInfo()   { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1873
        pass

class StackTool:  # imgui_internal.h:1877
    """State for Stack tool queries"""

    # int                     LastActiveFrame;    /* original C++ signature */
    last_active_frame: int  # imgui_internal.h:1879
    # int                     StackLevel;    /* original C++ signature */
    stack_level: int  # -1: query stack and resize Results, >= 0: individual stack level    # imgui_internal.h:1880
    # ImGuiID                 QueryId;    /* original C++ signature */
    query_id: ID  # ID to query details for    # imgui_internal.h:1881
    # bool                    CopyToClipboardOnCtrlC;    /* original C++ signature */
    copy_to_clipboard_on_ctrl_c: bool  # imgui_internal.h:1883
    # float                   CopyToClipboardLastTime;    /* original C++ signature */
    copy_to_clipboard_last_time: float  # imgui_internal.h:1884

    # ImGuiStackTool()        { memset(this, 0, sizeof(*this)); CopyToClipboardLastTime = -FLT_MAX; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1886
        pass
...
class ContextHookType(enum.Enum):  # imgui_internal.h:1894
...
class ContextHook:  # imgui_internal.h:1896
    # ImGuiID                     HookId;    /* original C++ signature */
    hook_id: ID  # A unique ID assigned by AddContextHook()    # imgui_internal.h:1898
    # ImGuiContextHookType        Type;    /* original C++ signature */
    type: ContextHookType  # imgui_internal.h:1899
    # ImGuiID                     Owner;    /* original C++ signature */
    owner: ID  # imgui_internal.h:1900
    # void*                       UserData;    /* original C++ signature */
    user_data: Any  # imgui_internal.h:1902

    # ImGuiContextHook()          { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:1904
        pass
...
class Context:  # imgui_internal.h:1911
    # bool                    Initialized;    /* original C++ signature */
    initialized: bool  # imgui_internal.h:1913
    # bool                    FontAtlasOwnedByContext;    /* original C++ signature */
    font_atlas_owned_by_context: bool  # IO.Fonts-> is owned by the ImGuiContext and will be destructed along with it.    # imgui_internal.h:1914
    # ImGuiIO                 IO;    /* original C++ signature */
    io: IO  # imgui_internal.h:1915
    # ImGuiPlatformIO         PlatformIO;    /* original C++ signature */
    platform_io: PlatformIO  # imgui_internal.h:1916
    # ImGuiStyle              Style;    /* original C++ signature */
    style: Style  # imgui_internal.h:1919
    # ImGuiConfigFlags        ConfigFlagsCurrFrame;    /* original C++ signature */
    config_flags_curr_frame: ConfigFlags  # = g.IO.ConfigFlags at the time of NewFrame()    # imgui_internal.h:1920
    # ImGuiConfigFlags        ConfigFlagsLastFrame;    /* original C++ signature */
    config_flags_last_frame: ConfigFlags  # imgui_internal.h:1921
    # ImFont*                 Font;    /* original C++ signature */
    font: ImFont  # (Shortcut) == FontStack.empty() ? IO.Font : FontStack.back()    # imgui_internal.h:1922
    # float                   FontSize;    /* original C++ signature */
    font_size: float  # (Shortcut) == FontBaseSize * g.CurrentWindow->FontWindowScale == window->FontSize(). Text height for current window.    # imgui_internal.h:1923
    # float                   FontBaseSize;    /* original C++ signature */
    font_base_size: float  # (Shortcut) == IO.FontGlobalScale * Font->Scale * Font->FontSize. Base text height.    # imgui_internal.h:1924
    # ImDrawListSharedData    DrawListSharedData;    /* original C++ signature */
    draw_list_shared_data: ImDrawListSharedData  # imgui_internal.h:1925
    # double                  Time;    /* original C++ signature */
    time: float  # imgui_internal.h:1926
    # int                     FrameCount;    /* original C++ signature */
    frame_count: int  # imgui_internal.h:1927
    # int                     FrameCountEnded;    /* original C++ signature */
    frame_count_ended: int  # imgui_internal.h:1928
    # int                     FrameCountPlatformEnded;    /* original C++ signature */
    frame_count_platform_ended: int  # imgui_internal.h:1929
    # int                     FrameCountRendered;    /* original C++ signature */
    frame_count_rendered: int  # imgui_internal.h:1930
    # bool                    WithinFrameScope;    /* original C++ signature */
    within_frame_scope: bool  # Set by NewFrame(), cleared by EndFrame()    # imgui_internal.h:1931
    # bool                    WithinFrameScopeWithImplicitWindow;    /* original C++ signature */
    within_frame_scope_with_implicit_window: bool  # Set by NewFrame(), cleared by EndFrame() when the implicit debug window has been pushed    # imgui_internal.h:1932
    # bool                    WithinEndChild;    /* original C++ signature */
    within_end_child: bool  # Set within EndChild()    # imgui_internal.h:1933
    # bool                    GcCompactAll;    /* original C++ signature */
    gc_compact_all: bool  # Request full GC    # imgui_internal.h:1934
    # bool                    TestEngineHookItems;    /* original C++ signature */
    test_engine_hook_items: bool  # Will call test engine hooks: ImGuiTestEngineHook_ItemAdd(), ImGuiTestEngineHook_ItemInfo(), ImGuiTestEngineHook_Log()    # imgui_internal.h:1935
    # void*                   TestEngine;    /* original C++ signature */
    test_engine: Any  # Test engine user data    # imgui_internal.h:1936

    # Windows state
    # ImGuiStorage            WindowsById;    /* original C++ signature */
    windows_by_id: Storage  # Map window's ImGuiID to ImGuiWindow*    # imgui_internal.h:1943
    # int                     WindowsActiveCount;    /* original C++ signature */
    windows_active_count: int  # Number of unique windows submitted by frame    # imgui_internal.h:1944
    # ImVec2                  WindowsHoverPadding;    /* original C++ signature */
    windows_hover_padding: ImVec2  # Padding around resizable windows for which hovering on counts as hovering the window == ImMax(style.TouchExtraPadding, WINDOWS_HOVER_PADDING)    # imgui_internal.h:1945
    # ImGuiWindow*            CurrentWindow;    /* original C++ signature */
    current_window: Window  # Window being drawn into    # imgui_internal.h:1946
    # ImGuiWindow*            HoveredWindow;    /* original C++ signature */
    hovered_window: Window  # Window the mouse is hovering. Will typically catch mouse inputs.    # imgui_internal.h:1947
    # ImGuiWindow*            HoveredWindowUnderMovingWindow;    /* original C++ signature */
    hovered_window_under_moving_window: Window  # Hovered window ignoring MovingWindow. Only set if MovingWindow is set.    # imgui_internal.h:1948
    # ImGuiWindow*            MovingWindow;    /* original C++ signature */
    moving_window: Window  # Track the window we clicked on (in order to preserve focus). The actual window that is moved is generally MovingWindow->RootWindowDockTree.    # imgui_internal.h:1949
    # ImGuiWindow*            WheelingWindow;    /* original C++ signature */
    wheeling_window: Window  # Track the window we started mouse-wheeling on. Until a timer elapse or mouse has moved, generally keep scrolling the same window even if during the course of scrolling the mouse ends up hovering a child window.    # imgui_internal.h:1950
    # ImVec2                  WheelingWindowRefMousePos;    /* original C++ signature */
    wheeling_window_ref_mouse_pos: ImVec2  # imgui_internal.h:1951
    # int                     WheelingWindowStartFrame;    /* original C++ signature */
    wheeling_window_start_frame: int  # This may be set one frame before WheelingWindow is != None    # imgui_internal.h:1952
    # float                   WheelingWindowReleaseTimer;    /* original C++ signature */
    wheeling_window_release_timer: float  # imgui_internal.h:1953
    # ImVec2                  WheelingWindowWheelRemainder;    /* original C++ signature */
    wheeling_window_wheel_remainder: ImVec2  # imgui_internal.h:1954
    # ImVec2                  WheelingAxisAvg;    /* original C++ signature */
    wheeling_axis_avg: ImVec2  # imgui_internal.h:1955

    # Item/widgets state and tracking information
    # ImGuiID                 DebugHookIdInfo;    /* original C++ signature */
    debug_hook_id_info: ID  # Will call core hooks: DebugHookIdInfo() from GetID functions, used by Stack Tool [next HoveredId/ActiveId to not pull in an extra cache-line]    # imgui_internal.h:1958
    # ImGuiID                 HoveredId;    /* original C++ signature */
    hovered_id: ID  # Hovered widget, filled during the frame    # imgui_internal.h:1959
    # ImGuiID                 HoveredIdPreviousFrame;    /* original C++ signature */
    hovered_id_previous_frame: ID  # imgui_internal.h:1960
    # bool                    HoveredIdAllowOverlap;    /* original C++ signature */
    hovered_id_allow_overlap: bool  # imgui_internal.h:1961
    # bool                    HoveredIdDisabled;    /* original C++ signature */
    hovered_id_disabled: bool  # At least one widget passed the rect test, but has been discarded by disabled flag or popup inhibit. May be True even if HoveredId == 0.    # imgui_internal.h:1962
    # float                   HoveredIdTimer;    /* original C++ signature */
    hovered_id_timer: float  # Measure contiguous hovering time    # imgui_internal.h:1963
    # float                   HoveredIdNotActiveTimer;    /* original C++ signature */
    hovered_id_not_active_timer: float  # Measure contiguous hovering time where the item has not been active    # imgui_internal.h:1964
    # ImGuiID                 ActiveId;    /* original C++ signature */
    active_id: ID  # Active widget    # imgui_internal.h:1965
    # ImGuiID                 ActiveIdIsAlive;    /* original C++ signature */
    active_id_is_alive: ID  # Active widget has been seen this frame (we can't use a bool as the ActiveId may change within the frame)    # imgui_internal.h:1966
    # float                   ActiveIdTimer;    /* original C++ signature */
    active_id_timer: float  # imgui_internal.h:1967
    # bool                    ActiveIdIsJustActivated;    /* original C++ signature */
    active_id_is_just_activated: bool  # Set at the time of activation for one frame    # imgui_internal.h:1968
    # bool                    ActiveIdAllowOverlap;    /* original C++ signature */
    active_id_allow_overlap: bool  # Active widget allows another widget to steal active id (generally for overlapping widgets, but not always)    # imgui_internal.h:1969
    # bool                    ActiveIdNoClearOnFocusLoss;    /* original C++ signature */
    active_id_no_clear_on_focus_loss: bool  # Disable losing active id if the active id window gets unfocused.    # imgui_internal.h:1970
    # bool                    ActiveIdHasBeenPressedBefore;    /* original C++ signature */
    active_id_has_been_pressed_before: bool  # Track whether the active id led to a press (this is to allow changing between PressOnClick and PressOnRelease without pressing twice). Used by range_select branch.    # imgui_internal.h:1971
    # bool                    ActiveIdHasBeenEditedBefore;    /* original C++ signature */
    active_id_has_been_edited_before: bool  # Was the value associated to the widget Edited over the course of the Active state.    # imgui_internal.h:1972
    # bool                    ActiveIdHasBeenEditedThisFrame;    /* original C++ signature */
    active_id_has_been_edited_this_frame: bool  # imgui_internal.h:1973
    # ImVec2                  ActiveIdClickOffset;    /* original C++ signature */
    active_id_click_offset: ImVec2  # Clicked offset from upper-left corner, if applicable (currently only set by ButtonBehavior)    # imgui_internal.h:1974
    # ImGuiWindow*            ActiveIdWindow;    /* original C++ signature */
    active_id_window: Window  # imgui_internal.h:1975
    # ImGuiInputSource        ActiveIdSource;    /* original C++ signature */
    active_id_source: InputSource  # Activating with mouse or nav (gamepad/keyboard)    # imgui_internal.h:1976
    # int                     ActiveIdMouseButton;    /* original C++ signature */
    active_id_mouse_button: int  # imgui_internal.h:1977
    # ImGuiID                 ActiveIdPreviousFrame;    /* original C++ signature */
    active_id_previous_frame: ID  # imgui_internal.h:1978
    # bool                    ActiveIdPreviousFrameIsAlive;    /* original C++ signature */
    active_id_previous_frame_is_alive: bool  # imgui_internal.h:1979
    # bool                    ActiveIdPreviousFrameHasBeenEditedBefore;    /* original C++ signature */
    active_id_previous_frame_has_been_edited_before: bool  # imgui_internal.h:1980
    # ImGuiWindow*            ActiveIdPreviousFrameWindow;    /* original C++ signature */
    active_id_previous_frame_window: Window  # imgui_internal.h:1981
    # ImGuiID                 LastActiveId;    /* original C++ signature */
    last_active_id: ID  # Store the last non-zero ActiveId, useful for animation.    # imgui_internal.h:1982
    # float                   LastActiveIdTimer;    /* original C++ signature */
    last_active_id_timer: float  # Store the last non-zero ActiveId timer since the beginning of activation, useful for animation.    # imgui_internal.h:1983
    ...
    keys_routing_table: KeyRoutingTable  # imgui_internal.h:1990
    # ImU32                   ActiveIdUsingNavDirMask;    /* original C++ signature */
    active_id_using_nav_dir_mask: ImU32  # Active widget will want to read those nav move requests (e.g. can activate a button and move away from it)    # imgui_internal.h:1991
    # bool                    ActiveIdUsingAllKeyboardKeys;    /* original C++ signature */
    active_id_using_all_keyboard_keys: bool  # imgui_internal.h:1992
    ...
    current_focus_scope_id: ID  # == g.FocusScopeStack.back()    # imgui_internal.h:1998
    # ImGuiItemFlags          CurrentItemFlags;    /* original C++ signature */
    current_item_flags: ItemFlags  # == g.ItemFlagsStack.back()    # imgui_internal.h:1999
    # ImGuiID                 DebugLocateId;    /* original C++ signature */
    debug_locate_id: ID  # Storage for DebugLocateItemOnHover() feature: this is read by ItemAdd() so we keep it in a hot/cached location    # imgui_internal.h:2000
    # ImGuiNextItemData       NextItemData;    /* original C++ signature */
    next_item_data: NextItemData  # Storage for SetNextItem** functions    # imgui_internal.h:2001
    # ImGuiLastItemData       LastItemData;    /* original C++ signature */
    last_item_data: LastItemData  # Storage for last submitted item (setup by ItemAdd)    # imgui_internal.h:2002
    # ImGuiNextWindowData     NextWindowData;    /* original C++ signature */
    next_window_data: NextWindowData  # Storage for SetNextWindow** functions    # imgui_internal.h:2003

    # Shared stacks
    # int                     BeginMenuCount;    /* original C++ signature */
    begin_menu_count: int  # imgui_internal.h:2014

    # Viewports
    # float                   CurrentDpiScale;    /* original C++ signature */
    current_dpi_scale: float  # == CurrentViewport->DpiScale    # imgui_internal.h:2018
    # ImGuiViewportP*         CurrentViewport;    /* original C++ signature */
    current_viewport: ViewportP  # We track changes of viewport (happening in Begin) so we can call Platform_OnChangedViewport()    # imgui_internal.h:2019
    # ImGuiViewportP*         MouseViewport;    /* original C++ signature */
    mouse_viewport: ViewportP  # imgui_internal.h:2020
    # ImGuiViewportP*         MouseLastHoveredViewport;    /* original C++ signature */
    mouse_last_hovered_viewport: ViewportP  # Last known viewport that was hovered by mouse (even if we are not hovering any viewport any more) + honoring the _NoInputs flag.    # imgui_internal.h:2021
    # ImGuiID                 PlatformLastFocusedViewportId;    /* original C++ signature */
    platform_last_focused_viewport_id: ID  # imgui_internal.h:2022
    # ImGuiPlatformMonitor    FallbackMonitor;    /* original C++ signature */
    fallback_monitor: PlatformMonitor  # Virtual monitor used as fallback if backend doesn't provide monitor information.    # imgui_internal.h:2023
    # int                     ViewportFrontMostStampCount;    /* original C++ signature */
    viewport_front_most_stamp_count: int  # Every time the front-most window changes, we stamp its viewport with an incrementing counter    # imgui_internal.h:2024

    # Gamepad/keyboard Navigation
    # ImGuiWindow*            NavWindow;    /* original C++ signature */
    nav_window: Window  # Focused window for navigation. Could be called 'FocusedWindow'    # imgui_internal.h:2027
    # ImGuiID                 NavId;    /* original C++ signature */
    nav_id: ID  # Focused item for navigation    # imgui_internal.h:2028
    # ImGuiID                 NavFocusScopeId;    /* original C++ signature */
    nav_focus_scope_id: ID  # Identify a selection scope (selection code often wants to "clear other items" when landing on an item of the selection set)    # imgui_internal.h:2029
    # ImGuiID                 NavActivateId;    /* original C++ signature */
    nav_activate_id: ID  # ~~ (g.ActiveId == 0) && (IsKeyPressed(ImGuiKey_Space) || IsKeyPressed(ImGuiKey_NavGamepadActivate)) ? NavId : 0, also set when calling ActivateItem()    # imgui_internal.h:2030
    # ImGuiID                 NavActivateDownId;    /* original C++ signature */
    nav_activate_down_id: ID  # ~~ IsKeyDown(ImGuiKey_Space) || IsKeyDown(ImGuiKey_NavGamepadActivate) ? NavId : 0    # imgui_internal.h:2031
    # ImGuiID                 NavActivatePressedId;    /* original C++ signature */
    nav_activate_pressed_id: ID  # ~~ IsKeyPressed(ImGuiKey_Space) || IsKeyPressed(ImGuiKey_NavGamepadActivate) ? NavId : 0 (no repeat)    # imgui_internal.h:2032
    # ImGuiID                 NavActivateInputId;    /* original C++ signature */
    nav_activate_input_id: ID  # ~~ IsKeyPressed(ImGuiKey_Enter) || IsKeyPressed(ImGuiKey_NavGamepadInput) ? NavId : 0; ImGuiActivateFlags_PreferInput will be set and NavActivateId will be 0.    # imgui_internal.h:2033
    # ImGuiActivateFlags      NavActivateFlags;    /* original C++ signature */
    nav_activate_flags: ActivateFlags  # imgui_internal.h:2034
    # ImGuiID                 NavJustMovedToId;    /* original C++ signature */
    nav_just_moved_to_id: ID  # Just navigated to this id (result of a successfully MoveRequest).    # imgui_internal.h:2035
    # ImGuiID                 NavJustMovedToFocusScopeId;    /* original C++ signature */
    nav_just_moved_to_focus_scope_id: ID  # Just navigated to this focus scope id (result of a successfully MoveRequest).    # imgui_internal.h:2036
    # ImGuiKeyChord           NavJustMovedToKeyMods;    /* original C++ signature */
    nav_just_moved_to_key_mods: KeyChord  # imgui_internal.h:2037
    # ImGuiID                 NavNextActivateId;    /* original C++ signature */
    nav_next_activate_id: ID  # Set by ActivateItem(), queued until next frame.    # imgui_internal.h:2038
    # ImGuiActivateFlags      NavNextActivateFlags;    /* original C++ signature */
    nav_next_activate_flags: ActivateFlags  # imgui_internal.h:2039
    # ImGuiInputSource        NavInputSource;    /* original C++ signature */
    nav_input_source: InputSource  # Keyboard or Gamepad mode? THIS WILL ONLY BE None or NavGamepad or NavKeyboard.    # imgui_internal.h:2040
    # ImGuiNavLayer           NavLayer;    /* original C++ signature */
    nav_layer: NavLayer  # Layer we are navigating on. For now the system is hard-coded for 0=main contents and 1=menu/title bar, may expose layers later.    # imgui_internal.h:2041
    # bool                    NavIdIsAlive;    /* original C++ signature */
    nav_id_is_alive: bool  # Nav widget has been seen this frame ~~ NavRectRel is valid    # imgui_internal.h:2042
    # bool                    NavMousePosDirty;    /* original C++ signature */
    nav_mouse_pos_dirty: bool  # When set we will update mouse position if (io.ConfigFlags & ImGuiConfigFlags_NavEnableSetMousePos) if set (NB: this not enabled by default)    # imgui_internal.h:2043
    # bool                    NavDisableHighlight;    /* original C++ signature */
    nav_disable_highlight: bool  # When user starts using mouse, we hide gamepad/keyboard highlight (NB: but they are still available, which is why NavDisableHighlight isn't always != NavDisableMouseHover)    # imgui_internal.h:2044
    # bool                    NavDisableMouseHover;    /* original C++ signature */
    nav_disable_mouse_hover: bool  # When user starts using gamepad/keyboard, we hide mouse hovering highlight until mouse is touched again.    # imgui_internal.h:2045

    # Navigation: Init & Move Requests
    # bool                    NavAnyRequest;    /* original C++ signature */
    nav_any_request: bool  # ~~ NavMoveRequest || NavInitRequest this is to perform early out in ItemAdd()    # imgui_internal.h:2048
    # bool                    NavInitRequest;    /* original C++ signature */
    nav_init_request: bool  # Init request for appearing window to select first item    # imgui_internal.h:2049
    # bool                    NavInitRequestFromMove;    /* original C++ signature */
    nav_init_request_from_move: bool  # imgui_internal.h:2050
    # ImGuiID                 NavInitResultId;    /* original C++ signature */
    nav_init_result_id: ID  # Init request result (first item of the window, or one for which SetItemDefaultFocus() was called)    # imgui_internal.h:2051
    # ImRect                  NavInitResultRectRel;    /* original C++ signature */
    nav_init_result_rect_rel: ImRect  # Init request result rectangle (relative to parent window)    # imgui_internal.h:2052
    # bool                    NavMoveSubmitted;    /* original C++ signature */
    nav_move_submitted: bool  # Move request submitted, will process result on next NewFrame()    # imgui_internal.h:2053
    # bool                    NavMoveScoringItems;    /* original C++ signature */
    nav_move_scoring_items: bool  # Move request submitted, still scoring incoming items    # imgui_internal.h:2054
    # bool                    NavMoveForwardToNextFrame;    /* original C++ signature */
    nav_move_forward_to_next_frame: bool  # imgui_internal.h:2055
    # ImGuiNavMoveFlags       NavMoveFlags;    /* original C++ signature */
    nav_move_flags: NavMoveFlags  # imgui_internal.h:2056
    # ImGuiScrollFlags        NavMoveScrollFlags;    /* original C++ signature */
    nav_move_scroll_flags: ScrollFlags  # imgui_internal.h:2057
    # ImGuiKeyChord           NavMoveKeyMods;    /* original C++ signature */
    nav_move_key_mods: KeyChord  # imgui_internal.h:2058
    # ImGuiDir                NavMoveDir;    /* original C++ signature */
    nav_move_dir: Dir  # Direction of the move request (left/right/up/down)    # imgui_internal.h:2059
    # ImGuiDir                NavMoveDirForDebug;    /* original C++ signature */
    nav_move_dir_for_debug: Dir  # imgui_internal.h:2060
    # ImGuiDir                NavMoveClipDir;    /* original C++ signature */
    nav_move_clip_dir: Dir  # FIXME-NAV: Describe the purpose of this better. Might want to rename?    # imgui_internal.h:2061
    # ImRect                  NavScoringRect;    /* original C++ signature */
    nav_scoring_rect: ImRect  # Rectangle used for scoring, in screen space. Based of window->NavRectRel[], modified for directional navigation scoring.    # imgui_internal.h:2062
    # ImRect                  NavScoringNoClipRect;    /* original C++ signature */
    nav_scoring_no_clip_rect: ImRect  # Some nav operations (such as PageUp/PageDown) enforce a region which clipper will attempt to always keep submitted    # imgui_internal.h:2063
    # int                     NavScoringDebugCount;    /* original C++ signature */
    nav_scoring_debug_count: int  # Metrics for debugging    # imgui_internal.h:2064
    # int                     NavTabbingDir;    /* original C++ signature */
    nav_tabbing_dir: int  # Generally -1 or +1, 0 when tabbing without a nav id    # imgui_internal.h:2065
    # int                     NavTabbingCounter;    /* original C++ signature */
    nav_tabbing_counter: int  # >0 when counting items for tabbing    # imgui_internal.h:2066
    # ImGuiNavItemData        NavMoveResultLocal;    /* original C++ signature */
    nav_move_result_local: NavItemData  # Best move request candidate within NavWindow    # imgui_internal.h:2067
    # ImGuiNavItemData        NavMoveResultLocalVisible;    /* original C++ signature */
    nav_move_result_local_visible: NavItemData  # Best move request candidate within NavWindow that are mostly visible (when using ImGuiNavMoveFlags_AlsoScoreVisibleSet flag)    # imgui_internal.h:2068
    # ImGuiNavItemData        NavMoveResultOther;    /* original C++ signature */
    nav_move_result_other: NavItemData  # Best move request candidate within NavWindow's flattened hierarchy (when using ImGuiWindowFlags_NavFlattened flag)    # imgui_internal.h:2069
    # ImGuiNavItemData        NavTabbingResultFirst;    /* original C++ signature */
    nav_tabbing_result_first: NavItemData  # First tabbing request candidate within NavWindow and flattened hierarchy    # imgui_internal.h:2070

    # Navigation: Windowing (CTRL+TAB for list, or Menu button + keys or directional pads to move/resize)
    # ImGuiKeyChord           ConfigNavWindowingKeyNext;    /* original C++ signature */
    config_nav_windowing_key_next: KeyChord  # = ImGuiMod_Ctrl | ImGuiKey_Tab, for reconfiguration (see #4828)    # imgui_internal.h:2073
    # ImGuiKeyChord           ConfigNavWindowingKeyPrev;    /* original C++ signature */
    config_nav_windowing_key_prev: KeyChord  # = ImGuiMod_Ctrl | ImGuiMod_Shift | ImGuiKey_Tab    # imgui_internal.h:2074
    # ImGuiWindow*            NavWindowingTarget;    /* original C++ signature */
    nav_windowing_target: Window  # Target window when doing CTRL+Tab (or Pad Menu + FocusPrev/Next), this window is temporarily displayed top-most!    # imgui_internal.h:2075
    # ImGuiWindow*            NavWindowingTargetAnim;    /* original C++ signature */
    nav_windowing_target_anim: Window  # Record of last valid NavWindowingTarget until DimBgRatio and NavWindowingHighlightAlpha becomes 0.0, so the fade-out can stay on it.    # imgui_internal.h:2076
    # ImGuiWindow*            NavWindowingListWindow;    /* original C++ signature */
    nav_windowing_list_window: Window  # Internal window actually listing the CTRL+Tab contents    # imgui_internal.h:2077
    # float                   NavWindowingTimer;    /* original C++ signature */
    nav_windowing_timer: float  # imgui_internal.h:2078
    # float                   NavWindowingHighlightAlpha;    /* original C++ signature */
    nav_windowing_highlight_alpha: float  # imgui_internal.h:2079
    # bool                    NavWindowingToggleLayer;    /* original C++ signature */
    nav_windowing_toggle_layer: bool  # imgui_internal.h:2080
    # ImVec2                  NavWindowingAccumDeltaPos;    /* original C++ signature */
    nav_windowing_accum_delta_pos: ImVec2  # imgui_internal.h:2081
    # ImVec2                  NavWindowingAccumDeltaSize;    /* original C++ signature */
    nav_windowing_accum_delta_size: ImVec2  # imgui_internal.h:2082

    # Render
    # float                   DimBgRatio;    /* original C++ signature */
    dim_bg_ratio: float  # 0.0..1.0 animation when fading in a dimming background (for modal window and CTRL+TAB list)    # imgui_internal.h:2085
    # ImGuiMouseCursor        MouseCursor;    /* original C++ signature */
    mouse_cursor: MouseCursor  # imgui_internal.h:2086

    # Drag and Drop
    # bool                    DragDropActive;    /* original C++ signature */
    drag_drop_active: bool  # imgui_internal.h:2089
    # bool                    DragDropWithinSource;    /* original C++ signature */
    drag_drop_within_source: bool  # Set when within a BeginDragDropXXX/EndDragDropXXX block for a drag source.    # imgui_internal.h:2090
    # bool                    DragDropWithinTarget;    /* original C++ signature */
    drag_drop_within_target: bool  # Set when within a BeginDragDropXXX/EndDragDropXXX block for a drag target.    # imgui_internal.h:2091
    # ImGuiDragDropFlags      DragDropSourceFlags;    /* original C++ signature */
    drag_drop_source_flags: DragDropFlags  # imgui_internal.h:2092
    # int                     DragDropSourceFrameCount;    /* original C++ signature */
    drag_drop_source_frame_count: int  # imgui_internal.h:2093
    # int                     DragDropMouseButton;    /* original C++ signature */
    drag_drop_mouse_button: int  # imgui_internal.h:2094
    # ImGuiPayload            DragDropPayload;    /* original C++ signature */
    drag_drop_payload: Payload  # imgui_internal.h:2095
    # ImRect                  DragDropTargetRect;    /* original C++ signature */
    drag_drop_target_rect: ImRect  # Store rectangle of current target candidate (we favor small targets when overlapping)    # imgui_internal.h:2096
    # ImGuiID                 DragDropTargetId;    /* original C++ signature */
    drag_drop_target_id: ID  # imgui_internal.h:2097
    # ImGuiDragDropFlags      DragDropAcceptFlags;    /* original C++ signature */
    drag_drop_accept_flags: DragDropFlags  # imgui_internal.h:2098
    # float                   DragDropAcceptIdCurrRectSurface;    /* original C++ signature */
    drag_drop_accept_id_curr_rect_surface: float  # Target item surface (we resolve overlapping targets by prioritizing the smaller surface)    # imgui_internal.h:2099
    # ImGuiID                 DragDropAcceptIdCurr;    /* original C++ signature */
    drag_drop_accept_id_curr: ID  # Target item id (set at the time of accepting the payload)    # imgui_internal.h:2100
    # ImGuiID                 DragDropAcceptIdPrev;    /* original C++ signature */
    drag_drop_accept_id_prev: ID  # Target item id from previous frame (we need to store this to allow for overlapping drag and drop targets)    # imgui_internal.h:2101
    # int                     DragDropAcceptFrameCount;    /* original C++ signature */
    drag_drop_accept_frame_count: int  # Last time a target expressed a desire to accept the source    # imgui_internal.h:2102
    # ImGuiID                 DragDropHoldJustPressedId;    /* original C++ signature */
    drag_drop_hold_just_pressed_id: ID  # Set when holding a payload just made ButtonBehavior() return a press.    # imgui_internal.h:2103

    # Clipper
    # int                             ClipperTempDataStacked;    /* original C++ signature */
    clipper_temp_data_stacked: int  # imgui_internal.h:2108

    # Tables
    # ImGuiTable*                     CurrentTable;    /* original C++ signature */
    current_table: Table  # imgui_internal.h:2112
    # int                             TablesTempDataStacked;    /* original C++ signature */
    tables_temp_data_stacked: int  # Temporary table data size (because we leave previous instances undestructed, we generally don't use TablesTempData.Size)    # imgui_internal.h:2113

    # Tab bars
    # ImGuiTabBar*                    CurrentTabBar;    /* original C++ signature */
    current_tab_bar: TabBar  # imgui_internal.h:2120

    # Hover Delay system
    # ImGuiID                 HoverDelayId;    /* original C++ signature */
    hover_delay_id: ID  # imgui_internal.h:2126
    # ImGuiID                 HoverDelayIdPreviousFrame;    /* original C++ signature */
    hover_delay_id_previous_frame: ID  # imgui_internal.h:2127
    # float                   HoverDelayTimer;    /* original C++ signature */
    hover_delay_timer: float  # Currently used IsItemHovered(), generally inferred from g.HoveredIdTimer but kept uncleared until clear timer elapse.    # imgui_internal.h:2128
    # float                   HoverDelayClearTimer;    /* original C++ signature */
    hover_delay_clear_timer: float  # Currently used IsItemHovered(): grace time before g.TooltipHoverTimer gets cleared.    # imgui_internal.h:2129

    # Widget state
    # ImVec2                  MouseLastValidPos;    /* original C++ signature */
    mouse_last_valid_pos: ImVec2  # imgui_internal.h:2132
    # ImGuiInputTextState     InputTextState;    /* original C++ signature */
    input_text_state: InputTextState  # imgui_internal.h:2133
    # ImFont                  InputTextPasswordFont;    /* original C++ signature */
    input_text_password_font: ImFont  # imgui_internal.h:2134
    # ImGuiID                 TempInputId;    /* original C++ signature */
    temp_input_id: ID  # Temporary text input when CTRL+clicking on a slider, etc.    # imgui_internal.h:2135
    # ImGuiColorEditFlags     ColorEditOptions;    /* original C++ signature */
    color_edit_options: ColorEditFlags  # Store user options for color edit widgets    # imgui_internal.h:2136
    # float                   ColorEditLastHue;    /* original C++ signature */
    color_edit_last_hue: float  # Backup of last Hue associated to LastColor, so we can restore Hue in lossy RGB<>HSV round trips    # imgui_internal.h:2137
    # float                   ColorEditLastSat;    /* original C++ signature */
    color_edit_last_sat: float  # Backup of last Saturation associated to LastColor, so we can restore Saturation in lossy RGB<>HSV round trips    # imgui_internal.h:2138
    # ImU32                   ColorEditLastColor;    /* original C++ signature */
    color_edit_last_color: ImU32  # RGB value with alpha set to 0.    # imgui_internal.h:2139
    # ImVec4                  ColorPickerRef;    /* original C++ signature */
    color_picker_ref: ImVec4  # Initial/reference color at the time of opening the color picker.    # imgui_internal.h:2140
    # ImGuiComboPreviewData   ComboPreviewData;    /* original C++ signature */
    combo_preview_data: ComboPreviewData  # imgui_internal.h:2141
    # float                   SliderGrabClickOffset;    /* original C++ signature */
    slider_grab_click_offset: float  # imgui_internal.h:2142
    # float                   SliderCurrentAccum;    /* original C++ signature */
    slider_current_accum: float  # Accumulated slider delta when using navigation controls.    # imgui_internal.h:2143
    # bool                    SliderCurrentAccumDirty;    /* original C++ signature */
    slider_current_accum_dirty: bool  # Has the accumulated slider delta changed since last time we tried to apply it?    # imgui_internal.h:2144
    # bool                    DragCurrentAccumDirty;    /* original C++ signature */
    drag_current_accum_dirty: bool  # imgui_internal.h:2145
    # float                   DragCurrentAccum;    /* original C++ signature */
    drag_current_accum: float  # Accumulator for dragging modification. Always high-precision, not rounded by end-user precision settings    # imgui_internal.h:2146
    # float                   DragSpeedDefaultRatio;    /* original C++ signature */
    drag_speed_default_ratio: float  # If speed == 0.0, uses (max-min) * DragSpeedDefaultRatio    # imgui_internal.h:2147
    # float                   ScrollbarClickDeltaToGrabCenter;    /* original C++ signature */
    scrollbar_click_delta_to_grab_center: float  # Distance between mouse and center of grab box, normalized in parent space. Use storage?    # imgui_internal.h:2148
    # float                   DisabledAlphaBackup;    /* original C++ signature */
    disabled_alpha_backup: float  # Backup for style.Alpha for BeginDisabled()    # imgui_internal.h:2149
    # short                   DisabledStackSize;    /* original C++ signature */
    disabled_stack_size: int  # imgui_internal.h:2150
    # short                   TooltipOverrideCount;    /* original C++ signature */
    tooltip_override_count: int  # imgui_internal.h:2151

    # Platform support
    # ImGuiPlatformImeData    PlatformImeData;    /* original C++ signature */
    platform_ime_data: PlatformImeData  # Data updated by current frame    # imgui_internal.h:2156
    # ImGuiPlatformImeData    PlatformImeDataPrev;    /* original C++ signature */
    platform_ime_data_prev: PlatformImeData  # Previous frame data (when changing we will call io.SetPlatformImeDataFn    # imgui_internal.h:2157
    # ImGuiID                 PlatformImeViewport;    /* original C++ signature */
    platform_ime_viewport: ID  # imgui_internal.h:2158
    # char                    PlatformLocaleDecimalPoint;    /* original C++ signature */
    platform_locale_decimal_point: int  # '.' or *localeconv()->decimal_point    # imgui_internal.h:2159

    # ImGuiDockContext        DockContext;    /* original C++ signature */
    # Extensions
    # FIXME: We could provide an API to register one slot in an array held in ImGuiContext?
    dock_context: DockContext  # imgui_internal.h:2163

    # Settings
    # bool                    SettingsLoaded;    /* original C++ signature */
    settings_loaded: bool  # imgui_internal.h:2166
    # float                   SettingsDirtyTimer;    /* original C++ signature */
    settings_dirty_timer: float  # Save .ini Settings to memory when time reaches zero    # imgui_internal.h:2167
    # ImGuiTextBuffer         SettingsIniData;    /* original C++ signature */
    settings_ini_data: TextBuffer  # In memory .ini settings    # imgui_internal.h:2168
    # ImGuiID                             HookIdNext;    /* original C++ signature */
    hook_id_next: ID  # Next available HookId    # imgui_internal.h:2173

    # Capture/Logging
    # bool                    LogEnabled;    /* original C++ signature */
    log_enabled: bool  # Currently capturing    # imgui_internal.h:2179
    # ImGuiLogType            LogType;    /* original C++ signature */
    log_type: LogType  # Capture target    # imgui_internal.h:2180
    # ImFileHandle            LogFile;    /* original C++ signature */
    log_file: ImFileHandle  # If != None log to stdout/ file    # imgui_internal.h:2181
    # ImGuiTextBuffer         LogBuffer;    /* original C++ signature */
    log_buffer: TextBuffer  # Accumulation buffer when log to clipboard. This is pointer so our GImGui static constructor doesn't call heap allocators.    # imgui_internal.h:2182
    # const char*             LogNextPrefix;    /* original C++ signature */
    log_next_prefix: str  # imgui_internal.h:2183
    # const char*             LogNextSuffix;    /* original C++ signature */
    log_next_suffix: str  # imgui_internal.h:2184
    # float                   LogLinePosY;    /* original C++ signature */
    log_line_pos_y: float  # imgui_internal.h:2185
    # bool                    LogLineFirstItem;    /* original C++ signature */
    log_line_first_item: bool  # imgui_internal.h:2186
    # int                     LogDepthRef;    /* original C++ signature */
    log_depth_ref: int  # imgui_internal.h:2187
    # int                     LogDepthToExpand;    /* original C++ signature */
    log_depth_to_expand: int  # imgui_internal.h:2188
    # int                     LogDepthToExpandDefault;    /* original C++ signature */
    log_depth_to_expand_default: int  # Default/stored value for LogDepthMaxExpand if not specified in the LogXXX function call.    # imgui_internal.h:2189

    # Debug Tools
    # ImGuiDebugLogFlags      DebugLogFlags;    /* original C++ signature */
    debug_log_flags: DebugLogFlags  # imgui_internal.h:2192
    # ImGuiTextBuffer         DebugLogBuf;    /* original C++ signature */
    debug_log_buf: TextBuffer  # imgui_internal.h:2193
    # ImGuiTextIndex          DebugLogIndex;    /* original C++ signature */
    debug_log_index: TextIndex  # imgui_internal.h:2194
    # ImU8                    DebugLocateFrames;    /* original C++ signature */
    debug_locate_frames: ImU8  # For DebugLocateItemOnHover(). This is used together with DebugLocateId which is in a hot/cached spot above.    # imgui_internal.h:2195
    # bool                    DebugItemPickerActive;    /* original C++ signature */
    debug_item_picker_active: bool  # Item picker is active (started with DebugStartItemPicker())    # imgui_internal.h:2196
    # ImU8                    DebugItemPickerMouseButton;    /* original C++ signature */
    debug_item_picker_mouse_button: ImU8  # imgui_internal.h:2197
    # ImGuiID                 DebugItemPickerBreakId;    /* original C++ signature */
    debug_item_picker_break_id: ID  # Will call IM_DEBUG_BREAK() when encountering this ID    # imgui_internal.h:2198
    # ImGuiMetricsConfig      DebugMetricsConfig;    /* original C++ signature */
    debug_metrics_config: MetricsConfig  # imgui_internal.h:2199
    # ImGuiStackTool          DebugStackTool;    /* original C++ signature */
    debug_stack_tool: StackTool  # imgui_internal.h:2200
    # ImGuiDockNode*          DebugHoveredDockNode;    /* original C++ signature */
    debug_hovered_dock_node: DockNode  # Hovered dock node.    # imgui_internal.h:2201

    # Misc
    # float                   FramerateSecPerFrame[60];    /* original C++ signature */
    framerate_sec_per_frame: np.ndarray  # ndarray[type=float, size=60]  # Calculate estimate of framerate for user over the last 60 frames..    # imgui_internal.h:2204
    # int                     FramerateSecPerFrameIdx;    /* original C++ signature */
    framerate_sec_per_frame_idx: int  # imgui_internal.h:2205
    # int                     FramerateSecPerFrameCount;    /* original C++ signature */
    framerate_sec_per_frame_count: int  # imgui_internal.h:2206
    # float                   FramerateSecPerFrameAccum;    /* original C++ signature */
    framerate_sec_per_frame_accum: float  # imgui_internal.h:2207
    # int                     WantCaptureMouseNextFrame;    /* original C++ signature */
    want_capture_mouse_next_frame: int  # Explicit capture override via SetNextFrameWantCaptureMouse()/SetNextFrameWantCaptureKeyboard(). Default to -1.    # imgui_internal.h:2208
    # int                     WantCaptureKeyboardNextFrame;    /* original C++ signature */
    want_capture_keyboard_next_frame: int  # "    # imgui_internal.h:2209
    # int                     WantTextInputNextFrame;    /* original C++ signature */
    want_text_input_next_frame: int  # imgui_internal.h:2210
    ...
    #     }
    def __init__(self, shared_font_atlas: ImFontAtlas) -> None:  # imgui_internal.h:2213
        pass
...
class WindowTempData:  # imgui_internal.h:2393
    ...
    cursor_pos: ImVec2  # Current emitting position, in absolute coordinates.    # imgui_internal.h:2396
    # ImVec2                  CursorPosPrevLine;    /* original C++ signature */
    cursor_pos_prev_line: ImVec2  # imgui_internal.h:2397
    # ImVec2                  CursorStartPos;    /* original C++ signature */
    cursor_start_pos: ImVec2  # Initial position after Begin(), generally ~ window position + WindowPadding.    # imgui_internal.h:2398
    # ImVec2                  CursorMaxPos;    /* original C++ signature */
    cursor_max_pos: ImVec2  # Used to implicitly calculate ContentSize at the beginning of next frame, for scrolling range and auto-resize. Always growing during the frame.    # imgui_internal.h:2399
    # ImVec2                  IdealMaxPos;    /* original C++ signature */
    ideal_max_pos: ImVec2  # Used to implicitly calculate ContentSizeIdeal at the beginning of next frame, for auto-resize only. Always growing during the frame.    # imgui_internal.h:2400
    # ImVec2                  CurrLineSize;    /* original C++ signature */
    curr_line_size: ImVec2  # imgui_internal.h:2401
    # ImVec2                  PrevLineSize;    /* original C++ signature */
    prev_line_size: ImVec2  # imgui_internal.h:2402
    # float                   CurrLineTextBaseOffset;    /* original C++ signature */
    curr_line_text_base_offset: float  # Baseline offset (0.0 by default on a new line, generally == style.FramePadding.y when a framed item has been added).    # imgui_internal.h:2403
    # float                   PrevLineTextBaseOffset;    /* original C++ signature */
    prev_line_text_base_offset: float  # imgui_internal.h:2404
    # bool                    IsSameLine;    /* original C++ signature */
    is_same_line: bool  # imgui_internal.h:2405
    # bool                    IsSetPos;    /* original C++ signature */
    is_set_pos: bool  # imgui_internal.h:2406
    # ImVec1                  Indent;    /* original C++ signature */
    indent: ImVec1  # Indentation / start position from left of window (increased by TreePush/TreePop, etc.)    # imgui_internal.h:2407
    # ImVec1                  ColumnsOffset;    /* original C++ signature */
    columns_offset: ImVec1  # Offset to the current column (if ColumnsCurrent > 0). FIXME: This and the above should be a stack to allow use cases like Tree->Column->Tree. Need revamp columns API.    # imgui_internal.h:2408
    # ImVec1                  GroupOffset;    /* original C++ signature */
    group_offset: ImVec1  # imgui_internal.h:2409
    # ImVec2                  CursorStartPosLossyness;    /* original C++ signature */
    cursor_start_pos_lossyness: ImVec2  # Record the loss of precision of CursorStartPos due to really large scrolling amount. This is used by clipper to compensentate and fix the most common use case of large scroll area.    # imgui_internal.h:2410

    # Keyboard/Gamepad navigation
    # ImGuiNavLayer           NavLayerCurrent;    /* original C++ signature */
    nav_layer_current: NavLayer  # Current layer, 0..31 (we currently only use 0..1)    # imgui_internal.h:2413
    # short                   NavLayersActiveMask;    /* original C++ signature */
    nav_layers_active_mask: int  # Which layers have been written to (result from previous frame)    # imgui_internal.h:2414
    # short                   NavLayersActiveMaskNext;    /* original C++ signature */
    nav_layers_active_mask_next: int  # Which layers have been written to (accumulator for current frame)    # imgui_internal.h:2415
    # bool                    NavHideHighlightOneFrame;    /* original C++ signature */
    nav_hide_highlight_one_frame: bool  # imgui_internal.h:2416
    # bool                    NavHasScroll;    /* original C++ signature */
    nav_has_scroll: bool  # Set when scrolling can be used (ScrollMax > 0.0)    # imgui_internal.h:2417

    # Miscellaneous
    # bool                    MenuBarAppending;    /* original C++ signature */
    menu_bar_appending: bool  # FIXME: Remove this    # imgui_internal.h:2420
    # ImVec2                  MenuBarOffset;    /* original C++ signature */
    menu_bar_offset: ImVec2  # MenuBarOffset.x is sort of equivalent of a per-layer CursorPos.x, saved/restored as we switch to the menu bar. The only situation when MenuBarOffset.y is > 0 if when (SafeAreaPadding.y > FramePadding.y), often used on TVs.    # imgui_internal.h:2421
    # ImGuiMenuColumns        MenuColumns;    /* original C++ signature */
    menu_columns: MenuColumns  # Simplified columns storage for menu items measurement    # imgui_internal.h:2422
    # int                     TreeDepth;    /* original C++ signature */
    tree_depth: int  # Current tree depth.    # imgui_internal.h:2423
    # ImU32                   TreeJumpToParentOnPopMask;    /* original C++ signature */
    tree_jump_to_parent_on_pop_mask: ImU32  # Store a copy of !g.NavIdIsAlive for TreeDepth 0..31.. Could be turned into a ImU64 if necessary.    # imgui_internal.h:2424
    # ImGuiStorage*           StateStorage;    /* original C++ signature */
    state_storage: Storage  # Current persistent per-window storage (store e.g. tree node open/close state)    # imgui_internal.h:2426
    # ImGuiOldColumns*        CurrentColumns;    /* original C++ signature */
    current_columns: OldColumns  # Current columns set    # imgui_internal.h:2427
    # int                     CurrentTableIdx;    /* original C++ signature */
    current_table_idx: int  # Current table index (into g.Tables)    # imgui_internal.h:2428
    # ImGuiLayoutType         LayoutType;    /* original C++ signature */
    layout_type: LayoutType  # imgui_internal.h:2429
    # ImGuiLayoutType         ParentLayoutType;    /* original C++ signature */
    parent_layout_type: LayoutType  # Layout type of parent window at the time of Begin()    # imgui_internal.h:2430

    # Local parameters stacks
    # We store the current settings outside of the vectors to increase memory locality (reduce cache misses). The vectors are rarely modified. Also it allows us to not heap allocate for short-lived windows which are not using those settings.
    # float                   ItemWidth;    /* original C++ signature */
    item_width: float  # Current item width (>0.0: width in pixels, <0.0: align xx pixels to the right of window).    # imgui_internal.h:2434
    # float                   TextWrapPos;    /* original C++ signature */
    text_wrap_pos: float  # Current text wrap pos.    # imgui_internal.h:2435
...
class Window:  # imgui_internal.h:2441
    """Storage for one window"""

    # ImGuiID                 ID;    /* original C++ signature */
    id_: ID  # == ImHashStr(Name)    # imgui_internal.h:2444
    # ImGuiWindowFlags        Flags,     /* original C++ signature */
    flags: WindowFlags  # See enum ImGuiWindowFlags_    # imgui_internal.h:2445
    # FlagsPreviousFrame;    /* original C++ signature */
    flags_previous_frame: WindowFlags  # See enum ImGuiWindowFlags_    # imgui_internal.h:2445
    # ImGuiWindowClass        WindowClass;    /* original C++ signature */
    window_class: WindowClass  # Advanced users only. Set with SetNextWindowClass()    # imgui_internal.h:2446
    # ImGuiViewportP*         Viewport;    /* original C++ signature */
    viewport: ViewportP  # Always set in Begin(). Inactive windows may have a None value here if their viewport was discarded.    # imgui_internal.h:2447
    # ImGuiID                 ViewportId;    /* original C++ signature */
    viewport_id: ID  # We backup the viewport id (since the viewport may disappear or never be created if the window is inactive)    # imgui_internal.h:2448
    # ImVec2                  ViewportPos;    /* original C++ signature */
    viewport_pos: ImVec2  # We backup the viewport position (since the viewport may disappear or never be created if the window is inactive)    # imgui_internal.h:2449
    # int                     ViewportAllowPlatformMonitorExtend;    /* original C++ signature */
    viewport_allow_platform_monitor_extend: int  # Reset to -1 every frame (index is guaranteed to be valid between NewFrame..EndFrame), only used in the Appearing frame of a tooltip/popup to enforce clamping to a given monitor    # imgui_internal.h:2450
    # ImVec2                  Pos;    /* original C++ signature */
    pos: ImVec2  # Position (always rounded-up to nearest pixel)    # imgui_internal.h:2451
    # ImVec2                  Size;    /* original C++ signature */
    size: ImVec2  # Current size (==SizeFull or collapsed title bar size)    # imgui_internal.h:2452
    # ImVec2                  SizeFull;    /* original C++ signature */
    size_full: ImVec2  # Size when non collapsed    # imgui_internal.h:2453
    # ImVec2                  ContentSize;    /* original C++ signature */
    content_size: ImVec2  # Size of contents/scrollable client area (calculated from the extents reach of the cursor) from previous frame. Does not include window decoration or window padding.    # imgui_internal.h:2454
    # ImVec2                  ContentSizeIdeal;    /* original C++ signature */
    content_size_ideal: ImVec2  # imgui_internal.h:2455
    # ImVec2                  ContentSizeExplicit;    /* original C++ signature */
    content_size_explicit: ImVec2  # Size of contents/scrollable client area explicitly request by the user via SetNextWindowContentSize().    # imgui_internal.h:2456
    # ImVec2                  WindowPadding;    /* original C++ signature */
    window_padding: ImVec2  # Window padding at the time of Begin().    # imgui_internal.h:2457
    # float                   WindowRounding;    /* original C++ signature */
    window_rounding: float  # Window rounding at the time of Begin(). May be clamped lower to avoid rendering artifacts with title bar, menu bar etc.    # imgui_internal.h:2458
    # float                   WindowBorderSize;    /* original C++ signature */
    window_border_size: float  # Window border size at the time of Begin().    # imgui_internal.h:2459
    # int                     NameBufLen;    /* original C++ signature */
    name_buf_len: int  # Size of buffer storing Name. May be larger than strlen(Name)!    # imgui_internal.h:2460
    # ImGuiID                 MoveId;    /* original C++ signature */
    move_id: ID  # == window->GetID("#MOVE")    # imgui_internal.h:2461
    # ImGuiID                 TabId;    /* original C++ signature */
    tab_id: ID  # == window->GetID("#TAB")    # imgui_internal.h:2462
    # ImGuiID                 ChildId;    /* original C++ signature */
    child_id: ID  # ID of corresponding item in parent window (for navigation to return from child window to parent window)    # imgui_internal.h:2463
    # ImVec2                  Scroll;    /* original C++ signature */
    scroll: ImVec2  # imgui_internal.h:2464
    # ImVec2                  ScrollMax;    /* original C++ signature */
    scroll_max: ImVec2  # imgui_internal.h:2465
    # ImVec2                  ScrollTarget;    /* original C++ signature */
    scroll_target: ImVec2  # target scroll position. stored as cursor position with scrolling canceled out, so the highest point is always 0.0. (FLT_MAX for no change)    # imgui_internal.h:2466
    # ImVec2                  ScrollTargetCenterRatio;    /* original C++ signature */
    scroll_target_center_ratio: ImVec2  # 0.0 = scroll so that target position is at top, 0.5 = scroll so that target position is centered    # imgui_internal.h:2467
    # ImVec2                  ScrollTargetEdgeSnapDist;    /* original C++ signature */
    scroll_target_edge_snap_dist: ImVec2  # 0.0 = no snapping, >0.0 snapping threshold    # imgui_internal.h:2468
    # ImVec2                  ScrollbarSizes;    /* original C++ signature */
    scrollbar_sizes: ImVec2  # Size taken by each scrollbars on their smaller axis. Pay attention! ScrollbarSizes.x == width of the vertical scrollbar, ScrollbarSizes.y = height of the horizontal scrollbar.    # imgui_internal.h:2469
    # bool                    ScrollbarX,     /* original C++ signature */
    scrollbar_x: bool  # Are scrollbars visible?    # imgui_internal.h:2470
    # ScrollbarY;    /* original C++ signature */
    scrollbar_y: bool  # Are scrollbars visible?    # imgui_internal.h:2470
    # bool                    ViewportOwned;    /* original C++ signature */
    viewport_owned: bool  # imgui_internal.h:2471
    # bool                    Active;    /* original C++ signature */
    active: bool  # Set to True on Begin(), unless Collapsed    # imgui_internal.h:2472
    # bool                    WasActive;    /* original C++ signature */
    was_active: bool  # imgui_internal.h:2473
    # bool                    WriteAccessed;    /* original C++ signature */
    write_accessed: bool  # Set to True when any widget access the current window    # imgui_internal.h:2474
    # bool                    Collapsed;    /* original C++ signature */
    collapsed: bool  # Set when collapsing window to become only title-bar    # imgui_internal.h:2475
    # bool                    WantCollapseToggle;    /* original C++ signature */
    want_collapse_toggle: bool  # imgui_internal.h:2476
    # bool                    SkipItems;    /* original C++ signature */
    skip_items: bool  # Set when items can safely be all clipped (e.g. window not visible or collapsed)    # imgui_internal.h:2477
    # bool                    Appearing;    /* original C++ signature */
    appearing: bool  # Set during the frame where the window is appearing (or re-appearing)    # imgui_internal.h:2478
    # bool                    Hidden;    /* original C++ signature */
    hidden: bool  # Do not display (== HiddenFrames*** > 0)    # imgui_internal.h:2479
    # bool                    IsFallbackWindow;    /* original C++ signature */
    is_fallback_window: bool  # Set on the "Debug##Default" window.    # imgui_internal.h:2480
    # bool                    IsExplicitChild;    /* original C++ signature */
    is_explicit_child: bool  # Set when passed _ChildWindow, left to False by BeginDocked()    # imgui_internal.h:2481
    # bool                    HasCloseButton;    /* original C++ signature */
    has_close_button: bool  # Set when the window has a close button (p_open != None)    # imgui_internal.h:2482
    # signed char             ResizeBorderHeld;    /* original C++ signature */
    resize_border_held: int  # Current border being held for resize (-1: none, otherwise 0-3)    # imgui_internal.h:2483
    # short                   BeginCount;    /* original C++ signature */
    begin_count: int  # Number of Begin() during the current frame (generally 0 or 1, 1+ if appending via multiple Begin/End pairs)    # imgui_internal.h:2484
    # short                   BeginCountPreviousFrame;    /* original C++ signature */
    begin_count_previous_frame: int  # Number of Begin() during the previous frame    # imgui_internal.h:2485
    # short                   BeginOrderWithinParent;    /* original C++ signature */
    begin_order_within_parent: int  # Begin() order within immediate parent window, if we are a child window. Otherwise 0.    # imgui_internal.h:2486
    # short                   BeginOrderWithinContext;    /* original C++ signature */
    begin_order_within_context: int  # Begin() order within entire imgui context. This is mostly used for debugging submission order related issues.    # imgui_internal.h:2487
    # short                   FocusOrder;    /* original C++ signature */
    focus_order: int  # Order within WindowsFocusOrder[], altered when windows are focused.    # imgui_internal.h:2488
    # ImGuiID                 PopupId;    /* original C++ signature */
    popup_id: ID  # ID in the popup stack when this window is used as a popup/menu (because we use generic Name/ID for recycling)    # imgui_internal.h:2489
    # ImS8                    AutoFitFramesX,     /* original C++ signature */
    auto_fit_frames_x: ImS8  # imgui_internal.h:2490
    # AutoFitFramesY;    /* original C++ signature */
    auto_fit_frames_y: ImS8  # imgui_internal.h:2490
    # ImS8                    AutoFitChildAxises;    /* original C++ signature */
    auto_fit_child_axises: ImS8  # imgui_internal.h:2491
    # bool                    AutoFitOnlyGrows;    /* original C++ signature */
    auto_fit_only_grows: bool  # imgui_internal.h:2492
    # ImGuiDir                AutoPosLastDirection;    /* original C++ signature */
    auto_pos_last_direction: Dir  # imgui_internal.h:2493
    # ImS8                    HiddenFramesCanSkipItems;    /* original C++ signature */
    hidden_frames_can_skip_items: ImS8  # Hide the window for N frames    # imgui_internal.h:2494
    # ImS8                    HiddenFramesCannotSkipItems;    /* original C++ signature */
    hidden_frames_cannot_skip_items: ImS8  # Hide the window for N frames while allowing items to be submitted so we can measure their size    # imgui_internal.h:2495
    # ImS8                    HiddenFramesForRenderOnly;    /* original C++ signature */
    hidden_frames_for_render_only: ImS8  # Hide the window until frame N at Render() time only    # imgui_internal.h:2496
    # ImS8                    DisableInputsFrames;    /* original C++ signature */
    disable_inputs_frames: ImS8  # Disable window interactions for N frames    # imgui_internal.h:2497
    # ImVec2                  SetWindowPosVal;    /* original C++ signature */
    set_window_pos_val: ImVec2  # store window position when using a non-zero Pivot (position set needs to be processed when we know the window size)    # imgui_internal.h:2502
    # ImVec2                  SetWindowPosPivot;    /* original C++ signature */
    set_window_pos_pivot: ImVec2  # store window pivot for positioning. ImVec2(0, 0) when positioning from top-left corner; ImVec2(0.5, 0.5) for centering; ImVec2(1, 1) for bottom right.    # imgui_internal.h:2503

    # ImGuiWindowTempData     DC;    /* original C++ signature */
    dc: WindowTempData  # Temporary per-window data, reset at the beginning of the frame. This used to be called ImGuiDrawContext, hence the "DC" variable name.    # imgui_internal.h:2506

    # The best way to understand what those rectangles are is to use the 'Metrics->Tools->Show Windows Rectangles' viewer.
    # The main 'OuterRect', omitted as a field, is window->Rect().
    # ImRect                  OuterRectClipped;    /* original C++ signature */
    outer_rect_clipped: ImRect  # == Window->Rect() just after setup in Begin(). == window->Rect() for root window.    # imgui_internal.h:2510
    # ImRect                  InnerRect;    /* original C++ signature */
    inner_rect: ImRect  # Inner rectangle (omit title bar, menu bar, scroll bar)    # imgui_internal.h:2511
    # ImRect                  InnerClipRect;    /* original C++ signature */
    inner_clip_rect: ImRect  # == InnerRect shrunk by WindowPadding*0.5 on each side, clipped within viewport or parent clip rect.    # imgui_internal.h:2512
    # ImRect                  WorkRect;    /* original C++ signature */
    work_rect: ImRect  # Initially covers the whole scrolling region. Reduced by containers e.g columns/tables when active. Shrunk by WindowPadding*1.0 on each side. This is meant to replace ContentRegionRect over time (from 1.71+ onward).    # imgui_internal.h:2513
    # ImRect                  ParentWorkRect;    /* original C++ signature */
    parent_work_rect: ImRect  # Backup of WorkRect before entering a container such as columns/tables. Used by e.g. SpanAllColumns functions to easily access. Stacked containers are responsible for maintaining this. // FIXME-WORKRECT: Could be a stack?    # imgui_internal.h:2514
    # ImRect                  ClipRect;    /* original C++ signature */
    clip_rect: ImRect  # Current clipping/scissoring rectangle, evolve as we are using PushClipRect(), etc. == DrawList->clip_rect_stack.back().    # imgui_internal.h:2515
    # ImRect                  ContentRegionRect;    /* original C++ signature */
    content_region_rect: ImRect  # FIXME: This is currently confusing/misleading. It is essentially WorkRect but not handling of scrolling. We currently rely on it as right/bottom aligned sizing operation need some size to rely on.    # imgui_internal.h:2516
    # ImVec2ih                HitTestHoleSize;    /* original C++ signature */
    hit_test_hole_size: ImVec2ih  # Define an optional rectangular hole where mouse will pass-through the window.    # imgui_internal.h:2517
    # ImVec2ih                HitTestHoleOffset;    /* original C++ signature */
    hit_test_hole_offset: ImVec2ih  # imgui_internal.h:2518

    # int                     LastFrameActive;    /* original C++ signature */
    last_frame_active: int  # Last frame number the window was Active.    # imgui_internal.h:2520
    # int                     LastFrameJustFocused;    /* original C++ signature */
    last_frame_just_focused: int  # Last frame number the window was made Focused.    # imgui_internal.h:2521
    # float                   LastTimeActive;    /* original C++ signature */
    last_time_active: float  # Last timestamp the window was Active (using float as we don't need high precision there)    # imgui_internal.h:2522
    # float                   ItemWidthDefault;    /* original C++ signature */
    item_width_default: float  # imgui_internal.h:2523
    # ImGuiStorage            StateStorage;    /* original C++ signature */
    state_storage: Storage  # imgui_internal.h:2524
    # float                   FontWindowScale;    /* original C++ signature */
    font_window_scale: float  # User scale multiplier per-window, via SetWindowFontScale()    # imgui_internal.h:2526
    # float                   FontDpiScale;    /* original C++ signature */
    font_dpi_scale: float  # imgui_internal.h:2527
    # int                     SettingsOffset;    /* original C++ signature */
    settings_offset: int  # Offset into SettingsWindows[] (offsets are always valid as we only grow the array from the back)    # imgui_internal.h:2528

    # ImDrawList*             DrawList;    /* original C++ signature */
    draw_list: ImDrawList  # == &DrawListInst (for backward compatibility reason with code using imgui_internal.h we keep this a pointer)    # imgui_internal.h:2530
    # ImDrawList              DrawListInst;    /* original C++ signature */
    draw_list_inst: ImDrawList  # imgui_internal.h:2531
    # ImGuiWindow*            ParentWindow;    /* original C++ signature */
    parent_window: Window  # If we are a child _or_ popup _or_ docked window, this is pointing to our parent. Otherwise None.    # imgui_internal.h:2532
    # ImGuiWindow*            ParentWindowInBeginStack;    /* original C++ signature */
    parent_window_in_begin_stack: Window  # imgui_internal.h:2533
    # ImGuiWindow*            RootWindow;    /* original C++ signature */
    root_window: Window  # Point to ourself or first ancestor that is not a child window. Doesn't cross through popups/dock nodes.    # imgui_internal.h:2534
    # ImGuiWindow*            RootWindowPopupTree;    /* original C++ signature */
    root_window_popup_tree: Window  # Point to ourself or first ancestor that is not a child window. Cross through popups parent<>child.    # imgui_internal.h:2535
    # ImGuiWindow*            RootWindowDockTree;    /* original C++ signature */
    root_window_dock_tree: Window  # Point to ourself or first ancestor that is not a child window. Cross through dock nodes.    # imgui_internal.h:2536
    # ImGuiWindow*            RootWindowForTitleBarHighlight;    /* original C++ signature */
    root_window_for_title_bar_highlight: Window  # Point to ourself or first ancestor which will display TitleBgActive color when this window is active.    # imgui_internal.h:2537
    # ImGuiWindow*            RootWindowForNav;    /* original C++ signature */
    root_window_for_nav: Window  # Point to ourself or first ancestor which doesn't have the NavFlattened flag.    # imgui_internal.h:2538

    # ImGuiWindow*            NavLastChildNavWindow;    /* original C++ signature */
    nav_last_child_nav_window: Window  # When going to the menu bar, we remember the child window we came from. (This could probably be made implicit if we kept g.Windows sorted by last focused including child window.)    # imgui_internal.h:2540
    # ImGuiID                 NavRootFocusScopeId;    /* original C++ signature */
    nav_root_focus_scope_id: ID  # Focus Scope ID at the time of Begin()    # imgui_internal.h:2543

    # int                     MemoryDrawListIdxCapacity;    /* original C++ signature */
    memory_draw_list_idx_capacity: int  # Backup of last idx/vtx count, so when waking up the window we can preallocate and avoid iterative alloc/copy    # imgui_internal.h:2545
    # int                     MemoryDrawListVtxCapacity;    /* original C++ signature */
    memory_draw_list_vtx_capacity: int  # imgui_internal.h:2546
    # bool                    MemoryCompacted;    /* original C++ signature */
    memory_compacted: bool  # Set when window extraneous data have been garbage collected    # imgui_internal.h:2547

    # Docking
    # short                   DockOrder;    /* original C++ signature */
    dock_order: int  # Order of the last time the window was visible within its DockNode. This is used to reorder windows that are reappearing on the same frame. Same value between windows that were active and windows that were none are possible.    # imgui_internal.h:2554
    # ImGuiWindowDockStyle    DockStyle;    /* original C++ signature */
    dock_style: WindowDockStyle  # imgui_internal.h:2555
    # ImGuiDockNode*          DockNode;    /* original C++ signature */
    dock_node: DockNode  # Which node are we docked into. Important: Prefer testing DockIsActive in many cases as this will still be set when the dock node is hidden.    # imgui_internal.h:2556
    # ImGuiDockNode*          DockNodeAsHost;    /* original C++ signature */
    dock_node_as_host: DockNode  # Which node are we owning (for parent windows)    # imgui_internal.h:2557
    # ImGuiID                 DockId;    /* original C++ signature */
    dock_id: ID  # Backup of last valid DockNode->ID, so single window remember their dock node id even when they are not bound any more    # imgui_internal.h:2558
    # ImGuiItemStatusFlags    DockTabItemStatusFlags;    /* original C++ signature */
    dock_tab_item_status_flags: ItemStatusFlags  # imgui_internal.h:2559
    # ImRect                  DockTabItemRect;    /* original C++ signature */
    dock_tab_item_rect: ImRect  # imgui_internal.h:2560

    # ImGuiWindow(ImGuiContext* context, const char* name);    /* original C++ signature */
    def __init__(self, context: Context, name: str) -> None:  # imgui_internal.h:2563
        pass
...
class TabBarFlagsPrivate_(enum.Enum):  # imgui_internal.h:2585
...
class TabItemFlagsPrivate_(enum.Enum):  # imgui_internal.h:2593
...
class TabItem:  # imgui_internal.h:2603
    """Storage for one active tab item (sizeof() 48 bytes)"""

    # ImGuiID             ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:2605
    # ImGuiTabItemFlags   Flags;    /* original C++ signature */
    flags: TabItemFlags  # imgui_internal.h:2606
    # ImGuiWindow*        Window;    /* original C++ signature */
    window: Window  # When TabItem is part of a DockNode's TabBar, we hold on to a window.    # imgui_internal.h:2607
    # int                 LastFrameVisible;    /* original C++ signature */
    last_frame_visible: int  # imgui_internal.h:2608
    # int                 LastFrameSelected;    /* original C++ signature */
    last_frame_selected: int  # This allows us to infer an ordered list of the last activated tabs with little maintenance    # imgui_internal.h:2609
    # float               Offset;    /* original C++ signature */
    offset: float  # Position relative to beginning of tab    # imgui_internal.h:2610
    # float               Width;    /* original C++ signature */
    width: float  # Width currently displayed    # imgui_internal.h:2611
    # float               ContentWidth;    /* original C++ signature */
    content_width: float  # Width of label, stored during BeginTabItem() call    # imgui_internal.h:2612
    # float               RequestedWidth;    /* original C++ signature */
    requested_width: float  # Width optionally requested by caller, -1.0 is unused    # imgui_internal.h:2613
    # ImS32               NameOffset;    /* original C++ signature */
    name_offset: ImS32  # When Window==None, offset to name within parent ImGuiTabBar::TabsNames    # imgui_internal.h:2614
    # ImS16               BeginOrder;    /* original C++ signature */
    begin_order: ImS16  # BeginTabItem() order, used to re-order tabs after toggling ImGuiTabBarFlags_Reorderable    # imgui_internal.h:2615
    # ImS16               IndexDuringLayout;    /* original C++ signature */
    index_during_layout: ImS16  # Index only used during TabBarLayout()    # imgui_internal.h:2616
    # bool                WantClose;    /* original C++ signature */
    want_close: bool  # Marked as closed by SetTabItemClosed()    # imgui_internal.h:2617
    ...
    def __init__(self) -> None:  # imgui_internal.h:2619
        pass

class TabBar:  # imgui_internal.h:2623
    """Storage for a tab bar (sizeof() 152 bytes)"""

    # ImGuiTabBarFlags    Flags;    /* original C++ signature */
    flags: TabBarFlags  # imgui_internal.h:2626
    # ImGuiID             ID;    /* original C++ signature */
    id_: ID  # Zero for tab-bars used by docking    # imgui_internal.h:2627
    # ImGuiID             SelectedTabId;    /* original C++ signature */
    selected_tab_id: ID  # Selected tab/window    # imgui_internal.h:2628
    # ImGuiID             NextSelectedTabId;    /* original C++ signature */
    next_selected_tab_id: ID  # Next selected tab/window. Will also trigger a scrolling animation    # imgui_internal.h:2629
    # ImGuiID             VisibleTabId;    /* original C++ signature */
    visible_tab_id: ID  # Can occasionally be != SelectedTabId (e.g. when previewing contents for CTRL+TAB preview)    # imgui_internal.h:2630
    # int                 CurrFrameVisible;    /* original C++ signature */
    curr_frame_visible: int  # imgui_internal.h:2631
    # int                 PrevFrameVisible;    /* original C++ signature */
    prev_frame_visible: int  # imgui_internal.h:2632
    # ImRect              BarRect;    /* original C++ signature */
    bar_rect: ImRect  # imgui_internal.h:2633
    # float               CurrTabsContentsHeight;    /* original C++ signature */
    curr_tabs_contents_height: float  # imgui_internal.h:2634
    # float               PrevTabsContentsHeight;    /* original C++ signature */
    prev_tabs_contents_height: float  # Record the height of contents submitted below the tab bar    # imgui_internal.h:2635
    # float               WidthAllTabs;    /* original C++ signature */
    width_all_tabs: float  # Actual width of all tabs (locked during layout)    # imgui_internal.h:2636
    # float               WidthAllTabsIdeal;    /* original C++ signature */
    width_all_tabs_ideal: float  # Ideal width if all tabs were visible and not clipped    # imgui_internal.h:2637
    # float               ScrollingAnim;    /* original C++ signature */
    scrolling_anim: float  # imgui_internal.h:2638
    # float               ScrollingTarget;    /* original C++ signature */
    scrolling_target: float  # imgui_internal.h:2639
    # float               ScrollingTargetDistToVisibility;    /* original C++ signature */
    scrolling_target_dist_to_visibility: float  # imgui_internal.h:2640
    # float               ScrollingSpeed;    /* original C++ signature */
    scrolling_speed: float  # imgui_internal.h:2641
    # float               ScrollingRectMinX;    /* original C++ signature */
    scrolling_rect_min_x: float  # imgui_internal.h:2642
    # float               ScrollingRectMaxX;    /* original C++ signature */
    scrolling_rect_max_x: float  # imgui_internal.h:2643
    # ImGuiID             ReorderRequestTabId;    /* original C++ signature */
    reorder_request_tab_id: ID  # imgui_internal.h:2644
    # ImS16               ReorderRequestOffset;    /* original C++ signature */
    reorder_request_offset: ImS16  # imgui_internal.h:2645
    # ImS8                BeginCount;    /* original C++ signature */
    begin_count: ImS8  # imgui_internal.h:2646
    # bool                WantLayout;    /* original C++ signature */
    want_layout: bool  # imgui_internal.h:2647
    # bool                VisibleTabWasSubmitted;    /* original C++ signature */
    visible_tab_was_submitted: bool  # imgui_internal.h:2648
    # bool                TabsAddedNew;    /* original C++ signature */
    tabs_added_new: bool  # Set to True when a new tab item or button has been added to the tab bar during last frame    # imgui_internal.h:2649
    # ImS16               TabsActiveCount;    /* original C++ signature */
    tabs_active_count: ImS16  # Number of tabs submitted this frame.    # imgui_internal.h:2650
    # ImS16               LastTabItemIdx;    /* original C++ signature */
    last_tab_item_idx: ImS16  # Index of last BeginTabItem() tab for use by EndTabItem()    # imgui_internal.h:2651
    # float               ItemSpacingY;    /* original C++ signature */
    item_spacing_y: float  # imgui_internal.h:2652
    # ImVec2              FramePadding;    /* original C++ signature */
    frame_padding: ImVec2  # style.FramePadding locked at the time of BeginTabBar()    # imgui_internal.h:2653
    # ImVec2              BackupCursorPos;    /* original C++ signature */
    backup_cursor_pos: ImVec2  # imgui_internal.h:2654
    # ImGuiTextBuffer     TabsNames;    /* original C++ signature */
    tabs_names: TextBuffer  # For non-docking tab bar we re-append names in a contiguous buffer.    # imgui_internal.h:2655

    # ImGuiTabBar();    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:2657
        pass
...
class TableColumn:  # imgui_internal.h:2684
    """[Internal] sizeof() ~ 104
    ...
    flags: TableColumnFlags  # Flags after some patching (not directly same as provided by user). See ImGuiTableColumnFlags_    # imgui_internal.h:2686
    # float                   WidthGiven;    /* original C++ signature */
    width_given: float  # Final/actual width visible == (MaxX - MinX), locked in TableUpdateLayout(). May be > WidthRequest to honor minimum width, may be < WidthRequest to honor shrinking columns down in tight space.    # imgui_internal.h:2687
    # float                   MinX;    /* original C++ signature */
    min_x: float  # Absolute positions    # imgui_internal.h:2688
    # float                   MaxX;    /* original C++ signature */
    max_x: float  # imgui_internal.h:2689
    # float                   WidthRequest;    /* original C++ signature */
    width_request: float  # Master width absolute value when !(Flags & _WidthStretch). When Stretch this is derived every frame from StretchWeight in TableUpdateLayout()    # imgui_internal.h:2690
    # float                   WidthAuto;    /* original C++ signature */
    width_auto: float  # Automatic width    # imgui_internal.h:2691
    # float                   StretchWeight;    /* original C++ signature */
    stretch_weight: float  # Master width weight when (Flags & _WidthStretch). Often around ~1.0 initially.    # imgui_internal.h:2692
    # float                   InitStretchWeightOrWidth;    /* original C++ signature */
    init_stretch_weight_or_width: float  # Value passed to TableSetupColumn(). For Width it is a content width (_without padding_).    # imgui_internal.h:2693
    # ImRect                  ClipRect;    /* original C++ signature */
    clip_rect: ImRect  # Clipping rectangle for the column    # imgui_internal.h:2694
    # ImGuiID                 UserID;    /* original C++ signature */
    user_id: ID  # Optional, value passed to TableSetupColumn()    # imgui_internal.h:2695
    # float                   WorkMinX;    /* original C++ signature */
    work_min_x: float  # Contents region min ~(MinX + CellPaddingX + CellSpacingX1) == cursor start position when entering column    # imgui_internal.h:2696
    # float                   WorkMaxX;    /* original C++ signature */
    work_max_x: float  # Contents region max ~(MaxX - CellPaddingX - CellSpacingX2)    # imgui_internal.h:2697
    # float                   ItemWidth;    /* original C++ signature */
    item_width: float  # Current item width for the column, preserved across rows    # imgui_internal.h:2698
    # float                   ContentMaxXFrozen;    /* original C++ signature */
    content_max_x_frozen: float  # Contents maximum position for frozen rows (apart from headers), from which we can infer content width.    # imgui_internal.h:2699
    # float                   ContentMaxXUnfrozen;    /* original C++ signature */
    content_max_x_unfrozen: float  # imgui_internal.h:2700
    # float                   ContentMaxXHeadersUsed;    /* original C++ signature */
    content_max_x_headers_used: float  # Contents maximum position for headers rows (regardless of freezing). TableHeader() automatically softclip itself + report ideal desired size, to avoid creating extraneous draw calls    # imgui_internal.h:2701
    # float                   ContentMaxXHeadersIdeal;    /* original C++ signature */
    content_max_x_headers_ideal: float  # imgui_internal.h:2702
    # ImS16                   NameOffset;    /* original C++ signature */
    name_offset: ImS16  # Offset into parent ColumnsNames[]    # imgui_internal.h:2703
    # ImGuiTableColumnIdx     DisplayOrder;    /* original C++ signature */
    display_order: TableColumnIdx  # Index within Table's IndexToDisplayOrder[] (column may be reordered by users)    # imgui_internal.h:2704
    # ImGuiTableColumnIdx     IndexWithinEnabledSet;    /* original C++ signature */
    index_within_enabled_set: TableColumnIdx  # Index within enabled/visible set (<= IndexToDisplayOrder)    # imgui_internal.h:2705
    # ImGuiTableColumnIdx     PrevEnabledColumn;    /* original C++ signature */
    prev_enabled_column: TableColumnIdx  # Index of prev enabled/visible column within Columns[], -1 if first enabled/visible column    # imgui_internal.h:2706
    # ImGuiTableColumnIdx     NextEnabledColumn;    /* original C++ signature */
    next_enabled_column: TableColumnIdx  # Index of next enabled/visible column within Columns[], -1 if last enabled/visible column    # imgui_internal.h:2707
    # ImGuiTableColumnIdx     SortOrder;    /* original C++ signature */
    sort_order: TableColumnIdx  # Index of this column within sort specs, -1 if not sorting on this column, 0 for single-sort, may be >0 on multi-sort    # imgui_internal.h:2708
    # ImGuiTableDrawChannelIdx DrawChannelCurrent;    /* original C++ signature */
    draw_channel_current: TableDrawChannelIdx  # Index within DrawSplitter.Channels[]    # imgui_internal.h:2709
    # ImGuiTableDrawChannelIdx DrawChannelFrozen;    /* original C++ signature */
    draw_channel_frozen: TableDrawChannelIdx  # Draw channels for frozen rows (often headers)    # imgui_internal.h:2710
    # ImGuiTableDrawChannelIdx DrawChannelUnfrozen;    /* original C++ signature */
    draw_channel_unfrozen: TableDrawChannelIdx  # Draw channels for unfrozen rows    # imgui_internal.h:2711
    # bool                    IsEnabled;    /* original C++ signature */
    is_enabled: bool  # IsUserEnabled && (Flags & ImGuiTableColumnFlags_Disabled) == 0    # imgui_internal.h:2712
    # bool                    IsUserEnabled;    /* original C++ signature */
    is_user_enabled: bool  # Is the column not marked Hidden by the user? (unrelated to being off view, e.g. clipped by scrolling).    # imgui_internal.h:2713
    # bool                    IsUserEnabledNextFrame;    /* original C++ signature */
    is_user_enabled_next_frame: bool  # imgui_internal.h:2714
    # bool                    IsVisibleX;    /* original C++ signature */
    is_visible_x: bool  # Is actually in view (e.g. overlapping the host window clipping rectangle, not scrolled).    # imgui_internal.h:2715
    # bool                    IsVisibleY;    /* original C++ signature */
    is_visible_y: bool  # imgui_internal.h:2716
    # bool                    IsRequestOutput;    /* original C++ signature */
    is_request_output: bool  # Return value for TableSetColumnIndex() / TableNextColumn(): whether we request user to output contents or not.    # imgui_internal.h:2717
    # bool                    IsSkipItems;    /* original C++ signature */
    is_skip_items: bool  # Do we want item submissions to this column to be completely ignored (no layout will happen).    # imgui_internal.h:2718
    # bool                    IsPreserveWidthAuto;    /* original C++ signature */
    is_preserve_width_auto: bool  # imgui_internal.h:2719
    # ImS8                    NavLayerCurrent;    /* original C++ signature */
    nav_layer_current: ImS8  # ImGuiNavLayer in 1 byte    # imgui_internal.h:2720
    # ImU8                    AutoFitQueue;    /* original C++ signature */
    auto_fit_queue: ImU8  # Queue of 8 values for the next 8 frames to request auto-fit    # imgui_internal.h:2721
    # ImU8                    CannotSkipItemsQueue;    /* original C++ signature */
    cannot_skip_items_queue: ImU8  # Queue of 8 values for the next 8 frames to disable Clipped/SkipItem    # imgui_internal.h:2722
    # ImU8                    SortDirectionsAvailList;    /* original C++ signature */
    sort_directions_avail_list: ImU8  # Ordered of available sort directions (2-bits each)    # imgui_internal.h:2726
    ...
    #     }
    def __init__(self) -> None:  # imgui_internal.h:2728
        pass

class TableCellData:  # imgui_internal.h:2743
    """Transient cell data stored per row.
    sizeof() ~ 6
    """

    # ImU32                       BgColor;    /* original C++ signature */
    bg_color: ImU32  # Actual color    # imgui_internal.h:2745
    # ImGuiTableColumnIdx         Column;    /* original C++ signature */
    column: TableColumnIdx  # Column number    # imgui_internal.h:2746
...
class TableInstanceData:  # imgui_internal.h:2750
    ...
    last_outer_height: float  # Outer height from last frame // FIXME: multi-instance issue (#3955)    # imgui_internal.h:2752
    # float                       LastFirstRowHeight;    /* original C++ signature */
    last_first_row_height: float  # Height of first row from last frame // FIXME: possible multi-instance issue?    # imgui_internal.h:2753

    # ImGuiTableInstanceData()    { LastOuterHeight = LastFirstRowHeight = 0.0f; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:2755
        pass

class Table:  # imgui_internal.h:2759
    """FIXME-TABLE: more transient data could be stored in a per-stacked table structure: DrawSplitter, SortSpecs, incoming RowData"""

    # ImGuiID                     ID;    /* original C++ signature */
    id_: ID  # imgui_internal.h:2761
    # ImGuiTableFlags             Flags;    /* original C++ signature */
    flags: TableFlags  # imgui_internal.h:2762
    # void*                       RawData;    /* original C++ signature */
    raw_data: Any  # Single allocation to hold Columns[], DisplayOrderToIndex[] and RowCellData[]    # imgui_internal.h:2763
    # ImGuiTableTempData*         TempData;    /* original C++ signature */
    temp_data: TableTempData  # Transient data while table is active. Point within g.CurrentTableStack[]    # imgui_internal.h:2764
    # ImU64                       EnabledMaskByDisplayOrder;    /* original C++ signature */
    enabled_mask_by_display_order: ImU64  # Column DisplayOrder -> IsEnabled map    # imgui_internal.h:2768
    # ImU64                       EnabledMaskByIndex;    /* original C++ signature */
    enabled_mask_by_index: ImU64  # Column Index -> IsEnabled map (== not hidden by user/api) in a format adequate for iterating column without touching cold data    # imgui_internal.h:2769
    # ImU64                       VisibleMaskByIndex;    /* original C++ signature */
    visible_mask_by_index: ImU64  # Column Index -> IsVisibleX|IsVisibleY map (== not hidden by user/api && not hidden by scrolling/cliprect)    # imgui_internal.h:2770
    # ImU64                       RequestOutputMaskByIndex;    /* original C++ signature */
    request_output_mask_by_index: ImU64  # Column Index -> IsVisible || AutoFit (== expect user to submit items)    # imgui_internal.h:2771
    # ImGuiTableFlags             SettingsLoadedFlags;    /* original C++ signature */
    settings_loaded_flags: TableFlags  # Which data were loaded from the .ini file (e.g. when order is not altered we won't save order)    # imgui_internal.h:2772
    # int                         SettingsOffset;    /* original C++ signature */
    settings_offset: int  # Offset in g.SettingsTables    # imgui_internal.h:2773
    # int                         LastFrameActive;    /* original C++ signature */
    last_frame_active: int  # imgui_internal.h:2774
    # int                         ColumnsCount;    /* original C++ signature */
    columns_count: int  # Number of columns declared in BeginTable()    # imgui_internal.h:2775
    # int                         CurrentRow;    /* original C++ signature */
    current_row: int  # imgui_internal.h:2776
    # int                         CurrentColumn;    /* original C++ signature */
    current_column: int  # imgui_internal.h:2777
    # ImS16                       InstanceCurrent;    /* original C++ signature */
    instance_current: ImS16  # Count of BeginTable() calls with same ID in the same frame (generally 0). This is a little bit similar to BeginCount for a window, but multiple table with same ID look are multiple tables, they are just synched.    # imgui_internal.h:2778
    # ImS16                       InstanceInteracted;    /* original C++ signature */
    instance_interacted: ImS16  # Mark which instance (generally 0) of the same ID is being interacted with    # imgui_internal.h:2779
    # float                       RowPosY1;    /* original C++ signature */
    row_pos_y1: float  # imgui_internal.h:2780
    # float                       RowPosY2;    /* original C++ signature */
    row_pos_y2: float  # imgui_internal.h:2781
    # float                       RowMinHeight;    /* original C++ signature */
    row_min_height: float  # Height submitted to TableNextRow()    # imgui_internal.h:2782
    # float                       RowTextBaseline;    /* original C++ signature */
    row_text_baseline: float  # imgui_internal.h:2783
    # float                       RowIndentOffsetX;    /* original C++ signature */
    row_indent_offset_x: float  # imgui_internal.h:2784
    # int                         RowBgColorCounter;    /* original C++ signature */
    row_bg_color_counter: int  # Counter for alternating background colors (can be fast-forwarded by e.g clipper), not same as CurrentRow because header rows typically don't increase this.    # imgui_internal.h:2787
    # ImU32                       RowBgColor[2];    /* original C++ signature */
    row_bg_color: np.ndarray  # ndarray[type=ImU32, size=2]  # Background color override for current row.    # imgui_internal.h:2788
    # ImU32                       BorderColorStrong;    /* original C++ signature */
    border_color_strong: ImU32  # imgui_internal.h:2789
    # ImU32                       BorderColorLight;    /* original C++ signature */
    border_color_light: ImU32  # imgui_internal.h:2790
    # float                       BorderX1;    /* original C++ signature */
    border_x1: float  # imgui_internal.h:2791
    # float                       BorderX2;    /* original C++ signature */
    border_x2: float  # imgui_internal.h:2792
    # float                       HostIndentX;    /* original C++ signature */
    host_indent_x: float  # imgui_internal.h:2793
    # float                       MinColumnWidth;    /* original C++ signature */
    min_column_width: float  # imgui_internal.h:2794
    # float                       OuterPaddingX;    /* original C++ signature */
    outer_padding_x: float  # imgui_internal.h:2795
    # float                       CellPaddingX;    /* original C++ signature */
    cell_padding_x: float  # Padding from each borders    # imgui_internal.h:2796
    # float                       CellPaddingY;    /* original C++ signature */
    cell_padding_y: float  # imgui_internal.h:2797
    # float                       CellSpacingX1;    /* original C++ signature */
    cell_spacing_x1: float  # Spacing between non-bordered cells    # imgui_internal.h:2798
    # float                       CellSpacingX2;    /* original C++ signature */
    cell_spacing_x2: float  # imgui_internal.h:2799
    # float                       InnerWidth;    /* original C++ signature */
    inner_width: float  # User value passed to BeginTable(), see comments at the top of BeginTable() for details.    # imgui_internal.h:2800
    # float                       ColumnsGivenWidth;    /* original C++ signature */
    columns_given_width: float  # Sum of current column width    # imgui_internal.h:2801
    # float                       ColumnsAutoFitWidth;    /* original C++ signature */
    columns_auto_fit_width: float  # Sum of ideal column width in order nothing to be clipped, used for auto-fitting and content width submission in outer window    # imgui_internal.h:2802
    # float                       ColumnsStretchSumWeights;    /* original C++ signature */
    columns_stretch_sum_weights: float  # Sum of weight of all enabled stretching columns    # imgui_internal.h:2803
    # float                       ResizedColumnNextWidth;    /* original C++ signature */
    resized_column_next_width: float  # imgui_internal.h:2804
    # float                       ResizeLockMinContentsX2;    /* original C++ signature */
    resize_lock_min_contents_x2: float  # Lock minimum contents width while resizing down in order to not create feedback loops. But we allow growing the table.    # imgui_internal.h:2805
    # float                       RefScale;    /* original C++ signature */
    ref_scale: float  # Reference scale to be able to rescale columns on font/dpi changes.    # imgui_internal.h:2806
    # ImRect                      OuterRect;    /* original C++ signature */
    outer_rect: ImRect  # Note: for non-scrolling table, OuterRect.Max.y is often FLT_MAX until EndTable(), unless a height has been specified in BeginTable().    # imgui_internal.h:2807
    # ImRect                      InnerRect;    /* original C++ signature */
    inner_rect: ImRect  # InnerRect but without decoration. As with OuterRect, for non-scrolling tables, InnerRect.Max.y is    # imgui_internal.h:2808
    # ImRect                      WorkRect;    /* original C++ signature */
    work_rect: ImRect  # imgui_internal.h:2809
    # ImRect                      InnerClipRect;    /* original C++ signature */
    inner_clip_rect: ImRect  # imgui_internal.h:2810
    # ImRect                      BgClipRect;    /* original C++ signature */
    bg_clip_rect: ImRect  # We use this to cpu-clip cell background color fill, evolve during the frame as we cross frozen rows boundaries    # imgui_internal.h:2811
    # ImRect                      Bg0ClipRectForDrawCmd;    /* original C++ signature */
    bg0_clip_rect_for_draw_cmd: ImRect  # Actual ImDrawCmd clip rect for BG0/1 channel. This tends to be == OuterWindow->ClipRect at BeginTable() because output in BG0/BG1 is cpu-clipped    # imgui_internal.h:2812
    # ImRect                      Bg2ClipRectForDrawCmd;    /* original C++ signature */
    bg2_clip_rect_for_draw_cmd: ImRect  # Actual ImDrawCmd clip rect for BG2 channel. This tends to be a correct, tight-fit, because output to BG2 are done by widgets relying on regular ClipRect.    # imgui_internal.h:2813
    # ImRect                      HostClipRect;    /* original C++ signature */
    host_clip_rect: ImRect  # This is used to check if we can eventually merge our columns draw calls into the current draw call of the current window.    # imgui_internal.h:2814
    # ImRect                      HostBackupInnerClipRect;    /* original C++ signature */
    host_backup_inner_clip_rect: ImRect  # Backup of InnerWindow->ClipRect during PushTableBackground()/PopTableBackground()    # imgui_internal.h:2815
    # ImGuiWindow*                OuterWindow;    /* original C++ signature */
    outer_window: Window  # Parent window for the table    # imgui_internal.h:2816
    # ImGuiWindow*                InnerWindow;    /* original C++ signature */
    inner_window: Window  # Window holding the table data (== OuterWindow or a child window)    # imgui_internal.h:2817
    # ImGuiTextBuffer             ColumnsNames;    /* original C++ signature */
    columns_names: TextBuffer  # Contiguous buffer holding columns names    # imgui_internal.h:2818
    # ImDrawListSplitter*         DrawSplitter;    /* original C++ signature */
    draw_splitter: ImDrawListSplitter  # Shortcut to TempData->DrawSplitter while in table. Isolate draw commands per columns to avoid switching clip rect constantly    # imgui_internal.h:2819
    # ImGuiTableInstanceData      InstanceDataFirst;    /* original C++ signature */
    instance_data_first: TableInstanceData  # imgui_internal.h:2820
    # ImGuiTableColumnSortSpecs   SortSpecsSingle;    /* original C++ signature */
    sort_specs_single: TableColumnSortSpecs  # imgui_internal.h:2822
    # ImGuiTableSortSpecs         SortSpecs;    /* original C++ signature */
    sort_specs: TableSortSpecs  # Public facing sorts specs, this is what we return in TableGetSortSpecs()    # imgui_internal.h:2824
    # ImGuiTableColumnIdx         SortSpecsCount;    /* original C++ signature */
    sort_specs_count: TableColumnIdx  # imgui_internal.h:2825
    # ImGuiTableColumnIdx         ColumnsEnabledCount;    /* original C++ signature */
    columns_enabled_count: TableColumnIdx  # Number of enabled columns (<= ColumnsCount)    # imgui_internal.h:2826
    # ImGuiTableColumnIdx         ColumnsEnabledFixedCount;    /* original C++ signature */
    columns_enabled_fixed_count: TableColumnIdx  # Number of enabled columns (<= ColumnsCount)    # imgui_internal.h:2827
    # ImGuiTableColumnIdx         DeclColumnsCount;    /* original C++ signature */
    decl_columns_count: TableColumnIdx  # Count calls to TableSetupColumn()    # imgui_internal.h:2828
    # ImGuiTableColumnIdx         HoveredColumnBody;    /* original C++ signature */
    hovered_column_body: TableColumnIdx  # Index of column whose visible region is being hovered. Important: == ColumnsCount when hovering empty region after the right-most column!    # imgui_internal.h:2829
    # ImGuiTableColumnIdx         HoveredColumnBorder;    /* original C++ signature */
    hovered_column_border: TableColumnIdx  # Index of column whose right-border is being hovered (for resizing).    # imgui_internal.h:2830
    # ImGuiTableColumnIdx         AutoFitSingleColumn;    /* original C++ signature */
    auto_fit_single_column: TableColumnIdx  # Index of single column requesting auto-fit.    # imgui_internal.h:2831
    # ImGuiTableColumnIdx         ResizedColumn;    /* original C++ signature */
    resized_column: TableColumnIdx  # Index of column being resized. Reset when InstanceCurrent==0.    # imgui_internal.h:2832
    # ImGuiTableColumnIdx         LastResizedColumn;    /* original C++ signature */
    last_resized_column: TableColumnIdx  # Index of column being resized from previous frame.    # imgui_internal.h:2833
    # ImGuiTableColumnIdx         HeldHeaderColumn;    /* original C++ signature */
    held_header_column: TableColumnIdx  # Index of column header being held.    # imgui_internal.h:2834
    # ImGuiTableColumnIdx         ReorderColumn;    /* original C++ signature */
    reorder_column: TableColumnIdx  # Index of column being reordered. (not cleared)    # imgui_internal.h:2835
    # ImGuiTableColumnIdx         ReorderColumnDir;    /* original C++ signature */
    reorder_column_dir: TableColumnIdx  # -1 or +1    # imgui_internal.h:2836
    # ImGuiTableColumnIdx         LeftMostEnabledColumn;    /* original C++ signature */
    left_most_enabled_column: TableColumnIdx  # Index of left-most non-hidden column.    # imgui_internal.h:2837
    # ImGuiTableColumnIdx         RightMostEnabledColumn;    /* original C++ signature */
    right_most_enabled_column: TableColumnIdx  # Index of right-most non-hidden column.    # imgui_internal.h:2838
    # ImGuiTableColumnIdx         LeftMostStretchedColumn;    /* original C++ signature */
    left_most_stretched_column: TableColumnIdx  # Index of left-most stretched column.    # imgui_internal.h:2839
    # ImGuiTableColumnIdx         RightMostStretchedColumn;    /* original C++ signature */
    right_most_stretched_column: TableColumnIdx  # Index of right-most stretched column.    # imgui_internal.h:2840
    # ImGuiTableColumnIdx         ContextPopupColumn;    /* original C++ signature */
    context_popup_column: TableColumnIdx  # Column right-clicked on, of -1 if opening context menu from a neutral/empty spot    # imgui_internal.h:2841
    # ImGuiTableColumnIdx         FreezeRowsRequest;    /* original C++ signature */
    freeze_rows_request: TableColumnIdx  # Requested frozen rows count    # imgui_internal.h:2842
    # ImGuiTableColumnIdx         FreezeRowsCount;    /* original C++ signature */
    freeze_rows_count: TableColumnIdx  # Actual frozen row count (== FreezeRowsRequest, or == 0 when no scrolling offset)    # imgui_internal.h:2843
    # ImGuiTableColumnIdx         FreezeColumnsRequest;    /* original C++ signature */
    freeze_columns_request: TableColumnIdx  # Requested frozen columns count    # imgui_internal.h:2844
    # ImGuiTableColumnIdx         FreezeColumnsCount;    /* original C++ signature */
    freeze_columns_count: TableColumnIdx  # Actual frozen columns count (== FreezeColumnsRequest, or == 0 when no scrolling offset)    # imgui_internal.h:2845
    # ImGuiTableColumnIdx         RowCellDataCurrent;    /* original C++ signature */
    row_cell_data_current: TableColumnIdx  # Index of current RowCellData[] entry in current row    # imgui_internal.h:2846
    # ImGuiTableDrawChannelIdx    DummyDrawChannel;    /* original C++ signature */
    dummy_draw_channel: TableDrawChannelIdx  # Redirect non-visible columns here.    # imgui_internal.h:2847
    # ImGuiTableDrawChannelIdx    Bg2DrawChannelCurrent;    /* original C++ signature */
    bg2_draw_channel_current: TableDrawChannelIdx  # For Selectable() and other widgets drawing across columns after the freezing line. Index within DrawSplitter.Channels[]    # imgui_internal.h:2848
    # ImGuiTableDrawChannelIdx    Bg2DrawChannelUnfrozen;    /* original C++ signature */
    bg2_draw_channel_unfrozen: TableDrawChannelIdx  # imgui_internal.h:2849
    # bool                        IsLayoutLocked;    /* original C++ signature */
    is_layout_locked: bool  # Set by TableUpdateLayout() which is called when beginning the first row.    # imgui_internal.h:2850
    # bool                        IsInsideRow;    /* original C++ signature */
    is_inside_row: bool  # Set when inside TableBeginRow()/TableEndRow().    # imgui_internal.h:2851
    # bool                        IsInitializing;    /* original C++ signature */
    is_initializing: bool  # imgui_internal.h:2852
    # bool                        IsSortSpecsDirty;    /* original C++ signature */
    is_sort_specs_dirty: bool  # imgui_internal.h:2853
    # bool                        IsUsingHeaders;    /* original C++ signature */
    is_using_headers: bool  # Set when the first row had the ImGuiTableRowFlags_Headers flag.    # imgui_internal.h:2854
    # bool                        IsContextPopupOpen;    /* original C++ signature */
    is_context_popup_open: bool  # Set when default context menu is open (also see: ContextPopupColumn, InstanceInteracted).    # imgui_internal.h:2855
    # bool                        IsSettingsRequestLoad;    /* original C++ signature */
    is_settings_request_load: bool  # imgui_internal.h:2856
    # bool                        IsSettingsDirty;    /* original C++ signature */
    is_settings_dirty: bool  # Set when table settings have changed and needs to be reported into ImGuiTableSetttings data.    # imgui_internal.h:2857
    # bool                        IsDefaultDisplayOrder;    /* original C++ signature */
    is_default_display_order: bool  # Set when display order is unchanged from default (DisplayOrder contains 0...Count-1)    # imgui_internal.h:2858
    # bool                        IsResetAllRequest;    /* original C++ signature */
    is_reset_all_request: bool  # imgui_internal.h:2859
    # bool                        IsResetDisplayOrderRequest;    /* original C++ signature */
    is_reset_display_order_request: bool  # imgui_internal.h:2860
    # bool                        IsUnfrozenRows;    /* original C++ signature */
    is_unfrozen_rows: bool  # Set when we got past the frozen row.    # imgui_internal.h:2861
    # bool                        IsDefaultSizingPolicy;    /* original C++ signature */
    is_default_sizing_policy: bool  # Set if user didn't explicitly set a sizing policy in BeginTable()    # imgui_internal.h:2862
    # bool                        MemoryCompacted;    /* original C++ signature */
    memory_compacted: bool  # imgui_internal.h:2863
    # bool                        HostSkipItems;    /* original C++ signature */
    host_skip_items: bool  # Backup of InnerWindow->SkipItem at the end of BeginTable(), because we will overwrite InnerWindow->SkipItem on a per-column basis    # imgui_internal.h:2864

    # ImGuiTable()                { memset(this, 0, sizeof(*this)); LastFrameActive = -1; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:2866
        pass

class TableTempData:  # imgui_internal.h:2873
    ...
    table_index: int  # Index in g.Tables.Buf[] pool    # imgui_internal.h:2875
    # float                       LastTimeActive;    /* original C++ signature */
    last_time_active: float  # Last timestamp this structure was used    # imgui_internal.h:2876

    # ImVec2                      UserOuterSize;    /* original C++ signature */
    user_outer_size: ImVec2  # outer_size.x passed to BeginTable()    # imgui_internal.h:2878
    # ImDrawListSplitter          DrawSplitter;    /* original C++ signature */
    draw_splitter: ImDrawListSplitter  # imgui_internal.h:2879

    # ImRect                      HostBackupWorkRect;    /* original C++ signature */
    host_backup_work_rect: ImRect  # Backup of InnerWindow->WorkRect at the end of BeginTable()    # imgui_internal.h:2881
    # ImRect                      HostBackupParentWorkRect;    /* original C++ signature */
    host_backup_parent_work_rect: ImRect  # Backup of InnerWindow->ParentWorkRect at the end of BeginTable()    # imgui_internal.h:2882
    # ImVec2                      HostBackupPrevLineSize;    /* original C++ signature */
    host_backup_prev_line_size: ImVec2  # Backup of InnerWindow->DC.PrevLineSize at the end of BeginTable()    # imgui_internal.h:2883
    # ImVec2                      HostBackupCurrLineSize;    /* original C++ signature */
    host_backup_curr_line_size: ImVec2  # Backup of InnerWindow->DC.CurrLineSize at the end of BeginTable()    # imgui_internal.h:2884
    # ImVec2                      HostBackupCursorMaxPos;    /* original C++ signature */
    host_backup_cursor_max_pos: ImVec2  # Backup of InnerWindow->DC.CursorMaxPos at the end of BeginTable()    # imgui_internal.h:2885
    # ImVec1                      HostBackupColumnsOffset;    /* original C++ signature */
    host_backup_columns_offset: ImVec1  # Backup of OuterWindow->DC.ColumnsOffset at the end of BeginTable()    # imgui_internal.h:2886
    # float                       HostBackupItemWidth;    /* original C++ signature */
    host_backup_item_width: float  # Backup of OuterWindow->DC.ItemWidth at the end of BeginTable()    # imgui_internal.h:2887
    # int                         HostBackupItemWidthStackSize;    /* original C++ signature */
    host_backup_item_width_stack_size: int  # Backup of OuterWindow->DC.ItemWidthStack.Size at the end of BeginTable()    # imgui_internal.h:2888

    # ImGuiTableTempData()        { memset(this, 0, sizeof(*this)); LastTimeActive = -1.0f; }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:2890
        pass

class TableColumnSettings:  # imgui_internal.h:2894
    """sizeof() ~ 12"""

    # float                   WidthOrWeight;    /* original C++ signature */
    width_or_weight: float  # imgui_internal.h:2896
    # ImGuiID                 UserID;    /* original C++ signature */
    user_id: ID  # imgui_internal.h:2897
    # ImGuiTableColumnIdx     Index;    /* original C++ signature */
    index: TableColumnIdx  # imgui_internal.h:2898
    # ImGuiTableColumnIdx     DisplayOrder;    /* original C++ signature */
    display_order: TableColumnIdx  # imgui_internal.h:2899
    # ImGuiTableColumnIdx     SortOrder;    /* original C++ signature */
    sort_order: TableColumnIdx  # imgui_internal.h:2900
    ...
    #         IsStretch = 0;
    #     }
    def __init__(self) -> None:  # imgui_internal.h:2905
        pass

class TableSettings:  # imgui_internal.h:2918
    """This is designed to be stored in a single ImChunkStream (1 header followed by N ImGuiTableColumnSettings, etc.)"""

    # ImGuiID                     ID;    /* original C++ signature */
    id_: ID  # Set to 0 to invalidate/delete the setting    # imgui_internal.h:2920
    # ImGuiTableFlags             SaveFlags;    /* original C++ signature */
    save_flags: TableFlags  # Indicate data we want to save using the Resizable/Reorderable/Sortable/Hideable flags (could be using its own flags..)    # imgui_internal.h:2921
    # float                       RefScale;    /* original C++ signature */
    ref_scale: float  # Reference scale to be able to rescale columns on font/dpi changes.    # imgui_internal.h:2922
    # ImGuiTableColumnIdx         ColumnsCount;    /* original C++ signature */
    columns_count: TableColumnIdx  # imgui_internal.h:2923
    # ImGuiTableColumnIdx         ColumnsCountMax;    /* original C++ signature */
    columns_count_max: TableColumnIdx  # Maximum number of columns this settings instance can store, we can recycle a settings instance with lower number of columns but not higher    # imgui_internal.h:2924
    # bool                        WantApply;    /* original C++ signature */
    want_apply: bool  # Set when loaded from .ini data (to enable merging/loading .ini data into an already running context)    # imgui_internal.h:2925

    # ImGuiTableSettings()        { memset(this, 0, sizeof(*this)); }    /* original C++ signature */
    def __init__(self) -> None:  # imgui_internal.h:2927
        pass
...
def get_current_window() -> Window:  # imgui_internal.h:2944
    pass

# IMGUI_API ImGuiWindow*  FindWindowByID(ImGuiID id);    /* original C++ signature */
def find_window_by_id(id_: ID) -> Window:  # imgui_internal.h:2945
    pass

# IMGUI_API ImGuiWindow*  FindWindowByName(const char* name);    /* original C++ signature */
def find_window_by_name(name: str) -> Window:  # imgui_internal.h:2946
    pass
...
) -> None:  # imgui_internal.h:2947
    pass

# IMGUI_API ImVec2        CalcWindowNextAutoFitSize(ImGuiWindow* window);    /* original C++ signature */
def calc_window_next_auto_fit_size(window: Window) -> ImVec2:  # imgui_internal.h:2948
    pass
...
) -> bool:  # imgui_internal.h:2951
    pass

# IMGUI_API bool          IsWindowNavFocusable(ImGuiWindow* window);    /* original C++ signature */
def is_window_nav_focusable(window: Window) -> bool:  # imgui_internal.h:2952
    pass
...
) -> None:  # imgui_internal.h:2956
    pass

# Windows: Display Order and Focus Order
# IMGUI_API void          FocusWindow(ImGuiWindow* window);    /* original C++ signature */
def focus_window(window: Window) -> None:  # imgui_internal.h:2961
    pass
...
) -> None:  # imgui_internal.h:2962
    pass

# IMGUI_API void          BringWindowToFocusFront(ImGuiWindow* window);    /* original C++ signature */
def bring_window_to_focus_front(window: Window) -> None:  # imgui_internal.h:2963
    pass

# IMGUI_API void          BringWindowToDisplayFront(ImGuiWindow* window);    /* original C++ signature */
def bring_window_to_display_front(window: Window) -> None:  # imgui_internal.h:2964
    pass

# IMGUI_API void          BringWindowToDisplayBack(ImGuiWindow* window);    /* original C++ signature */
def bring_window_to_display_back(window: Window) -> None:  # imgui_internal.h:2965
    pass
...
) -> None:  # imgui_internal.h:2966
    pass

# IMGUI_API int           FindWindowDisplayIndex(ImGuiWindow* window);    /* original C++ signature */
def find_window_display_index(window: Window) -> int:  # imgui_internal.h:2967
    pass
...
def find_bottom_most_visible_window_within_begin_stack(
    window: Window,
) -> Window:  # imgui_internal.h:2968
    pass

# IMGUI_API void          SetCurrentFont(ImFont* font);    /* original C++ signature */
def set_current_font(font: ImFont) -> None:  # imgui_internal.h:2971
    """Fonts, drawing"""
    pass

# Init
# IMGUI_API void          Initialize();    /* original C++ signature */
def initialize() -> None:  # imgui_internal.h:2976
    pass

# IMGUI_API void          Shutdown();        /* original C++ signature */
def shutdown() -> None:  # imgui_internal.h:2977
...
def update_input_events(trickle_fast_inputs: bool) -> None:  # imgui_internal.h:2980
    pass

# IMGUI_API void          UpdateHoveredWindowAndCaptureFlags();    /* original C++ signature */
def update_hovered_window_and_capture_flags() -> None:  # imgui_internal.h:2981
    pass

# IMGUI_API void          StartMouseMovingWindow(ImGuiWindow* window);    /* original C++ signature */
def start_mouse_moving_window(window: Window) -> None:  # imgui_internal.h:2982
    pass
...
def update_mouse_moving_window_new_frame() -> None:  # imgui_internal.h:2984
    pass

# IMGUI_API void          UpdateMouseMovingWindowEndFrame();    /* original C++ signature */
def update_mouse_moving_window_end_frame() -> None:  # imgui_internal.h:2985
    pass
...
) -> None:  # imgui_internal.h:2994
    pass

# IMGUI_API void          DestroyPlatformWindow(ImGuiViewportP* viewport);    /* original C++ signature */
def destroy_platform_window(viewport: ViewportP) -> None:  # imgui_internal.h:2995
    pass
...
def get_viewport_platform_monitor(
    viewport: Viewport,
) -> PlatformMonitor:  # imgui_internal.h:2998
    pass
...
def set_scroll_x(window: Window, scroll_x: float) -> None:  # imgui_internal.h:3017
    pass

# IMGUI_API void          SetScrollY(ImGuiWindow* window, float scroll_y);    /* original C++ signature */
def set_scroll_y(window: Window, scroll_y: float) -> None:  # imgui_internal.h:3018
    pass
...
) -> None:  # imgui_internal.h:3020
    pass

# Early work-in-progress API (ScrollToItem() will become public)
# IMGUI_API void          ScrollToItem(ImGuiScrollFlags flags = 0);    /* original C++ signature */
def scroll_to_item(flags: ScrollFlags = 0) -> None:  # imgui_internal.h:3023
    pass
...
def set_active_id(id_: ID, window: Window) -> None:  # imgui_internal.h:3036
    pass

# IMGUI_API void          SetFocusID(ImGuiID id, ImGuiWindow* window);    /* original C++ signature */
def set_focus_id(id_: ID, window: Window) -> None:  # imgui_internal.h:3037
    pass

# IMGUI_API void          ClearActiveID();    /* original C++ signature */
def clear_active_id() -> None:  # imgui_internal.h:3038
    pass

# IMGUI_API ImGuiID       GetHoveredID();    /* original C++ signature */
def get_hovered_id() -> ID:  # imgui_internal.h:3039
    pass

# IMGUI_API void          SetHoveredID(ImGuiID id);    /* original C++ signature */
def set_hovered_id(id_: ID) -> None:  # imgui_internal.h:3040
    pass

# IMGUI_API void          KeepAliveID(ImGuiID id);    /* original C++ signature */
def keep_alive_id(id_: ID) -> None:  # imgui_internal.h:3041
    pass

# IMGUI_API void          MarkItemEdited(ImGuiID id);         /* original C++ signature */
def mark_item_edited(id_: ID) -> None:  # imgui_internal.h:3042
...
def push_override_id(id_: ID) -> None:  # imgui_internal.h:3043
...
) -> None:  # imgui_internal.h:3055
    pass

# IMGUI_API bool          IsItemToggledSelection();                                       /* original C++ signature */
def is_item_toggled_selection() -> bool:  # imgui_internal.h:3056
...
def get_content_region_max_abs() -> ImVec2:  # imgui_internal.h:3057
    pass
...
) -> None:  # imgui_internal.h:3074
    pass

# IMGUI_API void          ClosePopupsExceptModals();    /* original C++ signature */
def close_popups_except_modals() -> None:  # imgui_internal.h:3075
    pass

# IMGUI_API bool          IsPopupOpen(ImGuiID id, ImGuiPopupFlags popup_flags);    /* original C++ signature */
def is_popup_open(id_: ID, popup_flags: PopupFlags) -> bool:  # imgui_internal.h:3076
    pass

# IMGUI_API bool          BeginPopupEx(ImGuiID id, ImGuiWindowFlags extra_flags);    /* original C++ signature */
def begin_popup_ex(id_: ID, extra_flags: WindowFlags) -> bool:  # imgui_internal.h:3077
    pass
...
) -> None:  # imgui_internal.h:3078
    pass

# IMGUI_API ImRect        GetPopupAllowedExtentRect(ImGuiWindow* window);    /* original C++ signature */
def get_popup_allowed_extent_rect(window: Window) -> ImRect:  # imgui_internal.h:3079
    pass

# IMGUI_API ImGuiWindow*  GetTopMostPopupModal();    /* original C++ signature */
def get_top_most_popup_modal() -> Window:  # imgui_internal.h:3080
    pass

# IMGUI_API ImGuiWindow*  GetTopMostAndVisiblePopupModal();    /* original C++ signature */
def get_top_most_and_visible_popup_modal() -> Window:  # imgui_internal.h:3081
    pass

# IMGUI_API ImVec2        FindBestWindowPosForPopup(ImGuiWindow* window);    /* original C++ signature */
def find_best_window_pos_for_popup(window: Window) -> ImVec2:  # imgui_internal.h:3082
    pass
...
) -> bool:  # imgui_internal.h:3091
    pass

# IMGUI_API bool          BeginComboPreview();    /* original C++ signature */
def begin_combo_preview() -> bool:  # imgui_internal.h:3092
    pass

# IMGUI_API void          EndComboPreview();    /* original C++ signature */
def end_combo_preview() -> None:  # imgui_internal.h:3093
    pass
...
def nav_init_request_apply_result() -> None:  # imgui_internal.h:3097
    pass

# IMGUI_API bool          NavMoveRequestButNoResultYet();    /* original C++ signature */
def nav_move_request_but_no_result_yet() -> bool:  # imgui_internal.h:3098
    pass
...
def nav_move_request_resolve_with_last_item(
    result: NavItemData,
) -> None:  # imgui_internal.h:3101
    pass

# IMGUI_API void          NavMoveRequestCancel();    /* original C++ signature */
def nav_move_request_cancel() -> None:  # imgui_internal.h:3102
    pass

# IMGUI_API void          NavMoveRequestApplyResult();    /* original C++ signature */
def nav_move_request_apply_result() -> None:  # imgui_internal.h:3103
    pass
...
) -> None:  # imgui_internal.h:3104
    pass

# IMGUI_API void          ActivateItem(ImGuiID id);       /* original C++ signature */
def activate_item(id_: ID) -> None:  # imgui_internal.h:3105
...
def set_nav_window(window: Window) -> None:  # imgui_internal.h:3106
    pass
...
def get_key_data(key: Key) -> KeyData:  # imgui_internal.h:3130
    pass
...
) -> ImVec2:  # imgui_internal.h:3134
    pass

# IMGUI_API float         GetNavTweakPressedAmount(ImGuiAxis axis);    /* original C++ signature */
def get_nav_tweak_pressed_amount(axis: Axis) -> float:  # imgui_internal.h:3135
    pass
...
) -> Tuple[float, float]:  # imgui_internal.h:3137
    pass

# IMGUI_API void          SetActiveIdUsingAllKeyboardKeys();    /* original C++ signature */
def set_active_id_using_all_keyboard_keys() -> None:  # imgui_internal.h:3138
    pass
...
def get_key_owner(key: Key) -> ID:  # imgui_internal.h:3152
    pass
...
def test_key_owner(key: Key, owner_id: ID) -> bool:  # imgui_internal.h:3155
...
def is_key_released(key: Key, owner_id: ID) -> bool:  # imgui_internal.h:3166
    pass

# IMGUI_API bool              IsMouseDown(ImGuiMouseButton button, ImGuiID owner_id);    /* original C++ signature */
def is_mouse_down(button: MouseButton, owner_id: ID) -> bool:  # imgui_internal.h:3167
    pass
...
def get_shortcut_routing_data(
    key_chord: KeyChord,
) -> KeyRoutingData:  # imgui_internal.h:3184
    pass

# Docking
# (some functions are only declared in imgui.cpp, see Docking section)
# IMGUI_API void          DockContextInitialize(ImGuiContext* ctx);    /* original C++ signature */
def dock_context_initialize(ctx: Context) -> None:  # imgui_internal.h:3188
    pass

# IMGUI_API void          DockContextShutdown(ImGuiContext* ctx);    /* original C++ signature */
def dock_context_shutdown(ctx: Context) -> None:  # imgui_internal.h:3189
    pass
...
def dock_context_new_frame_update_docking(
    ctx: Context,
) -> None:  # imgui_internal.h:3193
    pass

# IMGUI_API void          DockContextEndFrame(ImGuiContext* ctx);    /* original C++ signature */
def dock_context_end_frame(ctx: Context) -> None:  # imgui_internal.h:3194
    pass

# IMGUI_API ImGuiID       DockContextGenNodeID(ImGuiContext* ctx);    /* original C++ signature */
def dock_context_gen_node_id(ctx: Context) -> ID:  # imgui_internal.h:3195
    pass
...
def dock_context_find_node_by_id(
    ctx: Context, id_: ID
) -> DockNode:  # imgui_internal.h:3200
    pass

# IMGUI_API bool          DockNodeBeginAmendTabBar(ImGuiDockNode* node);    /* original C++ signature */
def dock_node_begin_amend_tab_bar(node: DockNode) -> bool:  # imgui_internal.h:3201
    pass

# IMGUI_API void          DockNodeEndAmendTabBar();    /* original C++ signature */
def dock_node_end_amend_tab_bar() -> None:  # imgui_internal.h:3202
    pass

# IMGUI_API bool          GetWindowAlwaysWantOwnTabBar(ImGuiWindow* window);    /* original C++ signature */
def get_window_always_want_own_tab_bar(window: Window) -> bool:  # imgui_internal.h:3208
    pass

# IMGUI_API void          BeginDocked(ImGuiWindow* window, bool* p_open);    /* original C++ signature */
def begin_docked(window: Window, p_open: bool) -> bool:  # imgui_internal.h:3209
    pass

# IMGUI_API void          BeginDockableDragDropSource(ImGuiWindow* window);    /* original C++ signature */
def begin_dockable_drag_drop_source(window: Window) -> None:  # imgui_internal.h:3210
    pass

# IMGUI_API void          BeginDockableDragDropTarget(ImGuiWindow* window);    /* original C++ signature */
def begin_dockable_drag_drop_target(window: Window) -> None:  # imgui_internal.h:3211
    pass
...
) -> None:  # imgui_internal.h:3223
    pass

# IMGUI_API ImGuiDockNode*DockBuilderGetNode(ImGuiID node_id);    /* original C++ signature */
def dock_builder_get_node(node_id: ID) -> DockNode:  # imgui_internal.h:3224
    pass
...
) -> ID:  # imgui_internal.h:3226
    pass

# IMGUI_API void          DockBuilderRemoveNode(ImGuiID node_id);                     /* original C++ signature */
def dock_builder_remove_node(node_id: ID) -> None:  # imgui_internal.h:3227
...
) -> None:  # imgui_internal.h:3228
    pass

# IMGUI_API void          DockBuilderRemoveNodeChildNodes(ImGuiID node_id);           /* original C++ signature */
def dock_builder_remove_node_child_nodes(node_id: ID) -> None:  # imgui_internal.h:3229
...
) -> None:  # imgui_internal.h:3235
    pass

# IMGUI_API void          DockBuilderFinish(ImGuiID node_id);    /* original C++ signature */
def dock_builder_finish(node_id: ID) -> None:  # imgui_internal.h:3236
    pass
...
def push_focus_scope(id_: ID) -> None:  # imgui_internal.h:3246
    pass

# IMGUI_API void          PopFocusScope();    /* original C++ signature */
def pop_focus_scope() -> None:  # imgui_internal.h:3247
    pass

# Drag and Drop
# IMGUI_API bool          IsDragDropActive();    /* original C++ signature */
def is_drag_drop_active() -> bool:  # imgui_internal.h:3251
    pass

# IMGUI_API bool          BeginDragDropTargetCustom(const ImRect& bb, ImGuiID id);    /* original C++ signature */
def begin_drag_drop_target_custom(bb: ImRect, id_: ID) -> bool:  # imgui_internal.h:3252
    pass

# IMGUI_API void          ClearDragDrop();    /* original C++ signature */
def clear_drag_drop() -> None:  # imgui_internal.h:3253
    pass

# IMGUI_API bool          IsDragDropPayloadBeingAccepted();    /* original C++ signature */
def is_drag_drop_payload_being_accepted() -> bool:  # imgui_internal.h:3254
    pass

# IMGUI_API void          RenderDragDropTargetRect(const ImRect& bb);    /* original C++ signature */
def render_drag_drop_target_rect(bb: ImRect) -> None:  # imgui_internal.h:3255
    pass
...
) -> OldColumns:  # imgui_internal.h:3265
    pass
...
) -> float:  # imgui_internal.h:3267
    pass

# Tables: Candidates for public API
# IMGUI_API void          TableOpenContextMenu(int column_n = -1);    /* original C++ signature */
def table_open_context_menu(column_n: int = -1) -> None:  # imgui_internal.h:3270
    pass
...
) -> None:  # imgui_internal.h:3272
    pass

# IMGUI_API int           TableGetHoveredColumn();     /* original C++ signature */
def table_get_hovered_column() -> int:  # imgui_internal.h:3273
...
def table_get_header_row_height() -> float:  # imgui_internal.h:3274
    pass

# IMGUI_API void          TablePushBackgroundChannel();    /* original C++ signature */
def table_push_background_channel() -> None:  # imgui_internal.h:3275
    pass

# IMGUI_API void          TablePopBackgroundChannel();    /* original C++ signature */
def table_pop_background_channel() -> None:  # imgui_internal.h:3276
    pass

# IMGUI_API ImGuiTable*   TableFindByID(ImGuiID id);    /* original C++ signature */
def table_find_by_id(id_: ID) -> Table:  # imgui_internal.h:3280
    pass
...
def table_begin_apply_requests(table: Table) -> None:  # imgui_internal.h:3283
    pass

# IMGUI_API void          TableSetupDrawChannels(ImGuiTable* table);    /* original C++ signature */
def table_setup_draw_channels(table: Table) -> None:  # imgui_internal.h:3284
    pass

# IMGUI_API void          TableUpdateLayout(ImGuiTable* table);    /* original C++ signature */
def table_update_layout(table: Table) -> None:  # imgui_internal.h:3285
    pass

# IMGUI_API void          TableUpdateBorders(ImGuiTable* table);    /* original C++ signature */
def table_update_borders(table: Table) -> None:  # imgui_internal.h:3286
    pass
...
def table_get_column_next_sort_direction(
    column: TableColumn,
) -> SortDirection:  # imgui_internal.h:3295
    pass
...
) -> ImRect:  # imgui_internal.h:3302
    pass

# IMGUI_API const char*   TableGetColumnName(const ImGuiTable* table, int column_n);    /* original C++ signature */
def table_get_column_name(table: Table, column_n: int) -> str:  # imgui_internal.h:3303
    pass
...
def table_set_column_width_auto_single(
    table: Table, column_n: int
) -> None:  # imgui_internal.h:3306
    pass

# IMGUI_API void          TableSetColumnWidthAutoAll(ImGuiTable* table);    /* original C++ signature */
def table_set_column_width_auto_all(table: Table) -> None:  # imgui_internal.h:3307
    pass

# IMGUI_API void          TableRemove(ImGuiTable* table);    /* original C++ signature */
def table_remove(table: Table) -> None:  # imgui_internal.h:3308
    pass

# IMGUI_API void          TableGcCompactTransientBuffers(ImGuiTable* table);    /* original C++ signature */
def table_gc_compact_transient_buffers(table: Table) -> None:  # imgui_internal.h:3309
    pass
...
) -> TableSettings:  # imgui_internal.h:3319
    pass

# IMGUI_API ImGuiTableSettings*   TableSettingsFindByID(ImGuiID id);    /* original C++ signature */
def table_settings_find_by_id(id_: ID) -> TableSettings:  # imgui_internal.h:3320
    pass
...
) -> None:  # imgui_internal.h:3326
    pass

# IMGUI_API void          TabBarRemoveTab(ImGuiTabBar* tab_bar, ImGuiID tab_id);    /* original C++ signature */
def tab_bar_remove_tab(tab_bar: TabBar, tab_id: ID) -> None:  # imgui_internal.h:3327
    pass

# IMGUI_API void          TabBarCloseTab(ImGuiTabBar* tab_bar, ImGuiTabItem* tab);    /* original C++ signature */
def tab_bar_close_tab(tab_bar: TabBar, tab: TabItem) -> None:  # imgui_internal.h:3328
    pass
...
def tab_bar_process_reorder(tab_bar: TabBar) -> bool:  # imgui_internal.h:3331
    pass
...
) -> Tuple[bool, bool]:  # imgui_internal.h:3332
    pass
...
) -> ImVec2:  # imgui_internal.h:3333
    pass

# IMGUI_API ImVec2        TabItemCalcSize(ImGuiWindow* window);    /* original C++ signature */
def tab_item_calc_size(window: Window) -> ImVec2:  # imgui_internal.h:3334
    pass
...
) -> Tuple[bool, bool]:  # imgui_internal.h:3336
    pass
...
) -> ImDrawFlags:  # imgui_internal.h:3361
    pass
...
) -> bool:  # imgui_internal.h:3365
    pass

# IMGUI_API bool          CloseButton(ImGuiID id, const ImVec2& pos);    /* original C++ signature */
def close_button(id_: ID, pos: ImVec2) -> bool:  # imgui_internal.h:3366
    pass
...
def scrollbar(axis: Axis) -> None:  # imgui_internal.h:3369
    pass
...
) -> ImRect:  # imgui_internal.h:3372
    pass

# IMGUI_API ImGuiID       GetWindowScrollbarID(ImGuiWindow* window, ImGuiAxis axis);    /* original C++ signature */
def get_window_scrollbar_id(window: Window, axis: Axis) -> ID:  # imgui_internal.h:3373
    pass

# IMGUI_API ImGuiID       GetWindowResizeCornerID(ImGuiWindow* window, int n);     /* original C++ signature */
def get_window_resize_corner_id(window: Window, n: int) -> ID:  # imgui_internal.h:3374
    """0..3: corners"""
    pass
...
) -> ID:  # imgui_internal.h:3375
    pass

# IMGUI_API void          SeparatorEx(ImGuiSeparatorFlags flags);    /* original C++ signature */
def separator_ex(flags: SeparatorFlags) -> None:  # imgui_internal.h:3376
    pass
...
) -> Tuple[bool, bool, bool]:  # imgui_internal.h:3381
    pass
...
) -> bool:  # imgui_internal.h:3385
    pass

# IMGUI_API void          TreePushOverrideID(ImGuiID id);    /* original C++ signature */
def tree_push_override_id(id_: ID) -> None:  # imgui_internal.h:3386
    pass

# IMGUI_API void          TreeNodeSetOpen(ImGuiID id, bool open);    /* original C++ signature */
def tree_node_set_open(id_: ID, open: bool) -> None:  # imgui_internal.h:3387
    pass
...
def shade_verts_linear_uv(
    ...
    uv_b: ImVec2,
    clamp: bool,
) -> None:  # imgui_internal.h:3425
    pass

# Garbage collection
# IMGUI_API void          GcCompactTransientMiscBuffers();    /* original C++ signature */
def gc_compact_transient_misc_buffers() -> None:  # imgui_internal.h:3428
    pass
...
def debug_locate_item_resolve_with_last_item() -> None:  # imgui_internal.h:3442
    pass

# IMGUI_API void          ShowFontAtlas(ImFontAtlas* atlas);    /* original C++ signature */
def show_font_atlas(atlas: ImFontAtlas) -> None:  # imgui_internal.h:3445
    pass
...
def debug_node_columns(columns: OldColumns) -> None:  # imgui_internal.h:3447
    pass

# IMGUI_API void          DebugNodeDockNode(ImGuiDockNode* node, const char* label);    /* original C++ signature */
def debug_node_dock_node(node: DockNode, label: str) -> None:  # imgui_internal.h:3448
    pass
...
def debug_node_draw_cmd_show_mesh_and_bounding_box(
    ...
    show_mesh: bool,
    show_aabb: bool,
) -> None:  # imgui_internal.h:3450
    pass

# IMGUI_API void          DebugNodeFont(ImFont* font);    /* original C++ signature */
def debug_node_font(font: ImFont) -> None:  # imgui_internal.h:3451
    pass
...
class ImFontBuilderIO:  # imgui_internal.h:3491
