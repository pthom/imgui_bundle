...
class TableInstanceData:
    ...
    last_first_row_height: float  # Height of first row from last frame (FIXME: this is used as "header height" and may be reworked)
    # float                       LastFrozenHeight;    /* original C++ signature */
    last_frozen_height: float  # Height of frozen section from last frame

    # ImGuiTableInstanceData()    { LastOuterHeight = LastFirstRowHeight = LastFrozenHeight = 0.0f; }    /* original C++ signature */
    def __init__(self) -> None:
        pass
