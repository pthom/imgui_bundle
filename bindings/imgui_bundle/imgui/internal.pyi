...
# -----------------------------------------------------------------------------
# imgui/internal.pyi is the equivalent of imgui_internal.h, using the
...
class ImWcharClass(enum.IntFlag):
    ...
    # ImWcharClass_Blank,     /* original C++ signature */
    blank = enum.auto()  # (= 0)
    # ImWcharClass_Punct,     /* original C++ signature */
    punct = enum.auto()  # (= 1)
    # ImWcharClass_Other    /* original C++ signature */
    # }
    other = enum.auto()  # (= 2)

# IMGUI_API void          ImTextInitClassifiers();    /* original C++ signature */
def im_text_init_classifiers() -> None:
    pass

# IMGUI_API void          ImTextClassifierClear(ImU32* bits, unsigned int codepoint_min, unsigned int codepoint_end, ImWcharClass char_class);    /* original C++ signature */
def im_text_classifier_clear(bits: ImU32, codepoint_min: int, codepoint_end: int, char_class: ImWcharClass) -> None:
    pass

# IMGUI_API void          ImTextClassifierSetCharClass(ImU32* bits, unsigned int codepoint_min, unsigned int codepoint_end, ImWcharClass char_class, unsigned int c);    /* original C++ signature */
def im_text_classifier_set_char_class(
    bits: ImU32, codepoint_min: int, codepoint_end: int, char_class: ImWcharClass, c: int
) -> None:
    pass
...
# IMGUI_API ImVec2     ImBezierCubicClosestPointCasteljau(const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const ImVec2& p4, const ImVec2& p, float max_error);    /* original C++ signature */
def im_bezier_cubic_closest_point_casteljau(
    p1: ImVec2Like, p2: ImVec2Like, p3: ImVec2Like, p4: ImVec2Like, p: ImVec2Like, max_error: float
) -> ImVec2:
...
class ImDrawListSharedData:
    ...
    curve_tessellation_max_error: float  # Tessellation tolerance when using PathBezierCurveTo()
...
class ItemFlagsPrivate_(enum.IntFlag):
    ...
    # ImGuiItemFlags_Default_                 = ImGuiItemFlags_AutoClosePopups | ImGuiItemFlags_LiveEditOnInputText,     /* original C++ signature */
    default_ = (
        enum.auto()
    )  # (= ItemFlags_AutoClosePopups | ItemFlags_LiveEditOnInputText)  # Please don't change, use PushItemFlag() instead.
...
class ItemStatusFlags_(enum.IntFlag):
    ...
    # ImGuiItemStatusFlags_EditedInternal     = 1 << 11,      /* original C++ signature */
    edited_internal = (
        enum.auto()
...
class InputTextFlagsPrivate_(enum.IntFlag):
    ...
    # ImGuiInputTextFlags_TempInput           = 1 << 27,      /* original C++ signature */
    temp_input = (
        enum.auto()
...
class ButtonFlagsPrivate_(enum.IntFlag):
    ...
    pressed_on_release = (
        enum.auto()
    )  # (= 1 << 7)  # return True on release (default requires click+release). Prior to 2026/03/20 this implied ImGuiButtonFlags_NoHoldingActiveId but they are separate now.
...
class ComboPreviewData:
    ...
    # float           BackupWorkRectMaxX;    /* original C++ signature */
    backup_work_rect_max_x: float
...
class GroupData:
    ...
    # bool        BackupAnyIdHasBeenEditedThisFrame;    /* original C++ signature */
    backup_any_id_has_been_edited_this_frame: bool
    ...
    def __init__(
        ...
        backup_any_id_has_been_edited_this_frame: bool = bool(),
...
class InputTextState:
    ...
    text_src: str  # == TextA.Data unless read-only, in which case == buf passed to InputText(). For _ReadOnly fields, pointer will be null outside the InputText() call. # (const)
    # ImVector<char>          TextA;    /* original C++ signature */
    ...
    # bool                    EditedBefore;    /* original C++ signature */
    edited_before: bool  # edited since activated
    # bool                    EditedThisFrame;    /* original C++ signature */
    edited_this_frame: bool  # edited this frame
    # bool                    ValidatedThisFrame;    /* original C++ signature */
    validated_this_frame: bool
    ...
    def get_selection_end(self) -> int:
        """(private API)"""
        pass
    # void        SetSelection(int start, int end);    /* original C++ signature */
...
class NextWindowData:
    ...
    scroll_val: ImVec2
    # ImGuiWindowFlags            WindowFlagsSet;    /* original C++ signature */
    window_flags_set: WindowFlags  # Flags to set. Use SetNextWindowFlags()!
    # ImGuiWindowFlags            WindowFlagsClear;    /* original C++ signature */
    window_flags_clear: WindowFlags
    # ImGuiChildFlags             ChildFlagsSet;    /* original C++ signature */
    child_flags_set: ChildFlags  # Flags to set. Use SetNextWindowChildFlags().
    # ImGuiChildFlags             ChildFlagsClear;    /* original C++ signature */
    child_flags_clear: ChildFlags
...
class NextItemDataFlags_(enum.IntFlag):
    ...
    # ImGuiNextItemDataFlags_HasColorMarker   = 1 << 5,    /* original C++ signature */
    # }
...
class NextItemData:
    ...
    # ImGuiItemFlags              ItemFlagsSet;    /* original C++ signature */
    item_flags_set: (
...
class WindowStackData:
    ...
    def __init__(
        ...
        parent_last_combo_preview_rect: Optional[ImRect] = None,
    ) -> None:
        """Auto-generated default constructor with named params
        ...
        Python bindings defaults:
            If any of the params below is None, then its default value below will be used:
                ...
                * ParentLastComboPreviewRect: ImRect()
        """
        pass
...
class ViewportP:
    ...
    # int                 BgFgDrawListsLastFrameActive[2];    /* original C++ signature */
    bg_fg_draw_lists_last_frame_active: (
        np.ndarray
    )  # ndarray[type=int, size=2]  # Last frame the background (0) and foreground (1) draw lists were used.
    # float               BgFgDrawListsLastTimeActive[2];    /* original C++ signature */
    bg_fg_draw_lists_last_time_active: np.ndarray  # ndarray[type=float, size=2]  # Timestamps for Gc.
...
class SettingsCleanupArgs:
    ...
    type_hash_filter: ID = (
        0  # Set to restrict cleanup to a given .ini type, e.g. == ImHashStr("Window"), ImHashStr("Table"). Otherwise every types supporting Cleanup will be affected.
    )
    # int             DiscardOlderThanMonths = 0;    /* original C++ signature */
    discard_older_than_months: int = 0  # Enable to discard entries older than XX months.
    # bool            DiscardWhenMissingDate = false;    /* original C++ signature */
    discard_when_missing_date: bool = False  # Enable to discard entries missing a date.
    # bool            DiscardAll = false;    /* original C++ signature */
    discard_all: bool = (
        False  # Enable to discard all entries = same as calling ClearIniSettings() except it may be filtered.
    )
    # bool            SetCurrentSessionDateToAll = false;    /* original C++ signature */
    set_current_session_date_to_all: bool = (
        False  # Enable to write current SessionDate to all supporting entries. // Let us know in #9460 if you use this.
    )
    # bool            SetCurrentSessionDateWhenMissingDate = false;    /* original C++ signature */
    set_current_session_date_when_missing_date: bool = (
    ...
    def __init__(
        ...
        discard_older_than_months: int = 0,
        discard_when_missing_date: bool = False,
        discard_all: bool = False,
        set_current_session_date_to_all: bool = False,
        set_current_session_date_when_missing_date: bool = False,
        _discard_older_than_date: int = 0,
    ) -> None:
        """Auto-generated default constructor with named params"""
        pass
...
class DebugLogFlags_(enum.IntFlag):
    ...
    output_to_debugger = enum.auto()  # (= 1 << 21)  # Also send output to Debugger Console [Windows only]
...
class MetricsConfig:
    ...
    # int         SettingsDiscardMonths = 6;    /* original C++ signature */
    settings_discard_months: int = 6
    # bool        SettingsHighlightOldEntries = false;    /* original C++ signature */
...
class Context:
    ...
    # float                   CurrentPixelDensity;    /* original C++ signature */
    current_pixel_density: float  # Current font density. Used by all calls to GetFontBaked().
    ...
    # ImGuiID                 WithinEndPopupID;    /* original C++ signature */
    within_end_popup_id: ID  # Set within EndPopup()
    ...
    # const char*             MixedValueLabel;    /* original C++ signature */
    mixed_value_label: str  # Value replacement when displaying a mixed value. Default to "-" (Unreal uses "Multiple values", Unity uses "---"). May be interpreted as a format: must not contain single %. Set to None to display original value. # (const)
    ...
    # bool                    AnyIdHasBeenEditedThisFrame;    /* original C++ signature */
    any_id_has_been_edited_this_frame: bool
    ...
    # bool                    ActiveIdWasSelected;    /* original C++ signature */
    active_id_was_selected: bool  # Active ID was selected at the time of activating
    # bool                    ActiveIdWasSoleSelected;    /* original C++ signature */
    active_id_was_sole_selected: bool  # Active ID was sole selection at the time of activating
    ...
    # bool                    LastActiveIdWasSelected;    /* original C++ signature */
    last_active_id_was_selected: bool
    # bool                    LastActiveIdWasSoleSelected;    /* original C++ signature */
    last_active_id_was_sole_selected: bool
    ...
    nav_scoring_no_clip_rect: ImRect  # Some nav operations (such as PageUp/PageDown) enforce a region which clipper will attempt to always keep submitted. Unset/invalid if inverted.
    ...
    # bool                    ConfigNavEnableTabbing;    /* original C++ signature */
    config_nav_enable_tabbing: bool  # = True. Enable tabbing (Tab, Shift+Tab). PLEASE LET ME KNOW IF YOU USE THIS.
    ...
    config_nav_windowing_key_next: KeyChord  # = ImGuiMod_Ctrl | ImGuiKey_Tab (or ImGuiMod_Super | ImGuiKey_Tab on OS X). Set to 0 to disable. For reconfiguration (see #4828)
    ...
    # Settings
    # ImGuiPackedDate         SessionDate;    /* original C++ signature */
    session_date: PackedDate  # Packed copy of platform_io.Platform_SessionDate, when valid.
...
class WindowTempData:
    ...
    tree_has_stack_data_depth_mask: ImU32  # Store whether given depth has ImGuiTreeNodeStackData data. Could be turned into a ImU64 if necessary. Sync any changes with TREE_NODE_MAX_DEPTH/TREE_NODE_GET_DEPTH_MASK!
    ...
    def __init__(
        ...
        item_width_default: float = float(),
...
class TabItem:
    ...
    offset: float  # Position relative to beginning of tab bar
    # float               Width;    /* original C++ signature */
...
class TabBar:
    ...
    # ImGuiID             NextScrollToTabId;    /* original C++ signature */
    next_scroll_to_tab_id: ID
...
class Table:
    ...
    # ImGuiTableColumnIdx         LastHeldHeaderColumn;    /* original C++ signature */
    last_held_header_column: TableColumnIdx  # Index of column header being held from previous frame.
    ...
    # ImGuiTableColumnIdx         ReorderColumnDstOrder;    /* original C++ signature */
    reorder_column_dst_order: TableColumnIdx  # Requested display order of column being reordered.
...
# IMGUI_API void          SetNextWindowFlags(ImGuiWindowFlags flags, bool enabled);    /* original C++ signature */
def set_next_window_flags(flags: WindowFlags, enabled: bool) -> None:
    pass

# IMGUI_API void          SetNextWindowChildFlags(ImGuiChildFlags flags, bool enabled);    /* original C++ signature */
def set_next_window_child_flags(flags: ChildFlags, enabled: bool) -> None:
    pass
...
# IMGUI_API void          SetPixelDensity(float pixel_density);     /* original C++ signature */
def set_pixel_density(pixel_density: float) -> None:
...
# IMGUI_API void          SetContextName(ImGuiContext* ctx, const char* name);    /* original C++ signature */
def set_context_name(ctx: Context, name: str) -> None:
    pass

# IMGUI_API ImGuiID       AddContextHook(ImGuiContext* ctx, const ImGuiContextHook* hook);    /* original C++ signature */
def add_context_hook(ctx: Context, hook: ContextHook) -> ID:
    pass

# IMGUI_API void          RemoveContextHook(ImGuiContext* ctx, ImGuiID hook_to_remove);    /* original C++ signature */
def remove_context_hook(ctx: Context, hook_to_remove: ID) -> None:
    pass

# IMGUI_API void          CallContextHooks(ImGuiContext* ctx, ImGuiContextHookType type);    /* original C++ signature */
def call_context_hooks(ctx: Context, type: ContextHookType) -> None:
    pass
...
# IMGUI_API void                  CleanupIniSettings(ImGuiSettingsCleanupArgs* args);     /* original C++ signature */
def cleanup_ini_settings(args: SettingsCleanupArgs) -> None:
...
# IMGUI_API ImGuiWindow*  FindFrontMostVisibleChildWindow(ImGuiWindow* window);    /* original C++ signature */
def find_front_most_visible_child_window(window: Window) -> Window:
    pass
...
# IMGUI_API bool          OpenPopupEx(ImGuiID id, ImGuiPopupFlags popup_flags = ImGuiPopupFlags_None);    /* original C++ signature */
def open_popup_ex(id_: ID, popup_flags: PopupFlags = PopupFlags_None) -> bool:
    pass
...
# IMGUI_API ImGuiMouseButton GetMouseButtonFromPopupFlags(ImGuiPopupFlags flags);    /* original C++ signature */
...
def begin_combo_preview() -> bool:
    """Submit preview contents a combo. Call this after EndCombo() to display contents that's more than just a text label."""
    pass
...
# IMGUI_API bool          SetItemKeyOwner(ImGuiKey key, ImGuiInputFlags flags);    /* original C++ signature */
def set_item_key_owner(key: Key, flags: InputFlags) -> bool:
    pass
...
# IMGUI_API bool          IsInNavFocusRoute(ImGuiID focus_scope_id);    /* original C++ signature */
...
# IMGUI_API void          RenderDragDropTargetRectEx(ImDrawList* draw_list, const ImRect& bb, float rounding);    /* original C++ signature */
def render_drag_drop_target_rect_ex(draw_list: ImDrawList, bb: ImRect, rounding: float) -> None:
    pass
...
# IMGUI_API void          RenderColorComponentMarker(const ImRect& bb, ImU32 col, float rounding);    /* original C++ signature */
def render_color_component_marker(bb: ImRect, col: ImU32, rounding: float) -> None:
    pass

# IMGUI_API void          RenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list, ImVec2 p_min, ImVec2 p_max, ImU32 col, float alpha, float grid_step, ImVec2 grid_off, float rounding = 0.0f, ImDrawFlags flags = 0);    /* original C++ signature */
...
# IMGUI_API void          RenderRectFilledInRangeH(ImDrawList* draw_list, const ImRect& rect, ImU32 col, float fill_x0, float fill_x1, float rounding);    /* original C++ signature */
def render_rect_filled_in_range_h(
    draw_list: ImDrawList, rect: ImRect, col: ImU32, fill_x0: float, fill_x1: float, rounding: float
) -> None:
    pass
...
# IMGUI_API void          TextAligned(float align_x, float width, const char* fmt, ...) ;     /* original C++ signature */
def text_aligned(align_x: float, width: float, fmt: str) -> None:
...
# IMGUI_API ImU64         DebugTextureIDToU64(ImTextureID tex_id);    /* original C++ signature */
def debug_texture_id_to_u64(tex_id: ImTextureID) -> ImU64:
    pass
...
# IMGUI_API void              ImFontAtlasFontRebuildOutput(ImFontAtlas* atlas, ImFont* font);    /* original C++ signature */
def im_font_atlas_font_rebuild_output(atlas: ImFontAtlas, font: ImFont) -> None:
    pass
...
# IMGUI_API bool              ImTextureDataUpdateNewFrame(ImTextureData* tex);    /* original C++ signature */
def im_texture_data_update_new_frame(tex: ImTextureData) -> bool:
    pass

# IMGUI_API void              ImTextureDataQueueUpload(ImTextureData* tex, int x, int y, int w, int h);    /* original C++ signature */
def im_texture_data_queue_upload(tex: ImTextureData, x: int, y: int, w: int, h: int) -> None:
    pass
