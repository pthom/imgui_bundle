...
class MetricsConfig:
    ...
    # bool        ShowStackTool = false;    /* original C++ signature */
    show_stack_tool: bool = False
...
class TableInstanceData:
    ...
    # ImGuiTableInstanceData()    { TableInstanceID = 0; LastOuterHeight = LastFirstRowHeight = LastFrozenHeight = 0.0f; }    /* original C++ signature */
    def __init__(self) -> None:
        pass
...
# IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col, ImGuiButtonFlags flags = 0);    /* original C++ signature */
def image_button_ex(
    id_: ID,
