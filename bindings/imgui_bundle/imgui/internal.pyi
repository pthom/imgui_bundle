...
class InputTextFlagsPrivate_(enum.Enum):
    ...
    im_gui_input_text_flags_localize_decimal_point = (
        enum.auto()
...
class TreeNodeFlagsPrivate_(enum.Enum):
    ...
    im_gui_tree_node_flags_clip_label_for_trailing_button = (
        enum.auto()
    ...
    # }
    im_gui_tree_node_flags_open_on_mask_ = (
        enum.auto()
    )  # (= TreeNodeFlags_OpenOnDoubleClick | TreeNodeFlags_OpenOnArrow)
...
class TreeNodeStackData:
    ...
    # ImGuiItemFlags          InFlags;    /* original C++ signature */
    in_flags: ItemFlags  # Used for nav landing
    # ImRect                  NavRect;    /* original C++ signature */
    nav_rect: ImRect  # Used for nav landing
    # ImGuiTreeNodeStackData(ImGuiID ID = ImGuiID(), ImGuiTreeNodeFlags TreeFlags = ImGuiTreeNodeFlags(), ImGuiItemFlags InFlags = ImGuiItemFlags(), ImRect NavRect = ImRect());    /* original C++ signature */
    def __init__(
        self,
        id_: ID = ID(),
...
class WindowStackData:
    ...
    # ImGuiWindowStackData(ImGuiLastItemData ParentLastItemDataBackup = ImGuiLastItemData(), ImGuiStackSizes StackSizesOnBegin = ImGuiStackSizes(), bool DisabledOverrideReenable = bool());    /* original C++ signature */
    def __init__(
        self,
...
class InputFlagsPrivate_(enum.Enum):
    ...
    im_gui_input_flags_repeat_rate_default = enum.auto()  # (= 1 << 1)  # Repeat rate: Regular (default)
    # ImGuiInputFlags_RepeatRateNavMove           = 1 << 2,       /* original C++ signature */
    im_gui_input_flags_repeat_rate_nav_move = enum.auto()  # (= 1 << 2)  # Repeat rate: Fast
    # ImGuiInputFlags_RepeatRateNavTweak          = 1 << 3,       /* original C++ signature */
    im_gui_input_flags_repeat_rate_nav_tweak = enum.auto()  # (= 1 << 3)  # Repeat rate: Faster
    # - Repeat mode: Specify when repeating key pressed can be interrupted.
    # - In theory ImGuiInputFlags_RepeatUntilOtherKeyPress may be a desirable default, but it would break too many behavior so everything is opt-in.
    # ImGuiInputFlags_RepeatUntilRelease          = 1 << 4,       /* original C++ signature */
    im_gui_input_flags_repeat_until_release = (
        enum.auto()
    ...
    im_gui_input_flags_repeat_until_key_mods_change = (
        enum.auto()
    ...
    im_gui_input_flags_repeat_until_key_mods_change_from_none = (
        enum.auto()
    ...
    im_gui_input_flags_repeat_until_other_key_press = (
        enum.auto()
    ...
    im_gui_input_flags_lock_this_frame = (
        enum.auto()
    ...
    im_gui_input_flags_lock_until_release = (
        enum.auto()
    ...
    im_gui_input_flags_cond_hovered = enum.auto()  # (= 1 << 22)  # Only set if item is hovered (default to both)
    # ImGuiInputFlags_CondActive                  = 1 << 23,      /* original C++ signature */
    im_gui_input_flags_cond_active = enum.auto()  # (= 1 << 23)  # Only set if item is active (default to both)
    # ImGuiInputFlags_CondDefault_                = ImGuiInputFlags_CondHovered | ImGuiInputFlags_CondActive,    /* original C++ signature */
    im_gui_input_flags_cond_default_ = enum.auto()  # (= InputFlags_CondHovered | InputFlags_CondActive)
    ...
    im_gui_input_flags_repeat_rate_mask_ = (
        enum.auto()
    ...
    im_gui_input_flags_repeat_until_mask_ = (
        enum.auto()
    ...
    im_gui_input_flags_repeat_mask_ = (
        enum.auto()
    ...
    im_gui_input_flags_cond_mask_ = enum.auto()  # (= InputFlags_CondHovered | InputFlags_CondActive)
    ...
    im_gui_input_flags_route_type_mask_ = (
        enum.auto()
    ...
    im_gui_input_flags_route_options_mask_ = (
        enum.auto()
    ...
    im_gui_input_flags_supported_by_is_key_pressed = enum.auto()  # (= InputFlags_RepeatMask_)
    # ImGuiInputFlags_SupportedByIsMouseClicked   = ImGuiInputFlags_Repeat,    /* original C++ signature */
    im_gui_input_flags_supported_by_is_mouse_clicked = enum.auto()  # (= InputFlags_Repeat)
    ...
    im_gui_input_flags_supported_by_shortcut = (
        enum.auto()
    ...
    im_gui_input_flags_supported_by_set_next_item_shortcut = (
        enum.auto()
    ...
    im_gui_input_flags_supported_by_set_key_owner = (
        enum.auto()
    ...
    # }
    im_gui_input_flags_supported_by_set_item_key_owner = (
        enum.auto()
...
class NavItemData:
    ...
    # ImGuiSelectionUserData SelectionUserData;    /* original C++ signature */
    selection_user_data: SelectionUserData  # I+Mov    // Best candidate SetNextItemSelectionUserData() value. Valid if (InFlags & ImGuiItemFlags_HasSelectionUserData)
...
class Context:
    ...
    nav_just_moved_to_has_selection_data: bool  # Copy of move result's InFlags & ImGuiItemFlags_HasSelectionUserData). Maybe we should just store ImGuiNavItemData.
    ...
    scrollbar_seek_mode: int  # 0: relative, -1/+1: prev/next page.
