...
def glfw_init_for_open_gl(window: GLFWwindow, install_callbacks: bool) -> bool:
    pass

def glfw_init_for_vulkan(window: GLFWwindow, install_callbacks: bool) -> bool:
    pass

def glfw_init_for_other(window: GLFWwindow, install_callbacks: bool) -> bool:
    pass
...
def glfw_install_callbacks(window: GLFWwindow) -> None:
    pass

def glfw_restore_callbacks(window: GLFWwindow) -> None:
    pass

# GLFW callbacks (individual callbacks to call if you didn't install callbacks)
def glfw_window_focus_callback(window: GLFWwindow, focused: int) -> None:
    """Since 1.84"""
    pass

def glfw_cursor_enter_callback(window: GLFWwindow, entered: int) -> None:
    """Since 1.84"""
    pass

def glfw_cursor_pos_callback(window: GLFWwindow, x: float, y: float) -> None:
    """Since 1.87"""
    pass
...
def glfw_scroll_callback(window: GLFWwindow, xoffset: float, yoffset: float) -> None:
    pass
...
def glfw_char_callback(window: GLFWwindow, c: int) -> None:
    pass
