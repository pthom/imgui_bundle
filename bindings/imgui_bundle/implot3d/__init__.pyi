...
#    ...
#    Vector3 data[42];
#    ImPlot3D::PlotLine("line", &data[0].X, &data[0].Y, &data[0].Z, 42, 0, 0, sizeof(Vector3));
#
...
# IMPLOT3D_API void PlotDummy(const char* label_id, ImPlot3DDummyFlags flags = 0);    /* original C++ signature */
