...
__Call for feedback__ : ImGui Bundle is a brand-new python and C++ package (Oct 2022). [Feedback](https://github.com/pthom/imgui_bundle/issues/10) from users would be appreciated in order to make sure its installation works on different platforms.
