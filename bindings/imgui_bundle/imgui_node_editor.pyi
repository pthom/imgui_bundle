...
class Style:  # imgui_node_editor.h:181
    # ImVec4  NodePadding;    /* original C++ signature */
    node_padding: ImVec4  # imgui_node_editor.h:183
    # float   NodeRounding;    /* original C++ signature */
    node_rounding: float  # imgui_node_editor.h:184
    # float   NodeBorderWidth;    /* original C++ signature */
    node_border_width: float  # imgui_node_editor.h:185
    # float   HoveredNodeBorderWidth;    /* original C++ signature */
    hovered_node_border_width: float  # imgui_node_editor.h:186
    # float   SelectedNodeBorderWidth;    /* original C++ signature */
    selected_node_border_width: float  # imgui_node_editor.h:187
    # float   PinRounding;    /* original C++ signature */
    pin_rounding: float  # imgui_node_editor.h:188
    # float   PinBorderWidth;    /* original C++ signature */
    pin_border_width: float  # imgui_node_editor.h:189
    # float   LinkStrength;    /* original C++ signature */
    link_strength: float  # imgui_node_editor.h:190
    # ImVec2  SourceDirection;    /* original C++ signature */
    source_direction: ImVec2  # imgui_node_editor.h:191
    # ImVec2  TargetDirection;    /* original C++ signature */
    target_direction: ImVec2  # imgui_node_editor.h:192
    # float   ScrollDuration;    /* original C++ signature */
    scroll_duration: float  # imgui_node_editor.h:193
    # float   FlowMarkerDistance;    /* original C++ signature */
    flow_marker_distance: float  # imgui_node_editor.h:194
    # float   FlowSpeed;    /* original C++ signature */
    flow_speed: float  # imgui_node_editor.h:195
    # float   FlowDuration;    /* original C++ signature */
    flow_duration: float  # imgui_node_editor.h:196
    # ImVec2  PivotAlignment;    /* original C++ signature */
    pivot_alignment: ImVec2  # imgui_node_editor.h:197
    # ImVec2  PivotSize;    /* original C++ signature */
    pivot_size: ImVec2  # imgui_node_editor.h:198
    # ImVec2  PivotScale;    /* original C++ signature */
    pivot_scale: ImVec2  # imgui_node_editor.h:199
    # float   PinCorners;    /* original C++ signature */
    pin_corners: float  # imgui_node_editor.h:200
    # float   PinRadius;    /* original C++ signature */
    pin_radius: float  # imgui_node_editor.h:201
    # float   PinArrowSize;    /* original C++ signature */
    pin_arrow_size: float  # imgui_node_editor.h:202
    # float   PinArrowWidth;    /* original C++ signature */
    pin_arrow_width: float  # imgui_node_editor.h:203
    # float   GroupRounding;    /* original C++ signature */
    group_rounding: float  # imgui_node_editor.h:204
    # float   GroupBorderWidth;    /* original C++ signature */
    group_border_width: float  # imgui_node_editor.h:205
    # float   HighlightConnectedLinks;    /* original C++ signature */
    highlight_connected_links: float  # imgui_node_editor.h:206
    # float   SnapLinkToPinDir;    /* original C++ signature */
    snap_link_to_pin_dir: float  # when True link will start on the line defined by pin direction    # imgui_node_editor.h:207
...
def set_current_editor(ctx: EditorContext) -> None:  # imgui_node_editor.h:270
    pass

# EditorContext* GetCurrentEditor();    /* original C++ signature */
def get_current_editor() -> EditorContext:  # imgui_node_editor.h:271
    pass
...
def destroy_editor(ctx: EditorContext) -> None:  # imgui_node_editor.h:273
    pass
...
def get_style() -> Style:  # imgui_node_editor.h:276
    pass

# const char* GetStyleColorName(StyleColor colorIndex);    /* original C++ signature */
def get_style_color_name(color_index: StyleColor) -> str:  # imgui_node_editor.h:277
    pass
...
def link(  # imgui_node_editor.h:311
    id: LinkId,
    start_pin_id: PinId,
    end_pin_id: PinId,
...
def flow(  # imgui_node_editor.h:313
...
def query_deleted_node(node_id: NodeId) -> bool:  # imgui_node_editor.h:328
    pass
...
) -> bool:  # imgui_node_editor.h:329
    pass

# void RejectDeletedItem();    /* original C++ signature */
def reject_deleted_item() -> None:  # imgui_node_editor.h:330
    pass

# void EndDelete();    /* original C++ signature */
def end_delete() -> None:  # imgui_node_editor.h:331
    pass
...
) -> None:  # imgui_node_editor.h:333
    pass

# void SetGroupSize(NodeId nodeId, const ImVec2& size);    /* original C++ signature */
def set_group_size(node_id: NodeId, size: ImVec2) -> None:  # imgui_node_editor.h:334
    pass

# ImVec2 GetNodePosition(NodeId nodeId);    /* original C++ signature */
def get_node_position(node_id: NodeId) -> ImVec2:  # imgui_node_editor.h:335
    pass

# ImVec2 GetNodeSize(NodeId nodeId);    /* original C++ signature */
def get_node_size(node_id: NodeId) -> ImVec2:  # imgui_node_editor.h:336
    pass

# void CenterNodeOnScreen(NodeId nodeId);    /* original C++ signature */
def center_node_on_screen(node_id: NodeId) -> None:  # imgui_node_editor.h:337
    pass

# void SetNodeZPosition(NodeId nodeId, float z);     /* original C++ signature */
def set_node_z_position(node_id: NodeId, z: float) -> None:  # imgui_node_editor.h:338
...
) -> None:  # imgui_node_editor.h:370
    pass

# bool ShowNodeContextMenu(NodeId* nodeId);    /* original C++ signature */
def show_node_context_menu(node_id: NodeId) -> bool:  # imgui_node_editor.h:372
    pass

# bool ShowPinContextMenu(PinId* pinId);    /* original C++ signature */
def show_pin_context_menu(pin_id: PinId) -> bool:  # imgui_node_editor.h:373
    pass

# bool ShowLinkContextMenu(LinkId* linkId);    /* original C++ signature */
def show_link_context_menu(link_id: LinkId) -> bool:  # imgui_node_editor.h:374
    pass

# bool ShowBackgroundContextMenu();    /* original C++ signature */
def show_background_context_menu() -> bool:  # imgui_node_editor.h:375
    pass

# void EnableShortcuts(bool enable);    /* original C++ signature */
def enable_shortcuts(enable: bool) -> None:  # imgui_node_editor.h:377
    pass

# bool AreShortcutsEnabled();    /* original C++ signature */
def are_shortcuts_enabled() -> bool:  # imgui_node_editor.h:378
    pass

# bool BeginShortcut();    /* original C++ signature */
def begin_shortcut() -> bool:  # imgui_node_editor.h:380
    pass

# bool AcceptCut();    /* original C++ signature */
def accept_cut() -> bool:  # imgui_node_editor.h:381
    pass

# bool AcceptCopy();    /* original C++ signature */
def accept_copy() -> bool:  # imgui_node_editor.h:382
    pass

# bool AcceptPaste();    /* original C++ signature */
def accept_paste() -> bool:  # imgui_node_editor.h:383
    pass

# bool AcceptDuplicate();    /* original C++ signature */
def accept_duplicate() -> bool:  # imgui_node_editor.h:384
    pass

# bool AcceptCreateNode();    /* original C++ signature */
def accept_create_node() -> bool:  # imgui_node_editor.h:385
    pass

# int  GetActionContextSize();    /* original C++ signature */
def get_action_context_size() -> int:  # imgui_node_editor.h:386
    pass

# int  GetActionContextNodes(NodeId* nodes, int size);    /* original C++ signature */
def get_action_context_nodes(
    nodes: NodeId, size: int
) -> int:  # imgui_node_editor.h:387
    pass

# int  GetActionContextLinks(LinkId* links, int size);    /* original C++ signature */
def get_action_context_links(
    links: LinkId, size: int
) -> int:  # imgui_node_editor.h:388
    pass

# void EndShortcut();    /* original C++ signature */
def end_shortcut() -> None:  # imgui_node_editor.h:389
    pass

# float GetCurrentZoom();    /* original C++ signature */
def get_current_zoom() -> float:  # imgui_node_editor.h:391
    pass

# NodeId GetHoveredNode();    /* original C++ signature */
def get_hovered_node() -> NodeId:  # imgui_node_editor.h:393
    pass

# PinId GetHoveredPin();    /* original C++ signature */
def get_hovered_pin() -> PinId:  # imgui_node_editor.h:394
    pass

# LinkId GetHoveredLink();    /* original C++ signature */
def get_hovered_link() -> LinkId:  # imgui_node_editor.h:395
    pass

# NodeId GetDoubleClickedNode();    /* original C++ signature */
def get_double_clicked_node() -> NodeId:  # imgui_node_editor.h:396
    pass

# PinId GetDoubleClickedPin();    /* original C++ signature */
def get_double_clicked_pin() -> PinId:  # imgui_node_editor.h:397
    pass

# LinkId GetDoubleClickedLink();    /* original C++ signature */
def get_double_clicked_link() -> LinkId:  # imgui_node_editor.h:398
    pass

# bool IsBackgroundClicked();    /* original C++ signature */
def is_background_clicked() -> bool:  # imgui_node_editor.h:399
    pass

# bool IsBackgroundDoubleClicked();    /* original C++ signature */
def is_background_double_clicked() -> bool:  # imgui_node_editor.h:400
    pass

# ImGuiMouseButton GetBackgroundClickButtonIndex();     /* original C++ signature */
def get_background_click_button_index() -> ImGuiMouseButton:  # imgui_node_editor.h:401
    """-1 if none"""
    pass

# ImGuiMouseButton GetBackgroundDoubleClickButtonIndex();     /* original C++ signature */
def get_background_double_click_button_index() -> ImGuiMouseButton:  # imgui_node_editor.h:402
    """-1 if none"""
    pass

# bool GetLinkPins(LinkId linkId, PinId* startPinId, PinId* endPinId);     /* original C++ signature */
def get_link_pins(  # imgui_node_editor.h:404
...
def pin_had_any_links(pin_id: PinId) -> bool:  # imgui_node_editor.h:406
    pass

# ImVec2 GetScreenSize();    /* original C++ signature */
def get_screen_size() -> ImVec2:  # imgui_node_editor.h:408
    pass

# ImVec2 ScreenToCanvas(const ImVec2& pos);    /* original C++ signature */
def screen_to_canvas(pos: ImVec2) -> ImVec2:  # imgui_node_editor.h:409
    pass

# ImVec2 CanvasToScreen(const ImVec2& pos);    /* original C++ signature */
def canvas_to_screen(pos: ImVec2) -> ImVec2:  # imgui_node_editor.h:410
    pass

# int GetNodeCount();                                    /* original C++ signature */
def get_node_count() -> int:  # imgui_node_editor.h:412
    """Returns number of submitted nodes since Begin() call"""
    pass

# int GetOrderedNodeIds(NodeId* nodes, int size);        /* original C++ signature */
def get_ordered_node_ids(nodes: NodeId, size: int) -> int:  # imgui_node_editor.h:413
