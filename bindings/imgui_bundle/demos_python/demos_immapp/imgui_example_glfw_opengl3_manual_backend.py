...
#
# This file is an adaptation of an imgui example (imgui/examples/example_glfw_opengl3/main.cpp)
# (see https://github.com/ocornut/imgui/blob/master/examples/example_glfw_opengl3/main.cpp)
#
# In this example, we implement the backend ourselves (glfw + OpenGL3)
