...
def demo_gui() -> None:
    ...
    imgui.begin_group()
    rich_md.render_unindented("# immvision.image_display()")
    rich_md.render_unindented("Displays an image (possibly resizable)")
    ...
    imgui.begin_group()
    rich_md.render_unindented("# immvision.image()")
    rich_md.render_unindented("Displays an image, while providing lots of visualization options.")
