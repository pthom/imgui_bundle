...
This file is its own narrative (narrative programming, see imgui_rich_md): its ::md sections are markdown,
rich_md.render_this_file renders them, and the Story section transcludes the others with their code."""
