...
# <submodule text_editor_bundle>
class text_editor_bundle:  # Proxy class that introduces typings for the *submodule* text_editor_bundle
    ...
    @staticmethod
    def default_snippet_language() -> constexpr SnippetLanguage:
    ...
    class SnippetData:
        ...
        de_indent_code: bool = True        # Keep the code indentation, but remove main indentation,
