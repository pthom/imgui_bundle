...
NOTE: This article is targeted to standard ImGui applications. `HelloImGui` and `Dear ImGui Bundle` provides a https://github.com/pthom/hello_imgui/blob/master/src/hello_imgui/dpi_aware.h[dedicated additional API ].
