...
void py_init_module_imgui_bundle_inner(py::module& m)
{
    ...
    m.def("run",
        ...
        py::arg("runner_params"), py::arg("with_implot") = false, py::arg("with_node_editor") = false, py::arg("with_node_editor_config") = py::none(), py::arg("with_markdown") = false, py::arg("with_markdown_options") = py::none(), py::arg("fps_idle") = 10.f, py::arg("restore_previous_geometry") = false,
    ...
    m.def("run",
        ...
        py::arg("gui_function"), py::arg("window_size") = py::none(), py::arg("window_title") = py::none(), py::arg("with_implot") = false, py::arg("with_node_editor") = false, py::arg("with_node_editor_config") = py::none(), py::arg("with_markdown") = false, py::arg("with_markdown_options") = py::none(), py::arg("fps_idle") = 10.f, py::arg("restore_previous_geometry") = false,
