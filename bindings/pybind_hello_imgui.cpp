...
void py_init_module_hello_imgui(py::module& m)
{
    ...
    m.def("run",
        py::overload_cast<VoidFunction, ImVec2, std::string, float>(HelloImGui::Run), py::arg("gui_function"), py::arg("window_size") = ImVec2(800.f, 600.f), py::arg("window_title") = "", py::arg("fps_idle") = 4.f);

    m.def("run_auto_size",
        HelloImGui::Run_AutoSize, py::arg("gui_function"), py::arg("window_title") = "", py::arg("restore_last_window_geometry") = true, py::arg("window_size") = ImVec2(0.f, 0.f), py::arg("fps_idle") = 4.f);
