...
CPP_HEADERS_DIR = _THIS_DIR + "/../external/immvision/immvision/src/immvision/internal/misc/"
...
def autogenerate_portable_file_dialogs():
    print("autogenerate_portable_file_dialogs")
    # input_cpp_header = CPP_HEADERS_DIR + "/portable_file_dialogs.h"
    output_cpp_pydef_file = CPP_GENERATED_PYBIND_DIR + "/pybind_portable_file_dialogs.cpp"
    output_stub_pyi_file = CPP_GENERATED_PYBIND_DIR + "/imgui_bundle/portable_file_dialogs.pyi"
