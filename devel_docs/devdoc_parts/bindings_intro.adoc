...
The generator in itself is located in link:https://github.com/pthom/litgen/tree/main/src/litgen[the litgen module] provided by link:https://github.com/pthom/litgen[litgen].
...
Its source code is available link:https://github.com/pthom/litgen/tree/main/src/litgen[here].
