...
void py_init_module_imgui_toggle(nb::module_& m)
{
    ...
    m.def("im_lerp",
        [](const ImOffsetRect & a, const ImOffsetRect & b, float t) -> ImOffsetRect
        {
            auto ImLerp_adapt_force_lambda = [](const ImOffsetRect & a, const ImOffsetRect & b, float t) -> ImOffsetRect
            {
