...
macro(immvision_find_opencv)
	...
	if (WIN32 AND IMGUI_BUNDLE_BUILD_PYTHON)	
		...
		file(GLOB immvision_opencv_world_dlls ${immvision_OpenCV_DLL_PATH}/opencv_world*.dll)
		if (immvision_opencv_world_dlls)		
			install(FILES ${immvision_opencv_world_dlls} DESTINATION .)
		endif()
	endif()
endmacro()
