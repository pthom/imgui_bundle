...
void py_init_module_imgui_md(py::module& m)
{
    ...
    m.def("get_code_font",
        ImGuiMd::GetCodeFont, py::return_value_policy::reference);


    auto pyClassMarkdownFontSpec =
        py::class_<ImGuiMd::MarkdownFontSpec>
            (m, "MarkdownFontSpec", "")
        .def_readwrite("italic", &ImGuiMd::MarkdownFontSpec::italic, "")
        .def_readwrite("bold", &ImGuiMd::MarkdownFontSpec::bold, "")
        .def_readwrite("header_level", &ImGuiMd::MarkdownFontSpec::headerLevel, "")
        .def(py::init<bool, bool, int>(),
            py::arg("italic_") = false, py::arg("bold_") = false, py::arg("header_level_") = 0)
        ;
