...
void py_init_module_imanim(nb::module_& m)
{
    ...
    m.def("get_morph_blend",
        ...
        {
            auto iam_get_morph_blend_adapt_force_lambda = [](ImGuiID id, ImGuiID channel_id) -> float
            {
                auto lambda_result = iam_get_morph_blend(id, channel_id);
                return lambda_result;
            };

            return iam_get_morph_blend_adapt_force_lambda(id, channel_id);
        },
    ...
    m.def("get_blended_float",
        [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, float>
        {
            auto iam_get_blended_float_adapt_force_lambda = [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, float>
            {
                auto lambda_result = iam_get_blended_float(instance_id, channel);
                return lambda_result;
            };

            return iam_get_blended_float_adapt_force_lambda(instance_id, channel);
        },     nb::arg("instance_id"), nb::arg("channel"));

    m.def("get_blended_vec2",
        [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, ImVec2>
        {
            auto iam_get_blended_vec2_adapt_force_lambda = [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, ImVec2>
            {
                auto lambda_result = iam_get_blended_vec2(instance_id, channel);
                return lambda_result;
            };

            return iam_get_blended_vec2_adapt_force_lambda(instance_id, channel);
        },     nb::arg("instance_id"), nb::arg("channel"));

    m.def("get_blended_vec4",
        [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, ImVec4>
        {
            auto iam_get_blended_vec4_adapt_force_lambda = [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, ImVec4>
            {
                auto lambda_result = iam_get_blended_vec4(instance_id, channel);
                return lambda_result;
            };

            return iam_get_blended_vec4_adapt_force_lambda(instance_id, channel);
        },     nb::arg("instance_id"), nb::arg("channel"));

    m.def("get_blended_int",
        [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, int>
        {
            auto iam_get_blended_int_adapt_force_lambda = [](ImGuiID instance_id, ImGuiID channel) -> std::pair<bool, int>
            {
                auto lambda_result = iam_get_blended_int(instance_id, channel);
                return lambda_result;
            };

            return iam_get_blended_int_adapt_force_lambda(instance_id, channel);
        },     nb::arg("instance_id"), nb::arg("channel"));
    // #endif
    //
