...
LEVEL1_HEADER = THIS_DIR + "/../../imgui_rich_md/imgui_rich_md/imgui_rich_md/backends/latex/imgui_microtex.h"
...
def write_amalgamation() -> str:
    ...
    level2 = level2.replace('#include "imgui_rich_md/backends/latex/imgui_microtex.h"\n', "")
