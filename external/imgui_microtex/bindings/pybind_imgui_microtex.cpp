...
void py_init_module_imgui_microtex(nb::module_& m)
{
    ...
    m.def("render",
        [](const std::string & latex, float fontSize, const std::optional<const ImU32> & color = std::nullopt, ImGuiMicroTeX::TexStyle style = ImGuiMicroTeX::TexStyle::Text) -> ImGuiMicroTeX::RenderedFormula
        {
            auto Render_adapt_mutable_param_with_default_value = [](const std::string & latex, float fontSize, const std::optional<const ImU32> & color = std::nullopt, ImGuiMicroTeX::TexStyle style = ImGuiMicroTeX::TexStyle::Text) -> ImGuiMicroTeX::RenderedFormula
            {
                ...
                auto lambda_result = ImGuiMicroTeX::Render(latex, fontSize, color_or_default, style);
                return lambda_result;
            };

            return Render_adapt_mutable_param_with_default_value(latex, fontSize, color, style);
        },
        nb::arg("latex"), nb::arg("font_size"), nb::arg("color").none() = nb::none(), nb::arg("style") = ImGuiMicroTeX::TexStyle::Text,
        "Python bindings defaults:\n    If color is None, then its default value will be: IM_COL32_BLACK");

    m.def("render",
        nb::overload_cast<const std::string &, float, const ImVec4 &, ImGuiMicroTeX::TexStyle>(ImGuiMicroTeX::Render), nb::arg("latex"), nb::arg("font_size"), nb::arg("color"), nb::arg("style") = ImGuiMicroTeX::TexStyle::Text);
    ...
    m.def("render_to_texture",
        [](const std::string & latex, float fontSize, const std::optional<const ImU32> & color = std::nullopt, ImGuiMicroTeX::TexStyle style = ImGuiMicroTeX::TexStyle::Text) -> ImGuiMicroTeX::FormulaTexture
        {
            auto RenderToTexture_adapt_mutable_param_with_default_value = [](const std::string & latex, float fontSize, const std::optional<const ImU32> & color = std::nullopt, ImGuiMicroTeX::TexStyle style = ImGuiMicroTeX::TexStyle::Text) -> ImGuiMicroTeX::FormulaTexture
            {
                ...
                auto lambda_result = ImGuiMicroTeX::RenderToTexture(latex, fontSize, color_or_default, style);
                return lambda_result;
            };
    ...
    m.def("render_to_texture",
        nb::overload_cast<const std::string &, float, const ImVec4 &, ImGuiMicroTeX::TexStyle>(ImGuiMicroTeX::RenderToTexture), nb::arg("latex"), nb::arg("font_size"), nb::arg("color"), nb::arg("style") = ImGuiMicroTeX::TexStyle::Text);
