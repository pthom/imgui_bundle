...
void py_init_module_imgui_test_engine(py::module& m)
{
    ...
    m.def("get_temp_string_builder",
        ImGuiTestEngine_GetTempStringBuilder, py::return_value_policy::reference);
    ...
    auto pyClassImGuiTestItemInfo =
        ...
        .def_readwrite("item_flags", &ImGuiTestItemInfo::ItemFlags, "Item flags")
    ...
    auto pyClassImGuiTestContext =
        ...
        .def("_make_aiming_space_over_pos",
            ...
            py::arg("viewport"), py::arg("over_window"), py::arg("over_pos"),
    ...
    auto pyClassImGuiTestInput =
        ...
        .def(py::init<>([](
        ImGuiTestInputType Type = ImGuiTestInputType_None, ImGuiKeyChord KeyChord = ImGuiKey_None, ImWchar Char = 0, bool Down = false, ImGuiID ViewportId = 0, ImVec2 ViewportPosSize = ImVec2())
        {
            ...
            r->ViewportPosSize = ViewportPosSize;
            return r;
        })
        , py::arg("type") = ImGuiTestInputType_None, py::arg("key_chord") = ImGuiKey_None, py::arg("char") = 0, py::arg("down") = false, py::arg("viewport_id") = 0, py::arg("viewport_pos_size") = ImVec2()
        )
        ...
        .def_readwrite("viewport_pos_size", &ImGuiTestInput::ViewportPosSize, "")
    ...
    m.def("open_source_file",
        ImGuiTestEngine_OpenSourceFile, py::arg("engine"), py::arg("source_filename"), py::arg("source_line_no"));
    ////////////////////    </generated_from:imgui_te_ui.h>    ////////////////////
