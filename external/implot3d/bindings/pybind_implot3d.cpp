...
void py_init_module_implot3d(nb::module_& m)
{
    ...
    auto pyClassImPlot3DBox =
        ...
        .def("contains",
            [](const ImPlot3DBox & self, const ImPlot3DPoint & point) -> bool
            {
                auto Contains_adapt_force_lambda = [&self](const ImPlot3DPoint & point) -> bool
                {
                    auto lambda_result = self.Contains(point);
                    return lambda_result;
                };

                return Contains_adapt_force_lambda(point);
            },
            nb::arg("point"),
    ...
    auto pyClassImPlot3DRange =
        ...
        .def("contains",
            [](const ImPlot3DRange & self, float value) -> bool
            {
                auto Contains_adapt_force_lambda = [&self](float value) -> bool
                {
