...
void py_init_module_implot(nb::module_& m)
{
    ...
    auto pyEnumImAxis_ =
        nb::enum_<ImAxis_>(m, "ImAxis_", nb::is_arithmetic(),
    ...
    auto pyEnumAxisFlags_ =
        nb::enum_<ImPlotAxisFlags_>(m, "AxisFlags_", nb::is_arithmetic(), "Options for plot axes (see SetupAxis).")
            ...
            .value("no_label", ImPlotAxisFlags_NoLabel,
                   "the axis label will not be displayed (axis labels are also hidden if the supplied string name is None)")
    ...
    auto pyEnumSubplotFlags_ =
        nb::enum_<ImPlotSubplotFlags_>(m, "SubplotFlags_", nb::is_arithmetic(),
    ...
    auto pyEnumMouseTextFlags_ =
        nb::enum_<ImPlotMouseTextFlags_>(m, "MouseTextFlags_", nb::is_arithmetic(),
    ...
    auto pyEnumDragToolFlags_ =
        nb::enum_<ImPlotDragToolFlags_>(m, "DragToolFlags_", nb::is_arithmetic(),
    ...
    auto pyEnumHistogramFlags_ =
        nb::enum_<ImPlotHistogramFlags_>(m, "HistogramFlags_", nb::is_arithmetic(),
    ...
    auto pyEnumCond_ =
        nb::enum_<ImPlotCond_>(m, "Cond_", nb::is_arithmetic(),
    ...
    auto pyEnumLocation_ =
        nb::enum_<ImPlotLocation_>(m, "Location_", nb::is_arithmetic(),
    ...
    auto pyEnumBin_ =
        nb::enum_<ImPlotBin_>(m, "Bin_", nb::is_arithmetic(),
    ...
    auto pyClassImPlotStyle =
        nb::class_<ImPlotStyle>
            ...
            .def_rw("digital_bit_height", &ImPlotStyle::DigitalBitHeight,
                    "= 8,      digital channels bit height (at y = 1.0) in pixels")
            ...
            .def_rw("fit_padding", &ImPlotStyle::FitPadding,
                    "= 0,0     additional fit padding as a percentage of the fit extents (e.g. ImVec2(0.1,0.1) adds 10% to the fit extents of X and Y)")
    ...
    auto pyClassImPlotInputMap =
        nb::class_<ImPlotInputMap>
            ...
            .def_rw("pan_mod", &ImPlotInputMap::PanMod,
                    "none   optional modifier that must be held for panning/fitting")
            ...
            .def_rw("select_cancel", &ImPlotInputMap::SelectCancel,
                    "LMB    cancels active box selection when pressed; cannot be same as Select")
            ...
            .def_rw("zoom_mod", &ImPlotInputMap::ZoomMod,
                    "none   optional modifier that must be held for scroll wheel zooming")
            .def_rw("zoom_rate", &ImPlotInputMap::ZoomRate,
                    "0.1   zoom rate for scroll (e.g. 0.1 = 10% plot range every scroll click); make negative to invert")
            .def(nb::init<>());
    ...
    m.def("begin_plot",
          [](const char *title_id, const std::optional<const ImVec2> &size = std::nullopt,
             ImPlotFlags flags = 0) -> bool {
              auto BeginPlot_adapt_mutable_param_with_default_value = [](const char *title_id,
    ...
    auto pyClassSubplotsRowColRatios =
        nb::class_<ImPlot::SubplotsRowColRatios>
            ...
            .def("__init__", [](ImPlot::SubplotsRowColRatios *self,
                                const std::optional<const std::vector<float>> &row_ratios = std::nullopt,
                                const std::optional<const std::vector<float>> &col_ratios = std::nullopt) {
    ...
    m.def("begin_subplots",
          ImPlot::BeginSubplotsWithRatios, nb::arg("title_id"), nb::arg("rows"), nb::arg("cols"), nb::arg("size"),
          nb::arg("flags") = 0, nb::arg("row_col_ratios") = nb::none());
    // #endif
    //
    ...
    m.def("setup_axis",
          [](ImAxis axis, std::optional<std::string> label = std::nullopt, ImPlotAxisFlags flags = 0) {
              auto SetupAxis_adapt_const_char_pointer_with_default_null = [](ImAxis axis,
    ...
    m.def("setup_axis_limits",
          [](ImAxis axis, double v_min, double v_max, const std::optional<const ImPlotCond> &cond = std::nullopt) {
              auto SetupAxisLimits_adapt_mutable_param_with_default_value = [](ImAxis axis, double v_min, double v_max,
                                                                               const std::optional<const ImPlotCond> &cond = std::nullopt) {
    ...
    m.def("setup_axes_limits",
          [](double x_min, double x_max, double y_min, double y_max,
             const std::optional<const ImPlotCond> &cond = std::nullopt) {
              auto SetupAxesLimits_adapt_mutable_param_with_default_value = [](double x_min, double x_max, double y_min,
                                                                               double y_max,
                                                                               const std::optional<const ImPlotCond> &cond = std::nullopt) {
    ...
    m.def("set_next_axis_limits",
          [](ImAxis axis, double v_min, double v_max, const std::optional<const ImPlotCond> &cond = std::nullopt) {
              auto SetNextAxisLimits_adapt_mutable_param_with_default_value = [](ImAxis axis, double v_min,
                                                                                 double v_max,
                                                                                 const std::optional<const ImPlotCond> &cond = std::nullopt) {
    ...
    m.def("set_next_axes_limits",
          [](double x_min, double x_max, double y_min, double y_max,
             const std::optional<const ImPlotCond> &cond = std::nullopt) {
              auto SetNextAxesLimits_adapt_mutable_param_with_default_value = [](double x_min, double x_max,
    ...
    m.def("plot_line",
          [](const char *label_id, const nb::ndarray<> &values, double xscale = 1, double xstart = 0,
             ImPlotLineFlags flags = 0, int offset = 0) {
              auto PlotLine_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values, double xscale = 1,
...
#undef DCODE
                  ...
                  if (values_type == 'B')
                      ImPlot::PlotLine(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotLine(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotLine(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotLine(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotLine(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotLine(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotLine(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotLine(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotLine(label_id, static_cast<const float *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotLine(label_id, static_cast<const double *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotLine(label_id, static_cast<const long double *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotLine(label_id, static_cast<const long long *>(values_from_pyarray),
                                       static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotLine_adapt_exclude_params = [&PlotLine_adapt_c_buffers](const char *label_id,
                                                                               const nb::ndarray<> &values,
          ...
          }, nb::arg("label_id"), nb::arg("values"), nb::arg("xscale") = 1, nb::arg("xstart") = 0, nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_line",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, ImPlotLineFlags flags = 0,
             int offset = 0) {
              auto PlotLine_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys,
                                                 ImPlotLineFlags flags = 0, int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotLine(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                       static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotLine(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                       static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotLine(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                       static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotLine(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                       static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotLine(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                       static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotLine(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                       static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotLine(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                       static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotLine(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                       static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotLine(label_id, static_cast<const float *>(xs_from_pyarray),
                                       static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotLine(label_id, static_cast<const double *>(xs_from_pyarray),
                                       static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                       offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotLine(label_id, static_cast<const long double *>(xs_from_pyarray),
                                       static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotLine(label_id, static_cast<const long long *>(xs_from_pyarray),
                                       static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
    ...
    m.def("plot_scatter",
          [](const char *label_id, const nb::ndarray<> &values, double xscale = 1, double xstart = 0,
             ImPlotScatterFlags flags = 0, int offset = 0) {
              auto PlotScatter_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values,
                                                    double xscale = 1, double xstart = 0, ImPlotScatterFlags flags = 0,
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotScatter(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotScatter(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotScatter(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotScatter(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotScatter(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotScatter(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotScatter(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotScatter(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotScatter(label_id, static_cast<const float *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotScatter(label_id, static_cast<const double *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotScatter(label_id, static_cast<const long double *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotScatter(label_id, static_cast<const long long *>(values_from_pyarray),
                                          static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotScatter_adapt_exclude_params = [&PlotScatter_adapt_c_buffers](const char *label_id,
                                                                                     const nb::ndarray<> &values,
                                                                                     double xscale = 1,
                                                                                     double xstart = 0,
    ...
    m.def("plot_scatter",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, ImPlotScatterFlags flags = 0,
             int offset = 0) {
              auto PlotScatter_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                    const nb::ndarray<> &ys, ImPlotScatterFlags flags = 0,
                                                    int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotScatter(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                          static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotScatter(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                          static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotScatter(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                          static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotScatter(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                          static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotScatter(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                          static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotScatter(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                          static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotScatter(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                          static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotScatter(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                          static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotScatter(label_id, static_cast<const float *>(xs_from_pyarray),
                                          static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotScatter(label_id, static_cast<const double *>(xs_from_pyarray),
                                          static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotScatter(label_id, static_cast<const long double *>(xs_from_pyarray),
                                          static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotScatter(label_id, static_cast<const long long *>(xs_from_pyarray),
                                          static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
    ...
    m.def("plot_stairs",
          [](const char *label_id, const nb::ndarray<> &values, double xscale = 1, double xstart = 0,
             ImPlotStairsFlags flags = 0, int offset = 0) {
              auto PlotStairs_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values, double xscale = 1,
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotStairs(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotStairs(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotStairs(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotStairs(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotStairs(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotStairs(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotStairs(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotStairs(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotStairs(label_id, static_cast<const float *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotStairs(label_id, static_cast<const double *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotStairs(label_id, static_cast<const long double *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotStairs(label_id, static_cast<const long long *>(values_from_pyarray),
                                         static_cast<int>(values_count), xscale, xstart, flags, offset, values_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotStairs_adapt_exclude_params = [&PlotStairs_adapt_c_buffers](const char *label_id,
                                                                                   const nb::ndarray<> &values,
                                                                                   double xscale = 1, double xstart = 0,
    ...
    m.def("plot_stairs",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, ImPlotStairsFlags flags = 0,
             int offset = 0) {
              auto PlotStairs_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                   const nb::ndarray<> &ys, ImPlotStairsFlags flags = 0, int offset = 0,
                                                   int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotStairs(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                         static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotStairs(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                         static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotStairs(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                         static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotStairs(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                         static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotStairs(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                         static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotStairs(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                         static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotStairs(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                         static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotStairs(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                         static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotStairs(label_id, static_cast<const float *>(xs_from_pyarray),
                                         static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count), flags,
                                         offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotStairs(label_id, static_cast<const double *>(xs_from_pyarray),
                                         static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotStairs(label_id, static_cast<const long double *>(xs_from_pyarray),
                                         static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotStairs(label_id, static_cast<const long long *>(xs_from_pyarray),
                                         static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
    ...
    m.def("plot_shaded",
          [](const char *label_id, const nb::ndarray<> &values, double yref = 0, double xscale = 1, double xstart = 0,
             ImPlotShadedFlags flags = 0, int offset = 0) {
              auto PlotShaded_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values, double yref = 0,
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotShaded(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotShaded(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotShaded(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotShaded(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotShaded(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotShaded(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotShaded(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotShaded(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotShaded(label_id, static_cast<const float *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotShaded(label_id, static_cast<const double *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotShaded(label_id, static_cast<const long double *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotShaded(label_id, static_cast<const long long *>(values_from_pyarray),
                                         static_cast<int>(values_count), yref, xscale, xstart, flags, offset,
                                         values_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotShaded_adapt_exclude_params = [&PlotShaded_adapt_c_buffers](const char *label_id,
                                                                                   const nb::ndarray<> &values,
          ...
          }, nb::arg("label_id"), nb::arg("values"), nb::arg("yref") = 0, nb::arg("xscale") = 1, nb::arg("xstart") = 0,
          nb::arg("flags") = 0, nb::arg("offset") = 0);

    m.def("plot_shaded",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, double yref = 0,
             ImPlotShadedFlags flags = 0, int offset = 0) {
              auto PlotShaded_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                   const nb::ndarray<> &ys, double yref = 0,
                                                   ImPlotShadedFlags flags = 0, int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotShaded(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                         static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotShaded(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                         static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count), yref,
                                         flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotShaded(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                         static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotShaded(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                         static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotShaded(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                         static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotShaded(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                         static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotShaded(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                         static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotShaded(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                         static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotShaded(label_id, static_cast<const float *>(xs_from_pyarray),
                                         static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count), yref,
                                         flags, offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotShaded(label_id, static_cast<const double *>(xs_from_pyarray),
                                         static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count), yref,
                                         flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotShaded(label_id, static_cast<const long double *>(xs_from_pyarray),
                                         static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotShaded(label_id, static_cast<const long long *>(xs_from_pyarray),
                                         static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                         yref, flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("yref") = 0, nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_shaded",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys1, const nb::ndarray<> &ys2,
             ImPlotShadedFlags flags = 0, int offset = 0) {
              auto PlotShaded_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                   const nb::ndarray<> &ys1, const nb::ndarray<> &ys2,
                                                   ImPlotShadedFlags flags = 0, int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  if (ys2_type == 'B')
                      ImPlot::PlotShaded(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                         static_cast<const uint8_t *>(ys1_from_pyarray),
                                         static_cast<const uint8_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'b')
                      ImPlot::PlotShaded(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                         static_cast<const int8_t *>(ys1_from_pyarray),
                                         static_cast<const int8_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'H')
                      ImPlot::PlotShaded(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                         static_cast<const uint16_t *>(ys1_from_pyarray),
                                         static_cast<const uint16_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'h')
                      ImPlot::PlotShaded(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                         static_cast<const int16_t *>(ys1_from_pyarray),
                                         static_cast<const int16_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'I')
                      ImPlot::PlotShaded(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                         static_cast<const uint32_t *>(ys1_from_pyarray),
                                         static_cast<const uint32_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'i')
                      ImPlot::PlotShaded(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                         static_cast<const int32_t *>(ys1_from_pyarray),
                                         static_cast<const int32_t *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'L')
                      ImPlot::PlotShaded(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                         static_cast<const np_uint_l *>(ys1_from_pyarray),
                                         static_cast<const np_uint_l *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'l')
                      ImPlot::PlotShaded(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                         static_cast<const np_int_l *>(ys1_from_pyarray),
                                         static_cast<const np_int_l *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'f')
                      ImPlot::PlotShaded(label_id, static_cast<const float *>(xs_from_pyarray),
                                         static_cast<const float *>(ys1_from_pyarray),
                                         static_cast<const float *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'd')
                      ImPlot::PlotShaded(label_id, static_cast<const double *>(xs_from_pyarray),
                                         static_cast<const double *>(ys1_from_pyarray),
                                         static_cast<const double *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                  else if (ys2_type == 'g')
                      ImPlot::PlotShaded(label_id, static_cast<const long double *>(xs_from_pyarray),
                                         static_cast<const long double *>(ys1_from_pyarray),
                                         static_cast<const long double *>(ys2_from_pyarray),
                                         static_cast<int>(ys2_count), flags, offset, ys2_stride);
                  else if (ys2_type == 'q')
                      ImPlot::PlotShaded(label_id, static_cast<const long long *>(xs_from_pyarray),
                                         static_cast<const long long *>(ys1_from_pyarray),
                                         static_cast<const long long *>(ys2_from_pyarray), static_cast<int>(ys2_count),
                                         flags, offset, ys2_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotShaded_adapt_exclude_params = [&PlotShaded_adapt_c_buffers](const char *label_id,
                                                                                   const nb::ndarray<> &xs,
                                                                                   const nb::ndarray<> &ys1,
                                                                                   const nb::ndarray<> &ys2,
                                                                                   ImPlotShadedFlags flags = 0,
                                                                                   int offset = 0) {
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys1"), nb::arg("ys2"), nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_bars",
          [](const char *label_id, const nb::ndarray<> &values, double bar_size = 0.67, double shift = 0,
             ImPlotBarsFlags flags = 0, int offset = 0) {
              auto PlotBars_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values,
                                                 double bar_size = 0.67, double shift = 0, ImPlotBarsFlags flags = 0,
                                                 int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(values.ndim() == 1 && values.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotBars(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotBars(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotBars(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotBars(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotBars(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotBars(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotBars(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotBars(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotBars(label_id, static_cast<const float *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotBars(label_id, static_cast<const double *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotBars(label_id, static_cast<const long double *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotBars(label_id, static_cast<const long long *>(values_from_pyarray),
                                       static_cast<int>(values_count), bar_size, shift, flags, offset, values_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotBars_adapt_exclude_params = [&PlotBars_adapt_c_buffers](const char *label_id,
                                                                               const nb::ndarray<> &values,
          ...
          }, nb::arg("label_id"), nb::arg("values"), nb::arg("bar_size") = 0.67, nb::arg("shift") = 0,
          nb::arg("flags") = 0, nb::arg("offset") = 0);

    m.def("plot_bars",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, double bar_size,
             ImPlotBarsFlags flags = 0, int offset = 0) {
              auto PlotBars_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys,
                                                 double bar_size, ImPlotBarsFlags flags = 0, int offset = 0,
                                                 int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotBars(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                       static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotBars(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                       static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotBars(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                       static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotBars(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                       static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotBars(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                       static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotBars(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                       static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotBars(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                       static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotBars(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                       static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotBars(label_id, static_cast<const float *>(xs_from_pyarray),
                                       static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotBars(label_id, static_cast<const double *>(xs_from_pyarray),
                                       static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotBars(label_id, static_cast<const long double *>(xs_from_pyarray),
                                       static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotBars(label_id, static_cast<const long long *>(xs_from_pyarray),
                                       static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                       bar_size, flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotBars_adapt_exclude_params = [&PlotBars_adapt_c_buffers](const char *label_id,
                                                                               const nb::ndarray<> &xs,
                                                                               const nb::ndarray<> &ys, double bar_size,
                                                                               ImPlotBarsFlags flags = 0,
                                                                               int offset = 0) {
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("bar_size"), nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_bar_groups",
          [](const std::vector<std::string> &label_ids, const nb::ndarray<> &values, int group_count,
             double group_size = 0.67, double shift = 0, ImPlotBarGroupsFlags flags = 0) {
              auto PlotBarGroups_adapt_c_buffers = [](const char *const label_ids[], const nb::ndarray<> &values,
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const uint8_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'b')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const int8_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'H')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const uint16_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'h')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const int16_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'I')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const uint32_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'i')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const int32_t *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'L')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const np_uint_l *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'l')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const np_int_l *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'f')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const float *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'd')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const double *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'g')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const long double *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                  else if (values_type == 'q')
                      ImPlot::PlotBarGroups(label_ids, static_cast<const long long *>(values_from_pyarray),
                                            static_cast<int>(values_count), group_count, group_size, shift, flags);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotBarGroups_adapt_c_string_list_no_count = [&PlotBarGroups_adapt_c_buffers](
                  const std::vector<std::string> &label_ids, const nb::ndarray<> &values, int group_count,
                  double group_size = 0.67, double shift = 0, ImPlotBarGroupsFlags flags = 0) {
          ...
          nb::arg("label_ids"), nb::arg("values"), nb::arg("group_count"), nb::arg("group_size") = 0.67,
          nb::arg("shift") = 0, nb::arg("flags") = 0,
    ...
    m.def("plot_error_bars",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, const nb::ndarray<> &err,
             ImPlotErrorBarsFlags flags = 0, int offset = 0) {
              auto PlotErrorBars_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                      const nb::ndarray<> &ys, const nb::ndarray<> &err,
                                                      ImPlotErrorBarsFlags flags = 0, int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (err_type == 'B')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                            static_cast<const uint8_t *>(ys_from_pyarray),
                                            static_cast<const uint8_t *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'b')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                            static_cast<const int8_t *>(ys_from_pyarray),
                                            static_cast<const int8_t *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'H')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                            static_cast<const uint16_t *>(ys_from_pyarray),
                                            static_cast<const uint16_t *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                  else if (err_type == 'h')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                            static_cast<const int16_t *>(ys_from_pyarray),
                                            static_cast<const int16_t *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'I')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                            static_cast<const uint32_t *>(ys_from_pyarray),
                                            static_cast<const uint32_t *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                  else if (err_type == 'i')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                            static_cast<const int32_t *>(ys_from_pyarray),
                                            static_cast<const int32_t *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'L')
                      ImPlot::PlotErrorBars(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                            static_cast<const np_uint_l *>(ys_from_pyarray),
                                            static_cast<const np_uint_l *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                  else if (err_type == 'l')
                      ImPlot::PlotErrorBars(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                            static_cast<const np_int_l *>(ys_from_pyarray),
                                            static_cast<const np_int_l *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                  else if (err_type == 'f')
                      ImPlot::PlotErrorBars(label_id, static_cast<const float *>(xs_from_pyarray),
                                            static_cast<const float *>(ys_from_pyarray),
                                            static_cast<const float *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'd')
                      ImPlot::PlotErrorBars(label_id, static_cast<const double *>(xs_from_pyarray),
                                            static_cast<const double *>(ys_from_pyarray),
                                            static_cast<const double *>(err_from_pyarray), static_cast<int>(err_count),
                                            flags, offset, err_stride);
                  else if (err_type == 'g')
                      ImPlot::PlotErrorBars(label_id, static_cast<const long double *>(xs_from_pyarray),
                                            static_cast<const long double *>(ys_from_pyarray),
                                            static_cast<const long double *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                  else if (err_type == 'q')
                      ImPlot::PlotErrorBars(label_id, static_cast<const long long *>(xs_from_pyarray),
                                            static_cast<const long long *>(ys_from_pyarray),
                                            static_cast<const long long *>(err_from_pyarray),
                                            static_cast<int>(err_count), flags, offset, err_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + err_type + "') for param err");
              };
              auto PlotErrorBars_adapt_exclude_params = [&PlotErrorBars_adapt_c_buffers](const char *label_id,
                                                                                         const nb::ndarray<> &xs,
                                                                                         const nb::ndarray<> &ys,
                                                                                         const nb::ndarray<> &err,
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("err"), nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_error_bars",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, const nb::ndarray<> &neg,
             const nb::ndarray<> &pos, ImPlotErrorBarsFlags flags = 0, int offset = 0) {
              auto PlotErrorBars_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                      const nb::ndarray<> &ys, const nb::ndarray<> &neg,
                                                      const nb::ndarray<> &pos, ImPlotErrorBarsFlags flags = 0,
                                                      int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  if (pos_type == 'B')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                            static_cast<const uint8_t *>(ys_from_pyarray),
                                            static_cast<const uint8_t *>(neg_from_pyarray),
                                            static_cast<const uint8_t *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'b')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                            static_cast<const int8_t *>(ys_from_pyarray),
                                            static_cast<const int8_t *>(neg_from_pyarray),
                                            static_cast<const int8_t *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'H')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                            static_cast<const uint16_t *>(ys_from_pyarray),
                                            static_cast<const uint16_t *>(neg_from_pyarray),
                                            static_cast<const uint16_t *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                  else if (pos_type == 'h')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                            static_cast<const int16_t *>(ys_from_pyarray),
                                            static_cast<const int16_t *>(neg_from_pyarray),
                                            static_cast<const int16_t *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'I')
                      ImPlot::PlotErrorBars(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                            static_cast<const uint32_t *>(ys_from_pyarray),
                                            static_cast<const uint32_t *>(neg_from_pyarray),
                                            static_cast<const uint32_t *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                  else if (pos_type == 'i')
                      ImPlot::PlotErrorBars(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                            static_cast<const int32_t *>(ys_from_pyarray),
                                            static_cast<const int32_t *>(neg_from_pyarray),
                                            static_cast<const int32_t *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'L')
                      ImPlot::PlotErrorBars(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                            static_cast<const np_uint_l *>(ys_from_pyarray),
                                            static_cast<const np_uint_l *>(neg_from_pyarray),
                                            static_cast<const np_uint_l *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                  else if (pos_type == 'l')
                      ImPlot::PlotErrorBars(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                            static_cast<const np_int_l *>(ys_from_pyarray),
                                            static_cast<const np_int_l *>(neg_from_pyarray),
                                            static_cast<const np_int_l *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                  else if (pos_type == 'f')
                      ImPlot::PlotErrorBars(label_id, static_cast<const float *>(xs_from_pyarray),
                                            static_cast<const float *>(ys_from_pyarray),
                                            static_cast<const float *>(neg_from_pyarray),
                                            static_cast<const float *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'd')
                      ImPlot::PlotErrorBars(label_id, static_cast<const double *>(xs_from_pyarray),
                                            static_cast<const double *>(ys_from_pyarray),
                                            static_cast<const double *>(neg_from_pyarray),
                                            static_cast<const double *>(pos_from_pyarray), static_cast<int>(pos_count),
                                            flags, offset, pos_stride);
                  else if (pos_type == 'g')
                      ImPlot::PlotErrorBars(label_id, static_cast<const long double *>(xs_from_pyarray),
                                            static_cast<const long double *>(ys_from_pyarray),
                                            static_cast<const long double *>(neg_from_pyarray),
                                            static_cast<const long double *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                  else if (pos_type == 'q')
                      ImPlot::PlotErrorBars(label_id, static_cast<const long long *>(xs_from_pyarray),
                                            static_cast<const long long *>(ys_from_pyarray),
                                            static_cast<const long long *>(neg_from_pyarray),
                                            static_cast<const long long *>(pos_from_pyarray),
                                            static_cast<int>(pos_count), flags, offset, pos_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotErrorBars_adapt_exclude_params = [&PlotErrorBars_adapt_c_buffers](const char *label_id,
                                                                                         const nb::ndarray<> &xs,
                                                                                         const nb::ndarray<> &ys,
                                                                                         const nb::ndarray<> &neg,
                                                                                         const nb::ndarray<> &pos,
                                                                                         ImPlotErrorBarsFlags flags = 0,
                                                                                         int offset = 0) {
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("neg"), nb::arg("pos"), nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_stems",
          [](const char *label_id, const nb::ndarray<> &values, double ref = 0, double scale = 1, double start = 0,
             ImPlotStemsFlags flags = 0, int offset = 0) {
              auto PlotStems_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values, double ref = 0,
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotStems(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotStems(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotStems(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotStems(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotStems(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotStems(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotStems(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotStems(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotStems(label_id, static_cast<const float *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotStems(label_id, static_cast<const double *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotStems(label_id, static_cast<const long double *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotStems(label_id, static_cast<const long long *>(values_from_pyarray),
                                        static_cast<int>(values_count), ref, scale, start, flags, offset,
                                        values_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotStems_adapt_exclude_params = [&PlotStems_adapt_c_buffers](const char *label_id,
                                                                                 const nb::ndarray<> &values,
                                                                                 double ref = 0, double scale = 1,
                                                                                 double start = 0,
          ...
          }, nb::arg("label_id"), nb::arg("values"), nb::arg("ref") = 0, nb::arg("scale") = 1, nb::arg("start") = 0,
          nb::arg("flags") = 0, nb::arg("offset") = 0);

    m.def("plot_stems",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, double ref = 0,
             ImPlotStemsFlags flags = 0, int offset = 0) {
              auto PlotStems_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                  const nb::ndarray<> &ys, double ref = 0, ImPlotStemsFlags flags = 0,
                                                  int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotStems(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                        static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotStems(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                        static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotStems(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                        static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotStems(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                        static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotStems(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                        static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotStems(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                        static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotStems(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                        static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                        ref, flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotStems(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                        static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotStems(label_id, static_cast<const float *>(xs_from_pyarray),
                                        static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotStems(label_id, static_cast<const double *>(xs_from_pyarray),
                                        static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count), ref,
                                        flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotStems(label_id, static_cast<const long double *>(xs_from_pyarray),
                                        static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                        ref, flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotStems(label_id, static_cast<const long long *>(xs_from_pyarray),
                                        static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                        ref, flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
          ...
          }, nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("ref") = 0, nb::arg("flags") = 0,
          nb::arg("offset") = 0);

    m.def("plot_inf_lines",
          [](const char *label_id, const nb::ndarray<> &values, ImPlotInfLinesFlags flags = 0, int offset = 0) {
              auto PlotInfLines_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values,
                                                     ImPlotInfLinesFlags flags = 0, int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(values.ndim() == 1 && values.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotInfLines(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'b')
                      ImPlot::PlotInfLines(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'H')
                      ImPlot::PlotInfLines(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'h')
                      ImPlot::PlotInfLines(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'I')
                      ImPlot::PlotInfLines(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'i')
                      ImPlot::PlotInfLines(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'L')
                      ImPlot::PlotInfLines(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'l')
                      ImPlot::PlotInfLines(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'f')
                      ImPlot::PlotInfLines(label_id, static_cast<const float *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'd')
                      ImPlot::PlotInfLines(label_id, static_cast<const double *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'g')
                      ImPlot::PlotInfLines(label_id, static_cast<const long double *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                  else if (values_type == 'q')
                      ImPlot::PlotInfLines(label_id, static_cast<const long long *>(values_from_pyarray),
                                           static_cast<int>(values_count), flags, offset, values_stride);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotInfLines_adapt_exclude_params = [&PlotInfLines_adapt_c_buffers](const char *label_id,
                                                                                       const nb::ndarray<> &values,
    ...
    m.def("plot_pie_chart",
          [](const std::vector<std::string> &label_ids, const nb::ndarray<> &values, double x, double y, double radius,
             const char *label_fmt = "%.1f", double angle0 = 90, ImPlotPieChartFlags flags = 0) {
              auto PlotPieChart_adapt_c_buffers = [](const char *const label_ids[], const nb::ndarray<> &values,
                                                     double x, double y, double radius, const char *label_fmt = "%.1f",
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      ImPlot::PlotPieChart(label_ids, static_cast<const uint8_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'b')
                      ImPlot::PlotPieChart(label_ids, static_cast<const int8_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'H')
                      ImPlot::PlotPieChart(label_ids, static_cast<const uint16_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'h')
                      ImPlot::PlotPieChart(label_ids, static_cast<const int16_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'I')
                      ImPlot::PlotPieChart(label_ids, static_cast<const uint32_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'i')
                      ImPlot::PlotPieChart(label_ids, static_cast<const int32_t *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'L')
                      ImPlot::PlotPieChart(label_ids, static_cast<const np_uint_l *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'l')
                      ImPlot::PlotPieChart(label_ids, static_cast<const np_int_l *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'f')
                      ImPlot::PlotPieChart(label_ids, static_cast<const float *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'd')
                      ImPlot::PlotPieChart(label_ids, static_cast<const double *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'g')
                      ImPlot::PlotPieChart(label_ids, static_cast<const long double *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                  else if (values_type == 'q')
                      ImPlot::PlotPieChart(label_ids, static_cast<const long long *>(values_from_pyarray),
                                           static_cast<int>(values_count), x, y, radius, label_fmt, angle0, flags);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotPieChart_adapt_c_string_list_no_count = [&PlotPieChart_adapt_c_buffers](
                  const std::vector<std::string> &label_ids, const nb::ndarray<> &values, double x, double y,
                  double radius, const char *label_fmt = "%.1f", double angle0 = 90, ImPlotPieChartFlags flags = 0) {
                  std::vector<const char *> label_ids_ptrs;
                  label_ids_ptrs.reserve(label_ids.size());
                  for (const auto &v: label_ids)
                      label_ids_ptrs.push_back(v.c_str());
          ...
          }, nb::arg("label_ids"), nb::arg("values"), nb::arg("x"), nb::arg("y"), nb::arg("radius"),
          nb::arg("label_fmt") = "%.1f", nb::arg("angle0") = 90, nb::arg("flags") = 0);

    m.def("plot_histogram",
          [](const char *label_id, const nb::ndarray<> &values, int bins = ImPlotBin_Sturges, double bar_scale = 1.0,
             const std::optional<const ImPlotRange> &range = std::nullopt, ImPlotHistogramFlags flags = 0) -> double {
              auto PlotHistogram_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &values,
                                                      int bins = ImPlotBin_Sturges, double bar_scale = 1.0,
                                                      ImPlotRange range = ImPlotRange(),
                                                      ImPlotHistogramFlags flags = 0) -> double {
                  // Check if the array is 1D and C-contiguous
                  if (!(values.ndim() == 1 && values.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (values_type == 'B')
                      return ImPlot::PlotHistogram(label_id, static_cast<const uint8_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'b')
                      return ImPlot::PlotHistogram(label_id, static_cast<const int8_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'H')
                      return ImPlot::PlotHistogram(label_id, static_cast<const uint16_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'h')
                      return ImPlot::PlotHistogram(label_id, static_cast<const int16_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'I')
                      return ImPlot::PlotHistogram(label_id, static_cast<const uint32_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'i')
                      return ImPlot::PlotHistogram(label_id, static_cast<const int32_t *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'L')
                      return ImPlot::PlotHistogram(label_id, static_cast<const np_uint_l *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'l')
                      return ImPlot::PlotHistogram(label_id, static_cast<const np_int_l *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'f')
                      return ImPlot::PlotHistogram(label_id, static_cast<const float *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'd')
                      return ImPlot::PlotHistogram(label_id, static_cast<const double *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'g')
                      return ImPlot::PlotHistogram(label_id, static_cast<const long double *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                  else if (values_type == 'q')
                      return ImPlot::PlotHistogram(label_id, static_cast<const long long *>(values_from_pyarray),
                                                   static_cast<int>(values_count), bins, bar_scale, range, flags);
                      // If we reach this point, the array type is not supported!
                  else
                      throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
              };
              auto PlotHistogram_adapt_mutable_param_with_default_value = [&PlotHistogram_adapt_c_buffers](
                  const char *label_id, const nb::ndarray<> &values, int bins = ImPlotBin_Sturges,
                  double bar_scale = 1.0, const std::optional<const ImPlotRange> &range = std::nullopt,
                  ImPlotHistogramFlags flags = 0) -> double {
                  ...
                  auto lambda_result = PlotHistogram_adapt_c_buffers(label_id, values, bins, bar_scale,
                                                                     range_or_default, flags);
                  return lambda_result;
              };

              return PlotHistogram_adapt_mutable_param_with_default_value(label_id, values, bins, bar_scale, range,
                                                                          flags);
          },
          nb::arg("label_id"), nb::arg("values"), nb::arg("bins") = ImPlotBin_Sturges, nb::arg("bar_scale") = 1.0,
          nb::arg("range") = nb::none(), nb::arg("flags") = 0,
    ...
    m.def("plot_histogram_2d",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, int x_bins = ImPlotBin_Sturges,
             int y_bins = ImPlotBin_Sturges, const std::optional<const ImPlotRect> &range = std::nullopt,
             ImPlotHistogramFlags flags = 0) -> double {
              auto PlotHistogram2D_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                        const nb::ndarray<> &ys, int x_bins = ImPlotBin_Sturges,
                                                        int y_bins = ImPlotBin_Sturges, ImPlotRect range = ImPlotRect(),
                                                        ImPlotHistogramFlags flags = 0) -> double {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                                     static_cast<const uint8_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'b')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                                     static_cast<const int8_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'H')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                                     static_cast<const uint16_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'h')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                                     static_cast<const int16_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'I')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                                     static_cast<const uint32_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'i')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                                     static_cast<const int32_t *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'L')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                                     static_cast<const np_uint_l *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'l')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                                     static_cast<const np_int_l *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'f')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const float *>(xs_from_pyarray),
                                                     static_cast<const float *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'd')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const double *>(xs_from_pyarray),
                                                     static_cast<const double *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'g')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const long double *>(xs_from_pyarray),
                                                     static_cast<const long double *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                  else if (ys_type == 'q')
                      return ImPlot::PlotHistogram2D(label_id, static_cast<const long long *>(xs_from_pyarray),
                                                     static_cast<const long long *>(ys_from_pyarray),
                                                     static_cast<int>(ys_count), x_bins, y_bins, range, flags);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotHistogram2D_adapt_mutable_param_with_default_value = [&PlotHistogram2D_adapt_c_buffers](
                  const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys,
                  int x_bins = ImPlotBin_Sturges, int y_bins = ImPlotBin_Sturges,
                  const std::optional<const ImPlotRect> &range = std::nullopt,
                  ImPlotHistogramFlags flags = 0) -> double {
                  ...
                  auto lambda_result = PlotHistogram2D_adapt_c_buffers(label_id, xs, ys, x_bins, y_bins,
                                                                       range_or_default, flags);
                  return lambda_result;
              };

              return PlotHistogram2D_adapt_mutable_param_with_default_value(label_id, xs, ys, x_bins, y_bins, range,
                                                                            flags);
          },
          nb::arg("label_id"), nb::arg("xs"), nb::arg("ys"), nb::arg("x_bins") = ImPlotBin_Sturges,
          nb::arg("y_bins") = ImPlotBin_Sturges, nb::arg("range") = nb::none(), nb::arg("flags") = 0,
    ...
    m.def("plot_digital",
          [](const char *label_id, const nb::ndarray<> &xs, const nb::ndarray<> &ys, ImPlotDigitalFlags flags = 0,
             int offset = 0) {
              auto PlotDigital_adapt_c_buffers = [](const char *label_id, const nb::ndarray<> &xs,
                                                    const nb::ndarray<> &ys, ImPlotDigitalFlags flags = 0,
                                                    int offset = 0, int stride = -1) {
                  // Check if the array is 1D and C-contiguous
                  if (!(xs.ndim() == 1 && xs.stride(0) == 1))
                      throw std::runtime_error("The array must be 1D and contiguous");
...
#undef DCODE
                  ...
                  // call the correct template version by casting
                  if (ys_type == 'B')
                      ImPlot::PlotDigital(label_id, static_cast<const uint8_t *>(xs_from_pyarray),
                                          static_cast<const uint8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'b')
                      ImPlot::PlotDigital(label_id, static_cast<const int8_t *>(xs_from_pyarray),
                                          static_cast<const int8_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'H')
                      ImPlot::PlotDigital(label_id, static_cast<const uint16_t *>(xs_from_pyarray),
                                          static_cast<const uint16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'h')
                      ImPlot::PlotDigital(label_id, static_cast<const int16_t *>(xs_from_pyarray),
                                          static_cast<const int16_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'I')
                      ImPlot::PlotDigital(label_id, static_cast<const uint32_t *>(xs_from_pyarray),
                                          static_cast<const uint32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'i')
                      ImPlot::PlotDigital(label_id, static_cast<const int32_t *>(xs_from_pyarray),
                                          static_cast<const int32_t *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'L')
                      ImPlot::PlotDigital(label_id, static_cast<const np_uint_l *>(xs_from_pyarray),
                                          static_cast<const np_uint_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'l')
                      ImPlot::PlotDigital(label_id, static_cast<const np_int_l *>(xs_from_pyarray),
                                          static_cast<const np_int_l *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'f')
                      ImPlot::PlotDigital(label_id, static_cast<const float *>(xs_from_pyarray),
                                          static_cast<const float *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'd')
                      ImPlot::PlotDigital(label_id, static_cast<const double *>(xs_from_pyarray),
                                          static_cast<const double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'g')
                      ImPlot::PlotDigital(label_id, static_cast<const long double *>(xs_from_pyarray),
                                          static_cast<const long double *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                  else if (ys_type == 'q')
                      ImPlot::PlotDigital(label_id, static_cast<const long long *>(xs_from_pyarray),
                                          static_cast<const long long *>(ys_from_pyarray), static_cast<int>(ys_count),
                                          flags, offset, ys_stride);
                      // If we reach this point, the array type is not supported!
                  else
              ...
              auto PlotDigital_adapt_exclude_params = [&PlotDigital_adapt_c_buffers](const char *label_id,
                                                                                     const nb::ndarray<> &xs,
                                                                                     const nb::ndarray<> &ys,
    ...
    m.def("plot_image",
          [](const char *label_id, ImTextureID user_texture_id, const ImPlotPoint &bounds_min,
             const ImPlotPoint &bounds_max, const std::optional<const ImVec2> &uv0 = std::nullopt,
             const std::optional<const ImVec2> &uv1 = std::nullopt,
             const std::optional<const ImVec4> &tint_col = std::nullopt, ImPlotImageFlags flags = 0) {
              auto PlotImage_adapt_mutable_param_with_default_value = [](const char *label_id,
                                                                         ImTextureID user_texture_id,
                                                                         const ImPlotPoint &bounds_min,
                                                                         const ImPlotPoint &bounds_max,
                                                                         const std::optional<const ImVec2> &uv0 = std::nullopt,
                                                                         const std::optional<const ImVec2> &uv1 = std::nullopt,
                                                                         const std::optional<const ImVec4> &tint_col = std::nullopt,
                  ...
                  ImPlot::PlotImage(label_id, user_texture_id, bounds_min, bounds_max, uv0_or_default, uv1_or_default,
                                    tint_col_or_default, flags);
              };

              PlotImage_adapt_mutable_param_with_default_value(label_id, user_texture_id, bounds_min, bounds_max, uv0,
                                                               uv1, tint_col, flags);
          },
          nb::arg("label_id"), nb::arg("user_texture_id"), nb::arg("bounds_min"), nb::arg("bounds_max"),
          nb::arg("uv0") = nb::none(), nb::arg("uv1") = nb::none(), nb::arg("tint_col") = nb::none(),
          nb::arg("flags") = 0,
          " Plots an axis-aligned image. #bounds_min/bounds_max are in plot coordinates (y-up) and #uv0/uv1 are in texture coordinates (y-down).\n---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        uv0: ImVec2(0,0)\n        uv1: ImVec2(1,1)\n        tint_col: ImVec4(1,1,1,1)");

    m.def("plot_text",
          [](const char *text, double x, double y, const std::optional<const ImVec2> &pix_offset = std::nullopt,
             ImPlotTextFlags flags = 0) {
              auto PlotText_adapt_mutable_param_with_default_value = [](const char *text, double x, double y,
                                                                        const std::optional<const ImVec2> &pix_offset = std::nullopt,
                                                                        ImPlotTextFlags flags = 0) {
    ...
    m.def("drag_point",
          [](int id, double x, double y, const ImVec4 &col, float size = 4, ImPlotDragToolFlags flags = 0,
             std::optional<bool> out_clicked = std::nullopt, std::optional<bool> out_hovered = std::nullopt,
             std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
              auto DragPoint_adapt_modifiable_immutable_to_return = [](int id, double x, double y, const ImVec4 &col,
                                                                       float size = 4, ImPlotDragToolFlags flags = 0,
                                                                       std::optional<bool> out_clicked = std::nullopt,
                                                                       std::optional<bool> out_hovered = std::nullopt,
                                                                       std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
                  ...
                  bool r = ImPlot::DragPoint(id, x_adapt_modifiable, y_adapt_modifiable, col, size, flags,
                                             out_clicked_adapt_modifiable, out_hovered_adapt_modifiable,
                                             held_adapt_modifiable);
                  return std::make_tuple(r, x, y, out_clicked, out_hovered, held);
              };

              return DragPoint_adapt_modifiable_immutable_to_return(id, x, y, col, size, flags, out_clicked,
                                                                    out_hovered, held);
          },
          nb::arg("id_"), nb::arg("x"), nb::arg("y"), nb::arg("col"), nb::arg("size") = 4, nb::arg("flags") = 0,
          nb::arg("out_clicked") = nb::none(), nb::arg("out_hovered") = nb::none(), nb::arg("held") = nb::none(),
          "Shows a draggable point at x,y. #col defaults to ImGuiCol_Text.");

    m.def("drag_line_x",
          [](int id, double x, const ImVec4 &col, float thickness = 1, ImPlotDragToolFlags flags = 0,
             std::optional<bool> out_clicked = std::nullopt, std::optional<bool> out_hovered = std::nullopt,
             std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
              auto DragLineX_adapt_modifiable_immutable_to_return = [](int id, double x, const ImVec4 &col,
                                                                       float thickness = 1,
              ...
              return DragLineX_adapt_modifiable_immutable_to_return(id, x, col, thickness, flags, out_clicked,
                                                                    out_hovered, held);
          },
          nb::arg("id_"), nb::arg("x"), nb::arg("col"), nb::arg("thickness") = 1, nb::arg("flags") = 0,
          nb::arg("out_clicked") = nb::none(), nb::arg("out_hovered") = nb::none(), nb::arg("held") = nb::none(),
          "Shows a draggable vertical guide line at an x-value. #col defaults to ImGuiCol_Text.");

    m.def("drag_line_y",
          [](int id, double y, const ImVec4 &col, float thickness = 1, ImPlotDragToolFlags flags = 0,
             std::optional<bool> out_clicked = std::nullopt, std::optional<bool> out_hovered = std::nullopt,
             std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
              auto DragLineY_adapt_modifiable_immutable_to_return = [](int id, double y, const ImVec4 &col,
                                                                       float thickness = 1,
                                                                       ImPlotDragToolFlags flags = 0,
                                                                       std::optional<bool> out_clicked = std::nullopt,
                                                                       std::optional<bool> out_hovered = std::nullopt,
              ...
              return DragLineY_adapt_modifiable_immutable_to_return(id, y, col, thickness, flags, out_clicked,
                                                                    out_hovered, held);
          },
          nb::arg("id_"), nb::arg("y"), nb::arg("col"), nb::arg("thickness") = 1, nb::arg("flags") = 0,
          nb::arg("out_clicked") = nb::none(), nb::arg("out_hovered") = nb::none(), nb::arg("held") = nb::none(),
          "Shows a draggable horizontal guide line at a y-value. #col defaults to ImGuiCol_Text.");

    m.def("drag_rect",
          [](int id, double x1, double y1, double x2, double y2, const ImVec4 &col, ImPlotDragToolFlags flags = 0,
             std::optional<bool> out_clicked = std::nullopt, std::optional<bool> out_hovered = std::nullopt,
             std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, double, double, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
              auto DragRect_adapt_modifiable_immutable_to_return = [](int id, double x1, double y1, double x2,
                                                                      double y2, const ImVec4 &col,
                                                                      ImPlotDragToolFlags flags = 0,
                                                                      std::optional<bool> out_clicked = std::nullopt,
                                                                      std::optional<bool> out_hovered = std::nullopt,
                                                                      std::optional<bool> held = std::nullopt) -> std::tuple<bool, double, double, double, double, std::optional<bool>, std::optional<bool>, std::optional<bool>> {
                  ...
                  bool r = ImPlot::DragRect(id, x1_adapt_modifiable, y1_adapt_modifiable, x2_adapt_modifiable,
                                            y2_adapt_modifiable, col, flags, out_clicked_adapt_modifiable,
                                            out_hovered_adapt_modifiable, held_adapt_modifiable);
                  return std::make_tuple(r, x1, y1, x2, y2, out_clicked, out_hovered, held);
              };

              return DragRect_adapt_modifiable_immutable_to_return(id, x1, y1, x2, y2, col, flags, out_clicked,
                                                                   out_hovered, held);
          },
          nb::arg("id_"), nb::arg("x1"), nb::arg("y1"), nb::arg("x2"), nb::arg("y2"), nb::arg("col"),
          nb::arg("flags") = 0, nb::arg("out_clicked") = nb::none(), nb::arg("out_hovered") = nb::none(),
          nb::arg("held") = nb::none(),
          "Shows a draggable and resizeable rectangle.");

    m.def("annotation",
          nb::overload_cast<double, double, const ImVec4 &, const ImVec2 &, bool, bool>(ImPlot::Annotation),
          nb::arg("x"), nb::arg("y"), nb::arg("col"), nb::arg("pix_offset"), nb::arg("clamp"),
          nb::arg("round") = false);

    m.def("annotation",
          [](double x, double y, const ImVec4 &col, const ImVec2 &pix_offset, bool clamp, const char *fmt) {
              auto Annotation_adapt_variadic_format = [](double x, double y, const ImVec4 &col,
                                                         const ImVec2 &pix_offset, bool clamp, const char *fmt) {
    ...
    m.def("tag_x",
          nb::overload_cast<double, const ImVec4 &, bool>(ImPlot::TagX), nb::arg("x"), nb::arg("col"),
          nb::arg("round") = false);
    ...
    m.def("tag_y",
          nb::overload_cast<double, const ImVec4 &, bool>(ImPlot::TagY), nb::arg("y"), nb::arg("col"),
          nb::arg("round") = false);
    ...
    m.def("pixels_to_plot",
          [](const ImVec2 &pix, const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
              auto PixelsToPlot_adapt_mutable_param_with_default_value = [](const ImVec2 &pix,
                                                                            const std::optional<const ImAxis> &x_axis = std::nullopt,
                                                                            const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
    ...
    m.def("pixels_to_plot",
          [](float x, float y, const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
              auto PixelsToPlot_adapt_mutable_param_with_default_value = [](float x, float y,
                                                                            const std::optional<const ImAxis> &x_axis = std::nullopt,
                                                                            const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
    ...
    m.def("plot_to_pixels",
          [](const ImPlotPoint &plt, const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImVec2 {
              auto PlotToPixels_adapt_mutable_param_with_default_value = [](const ImPlotPoint &plt,
                                                                            const std::optional<const ImAxis> &x_axis = std::nullopt,
                                                                            const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImVec2 {
    ...
    m.def("plot_to_pixels",
          [](double x, double y, const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImVec2 {
              auto PlotToPixels_adapt_mutable_param_with_default_value = [](double x, double y,
                                                                            const std::optional<const ImAxis> &x_axis = std::nullopt,
                                                                            const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImVec2 {
    ...
    m.def("get_plot_mouse_pos",
          [](const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
              auto GetPlotMousePos_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImAxis> &x_axis = std::nullopt,
                  const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotPoint {
    ...
    m.def("get_plot_limits",
          [](const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotRect {
              auto GetPlotLimits_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImAxis> &x_axis = std::nullopt,
                  const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotRect {
    ...
    m.def("get_plot_selection",
          [](const std::optional<const ImAxis> &x_axis = std::nullopt,
             const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotRect {
              auto GetPlotSelection_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImAxis> &x_axis = std::nullopt,
                  const std::optional<const ImAxis> &y_axis = std::nullopt) -> ImPlotRect {
    ...
    m.def("hide_next_item",
          [](bool hidden = true, const std::optional<const ImPlotCond> &cond = std::nullopt) {
              auto HideNextItem_adapt_mutable_param_with_default_value = [](bool hidden = true,
                                                                            const std::optional<const ImPlotCond> &cond = std::nullopt) {
    ...
    m.def("set_next_line_style",
          [](const std::optional<const ImVec4> &col = std::nullopt, float weight = IMPLOT_AUTO) {
              auto SetNextLineStyle_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImVec4> &col = std::nullopt, float weight = IMPLOT_AUTO) {
    ...
    m.def("set_next_fill_style",
          [](const std::optional<const ImVec4> &col = std::nullopt, float alpha_mod = IMPLOT_AUTO) {
              auto SetNextFillStyle_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImVec4> &col = std::nullopt, float alpha_mod = IMPLOT_AUTO) {
    ...
    m.def("set_next_marker_style",
          [](const std::optional<const ImPlotMarker> &marker = std::nullopt, float size = IMPLOT_AUTO,
             const std::optional<const ImVec4> &fill = std::nullopt, float weight = IMPLOT_AUTO,
             const std::optional<const ImVec4> &outline = std::nullopt) {
              auto SetNextMarkerStyle_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImPlotMarker> &marker = std::nullopt, float size = IMPLOT_AUTO,
                  const std::optional<const ImVec4> &fill = std::nullopt, float weight = IMPLOT_AUTO,
                  const std::optional<const ImVec4> &outline = std::nullopt) {
          ...
          nb::arg("marker") = nb::none(), nb::arg("size") = IMPLOT_AUTO, nb::arg("fill") = nb::none(),
          nb::arg("weight") = IMPLOT_AUTO, nb::arg("outline") = nb::none(),
          " Set the marker style for the next item only.\n---\nPython bindings defaults:\n    If any of the params below is None, then its default value below will be used:\n        marker: IMPLOT_AUTO\n        fill: IMPLOT_AUTO_COL\n        outline: IMPLOT_AUTO_COL");

    m.def("set_next_error_bar_style",
          [](const std::optional<const ImVec4> &col = std::nullopt, float size = IMPLOT_AUTO,
             float weight = IMPLOT_AUTO) {
              auto SetNextErrorBarStyle_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImVec4> &col = std::nullopt, float size = IMPLOT_AUTO,
                  float weight = IMPLOT_AUTO) {
    ...
    m.def("get_colormap_size",
          [](const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> int {
              auto GetColormapSize_adapt_mutable_param_with_default_value = [](
                  const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> int {
    ...
    m.def("get_colormap_color",
          [](int idx, const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> ImVec4 {
              auto GetColormapColor_adapt_mutable_param_with_default_value = [](int idx,
                                                                                const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> ImVec4 {
    ...
    m.def("sample_colormap",
          [](float t, const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> ImVec4 {
              auto SampleColormap_adapt_mutable_param_with_default_value = [](float t,
                                                                              const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> ImVec4 {
    ...
    m.def("colormap_scale",
          [](const char *label, double scale_min, double scale_max,
             const std::optional<const ImVec2> &size = std::nullopt, const char *format = "%g",
             ImPlotColormapScaleFlags flags = 0, const std::optional<const ImPlotColormap> &cmap = std::nullopt) {
              auto ColormapScale_adapt_mutable_param_with_default_value = [](const char *label, double scale_min,
                                                                             double scale_max,
                                                                             const std::optional<const ImVec2> &size = std::nullopt,
                                                                             const char *format = "%g",
                                                                             ImPlotColormapScaleFlags flags = 0,
                                                                             const std::optional<const ImPlotColormap> &cmap = std::nullopt) {
              ...
              ColormapScale_adapt_mutable_param_with_default_value(label, scale_min, scale_max, size, format, flags,
                                                                   cmap);
          },
          nb::arg("label"), nb::arg("scale_min"), nb::arg("scale_max"), nb::arg("size") = nb::none(),
          nb::arg("format") = "%g", nb::arg("flags") = 0, nb::arg("cmap") = nb::none(),
    ...
    m.def("colormap_slider",
          [](const char *label, float t, ImVec4 *out = nullptr, const char *format = "",
             const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> std::tuple<bool, float> {
              auto ColormapSlider_adapt_mutable_param_with_default_value = [](const char *label, float *t,
                                                                              ImVec4 *out = nullptr,
                                                                              const char *format = "",
                                                                              const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> bool {
              ...
              auto ColormapSlider_adapt_modifiable_immutable_to_return = [&ColormapSlider_adapt_mutable_param_with_default_value](
                  const char *label, float t, ImVec4 *out = nullptr, const char *format = "",
                  const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> std::tuple<bool, float> {
                  float *t_adapt_modifiable = &t;

                  bool r = ColormapSlider_adapt_mutable_param_with_default_value(label, t_adapt_modifiable, out, format,
                                                                                 cmap);
          ...
          nb::arg("label"), nb::arg("t"), nb::arg("out") = nb::none(), nb::arg("format") = "",
          nb::arg("cmap") = nb::none(),
          " Shows a horizontal slider with a colormap gradient background. Optionally returns the color sampled at t in [0 1].\n---\nPython bindings defaults:\n    If cmap is None, then its default value will be: IMPLOT_AUTO");

    m.def("colormap_button",
          [](const char *label, const std::optional<const ImVec2> &size = std::nullopt,
             const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> bool {
              auto ColormapButton_adapt_mutable_param_with_default_value = [](const char *label,
                                                                              const std::optional<const ImVec2> &size = std::nullopt,
                                                                              const std::optional<const ImPlotColormap> &cmap = std::nullopt) -> bool {
    ...
    m.def("bust_color_cache",
          [](std::optional<std::string> plot_title_id = std::nullopt) {
              auto BustColorCache_adapt_const_char_pointer_with_default_null = [](
                  std::optional<std::string> plot_title_id = std::nullopt) {
    ...
    m.def("show_metrics_window",
          [](std::optional<bool> p_popen = std::nullopt) -> std::optional<bool> {
              auto ShowMetricsWindow_adapt_modifiable_immutable_to_return = [](
                  std::optional<bool> p_popen = std::nullopt) -> std::optional<bool> {
