...
void py_init_module_implot_internal(py::module& m)
{
    ...
    m.def("im_mean",
        [](const py::array & values) -> double
        {
            auto ImMean_adapt_c_buffers = [](const py::array & values) -> double
            {
                ...
                if (values_type == 'B')
                    return ImMean(static_cast<const uint8_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'b')
                    return ImMean(static_cast<const int8_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'H')
                    return ImMean(static_cast<const uint16_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'h')
                    return ImMean(static_cast<const int16_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'I')
                    return ImMean(static_cast<const uint32_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'i')
                    return ImMean(static_cast<const int32_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'L')
                    return ImMean(static_cast<const np_uint_l *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'l')
                    return ImMean(static_cast<const np_int_l *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'f')
                    return ImMean(static_cast<const float *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'd')
                    return ImMean(static_cast<const double *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'g')
                    return ImMean(static_cast<const long double *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'q')
                    return ImMean(static_cast<const long long *>(values_from_pyarray), static_cast<int>(values_count));
                // If we reach this point, the array type is not supported!
                else
                    throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
            };

            return ImMean_adapt_c_buffers(values);
        },
        py::arg("values"),
    ...
    m.def("im_std_dev",
        [](const py::array & values) -> double
        {
            auto ImStdDev_adapt_c_buffers = [](const py::array & values) -> double
            {
                // convert py::array to C standard buffer (const)
                const void * values_from_pyarray = values.data();
                py::ssize_t values_count = values.shape()[0];
                ...
                char values_type = values.dtype().char_();
                if (values_type == 'B')
                    return ImStdDev(static_cast<const uint8_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'b')
                    return ImStdDev(static_cast<const int8_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'H')
                    return ImStdDev(static_cast<const uint16_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'h')
                    return ImStdDev(static_cast<const int16_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'I')
                    return ImStdDev(static_cast<const uint32_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'i')
                    return ImStdDev(static_cast<const int32_t *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'L')
                    return ImStdDev(static_cast<const np_uint_l *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'l')
                    return ImStdDev(static_cast<const np_int_l *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'f')
                    return ImStdDev(static_cast<const float *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'd')
                    return ImStdDev(static_cast<const double *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'g')
                    return ImStdDev(static_cast<const long double *>(values_from_pyarray), static_cast<int>(values_count));
                else if (values_type == 'q')
                    return ImStdDev(static_cast<const long long *>(values_from_pyarray), static_cast<int>(values_count));
                // If we reach this point, the array type is not supported!
                else
                    throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
            };

            return ImStdDev_adapt_c_buffers(values);
        },
        py::arg("values"),
    ...
    m.def("calculate_bins",
        [](const py::array & values, ImPlotBin meth, const ImPlotRange & range, int bins_out, double width_out) -> std::tuple<int, double>
        {
            auto CalculateBins_adapt_c_buffers = [](const py::array & values, ImPlotBin meth, const ImPlotRange & range, int & bins_out, double & width_out)
            {
                // convert py::array to C standard buffer (const)
                const void * values_from_pyarray = values.data();
                py::ssize_t values_count = values.shape()[0];
                ...
                char values_type = values.dtype().char_();
                if (values_type == 'B')
                    ImPlot::CalculateBins(static_cast<const uint8_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'b')
                    ImPlot::CalculateBins(static_cast<const int8_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'H')
                    ImPlot::CalculateBins(static_cast<const uint16_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'h')
                    ImPlot::CalculateBins(static_cast<const int16_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'I')
                    ImPlot::CalculateBins(static_cast<const uint32_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'i')
                    ImPlot::CalculateBins(static_cast<const int32_t *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'L')
                    ImPlot::CalculateBins(static_cast<const np_uint_l *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'l')
                    ImPlot::CalculateBins(static_cast<const np_int_l *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'f')
                    ImPlot::CalculateBins(static_cast<const float *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'd')
                    ImPlot::CalculateBins(static_cast<const double *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'g')
                    ImPlot::CalculateBins(static_cast<const long double *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                else if (values_type == 'q')
                    ImPlot::CalculateBins(static_cast<const long long *>(values_from_pyarray), static_cast<int>(values_count), meth, range, bins_out, width_out);
                // If we reach this point, the array type is not supported!
                else
                    throw std::runtime_error(std::string("Bad array type ('") + values_type + "') for param values");
            };
            auto CalculateBins_adapt_modifiable_immutable_to_return = [&CalculateBins_adapt_c_buffers](const py::array & values, ImPlotBin meth, const ImPlotRange & range, int bins_out, double width_out) -> std::tuple<int, double>
            {
                int & bins_out_adapt_modifiable = bins_out;
                double & width_out_adapt_modifiable = width_out;

                CalculateBins_adapt_c_buffers(values, meth, range, bins_out_adapt_modifiable, width_out_adapt_modifiable);
                return std::make_tuple(bins_out, width_out);
            };

            return CalculateBins_adapt_modifiable_immutable_to_return(values, meth, range, bins_out, width_out);
        },
        py::arg("values"), py::arg("meth"), py::arg("range"), py::arg("bins_out"), py::arg("width_out"),
