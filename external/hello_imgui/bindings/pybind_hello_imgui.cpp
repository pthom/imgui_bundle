...
void py_init_module_hello_imgui(py::module& m)
{
    ...
    auto pyClassAppWindowParams =
        ...
        , py::arg("window_title") = std::string(), py::arg("window_geometry") = WindowGeometry(), py::arg("restore_previous_geometry") = false, py::arg("resizable") = true, py::arg("hidden") = false, py::arg("borderless") = false, py::arg("borderless_movable") = true, py::arg("borderless_resizable") = true, py::arg("borderless_highlight_color") = ImVec4(0.2f, 0.4f, 1.f, 0.3f), py::arg("edge_insets") = EdgeInsets(), py::arg("handle_edge_insets") = true
        )
