...
def demo_input_text_decimal():
    ...
    changed, static.text = imgui.input_text(
                    "decimal", static.text, imgui.ImGuiInputTextFlags_.chars_decimal)
...
def demo_imgui_bundle():
    ...
    if imgui.collapsing_header("About", imgui.ImGuiTreeNodeFlags_.default_open):
        ...
        """
            ### Batteries included
            ImGui Bundle include [imgui](https://github.com/ocornut/imgui.git), [implot](https://github.com/epezent/implot), [hello imgui](https://github.com/pthom/hello_imgui.git), [ImGuiColorTextEdit](external/ImGuiColorTextEdit), [imgui-node-editor](https://github.com/thedmd/imgui-node-editor), [imgui-knobs](https://github.com/altschuler/imgui-knobs), [ImFileDialog](https://github.com/pthom/ImFileDialog.git), [imgui_md (markdown)](https://github.com/mekhontsev/imgui_md.git), and [imspinner](https://github.com/dalerank/imspinner)
