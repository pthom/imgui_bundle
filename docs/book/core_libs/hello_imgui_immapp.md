...
````{card}
:link: https://imgui-bundle.pages.dev/explorer/demo_docking.html
...
[Docking Demo](https://imgui-bundle.pages.dev/explorer/demo_docking.html) shows how to create a full-featured application:
...
````{card}
:link: https://imgui-bundle.pages.dev/explorer/demo_assets_addons.html
...
````{card}
:link: https://imgui-bundle.pages.dev/explorer/demo_custom_background.html
...
````{card}
:link: https://imgui-bundle.pages.dev/explorer/demo_powersave.html
