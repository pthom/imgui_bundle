...
- [ImGui Manual (widget reference & code)](https://pthom.github.io/imgui_manual/): explore all the widgets and features of Dear ImGui, with live examples and the corresponding python or C++ code
