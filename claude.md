...
* Autogenerated files: the content of stub files (e.g. external/imgui/bindings/pybind_imgui.cpp) and pybind files (e.g. bindings/imgui_bundle/imgui/__init__.pyi) for included libraries is mostly autogenerated. 
